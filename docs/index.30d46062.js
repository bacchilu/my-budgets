 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class we extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Ee=function(e){return function(e){const t=ve(e);return be.encodeByteArray(t,!0)}(e).replace(/\./g,"")},_e=function(e){try{return be.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
 * @license
 ...
 * limitations under the License.
 */
class St{getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}constructor(e){this.container=e}}const Tt="@firebase/app",It="0.9.8",Ct=new st("@firebase/app"),Nt="[DEFAULT]",xt={[Tt]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},At=new Map,Rt=new Map;function Dt(e,t){try{e.container.addComponent(t)}catch(n){Ct.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Ot(e){const t=e.name;if(Rt.has(t))return Ct.debug(`There were multiple attempts to register component ${t}.`),!1;Rt.set(t,e);for(const t of At.values())Dt(t,e);return!0}function Pt(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Lt=new Me("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ft="9.20.0";function Ut(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:Nt,automaticDataCollectionEnabled:!1},t),i=r.name;if("string"!=typeof i||!i)throw Lt.create("bad-app-name",{appName:String(i)});if(n||(n=Ce()),!n)throw Lt.create("no-options");const s=At.get(i);if(s){if(Ve(n,s.options)&&Ve(r,s.config))return s;throw Lt.create("duplicate-app",{appName:i})}const o=new Xe(i);for(const e of Rt.values())o.addComponent(e);const a=new Mt(n,r,o);return At.set(i,a),a}function Vt(e=Nt){const t=At.get(e);if(!t&&e===Nt)return Ut();if(!t)throw Lt.create("no-app",{appName:e});return t}function jt(e,t,n){var r;let i=null!==(r=xt[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${i}" with version "${t}":`];return s&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ct.warn(e.join(" "))}Ot(new Ge(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const zt="firebase-heartbeat-database",Bt=1,$t="firebase-heartbeat-store";let qt=null;function Ht(){return qt||(qt=bt(zt,Bt,{upgrade:(e,t)=>{if(0===t)e.createObjectStore($t)}}).catch((e=>{throw Lt.create("idb-open",{originalErrorMessage:e.message})}))),qt}async function Kt(e,t){try{const n=(await Ht()).transaction($t,"readwrite"),r=n.objectStore($t);return await r.put(t,Wt(e)),n.done}catch(e){if(e instanceof Le)Ct.warn(e.message);else{const t=Lt.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Ct.warn(t.message)}}}function Wt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=Qt();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Qt(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let r=e.slice();for(const i of e){const e=n.find((e=>e.agent===i.agent));if(e){if(e.dates.push(i.date),Xt(n)>t){e.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Xt(n)>t){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}(this._heartbeatsCache.heartbeats),r=Ee(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Yt(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}}function Qt(){return(new Date).toISOString().substring(0,10)}class Yt{async runIndexedDBEnvironmentCheck(){return!!Pe()&&new Promise(((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){try{return(await Ht()).transaction($t).objectStore($t).get(Wt(e))}catch(e){if(e instanceof Le)Ct.warn(e.message);else{const t=Lt.create("idb-get",{originalErrorMessage:null==e?void 0:e.message});Ct.warn(t.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Kt(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Kt(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function Xt(e){return Ee(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Jt;Jt="",Ot(new Ge("platform-logger",(e=>new St(e)),"PRIVATE")),Ot(new Ge("heartbeat",(e=>new Gt(e)),"PRIVATE")),jt(Tt,It,Jt),jt(Tt,It,"esm2017"),jt("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kn(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Yn(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Wn(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Jn(t))return"Blackberry";if(Zn(t))return"Webos";if(Gn(t))return"Safari";if((t.includes("chrome/")||Qn(t))&&!t.includes("edge/"))return"Chrome";if(Xn(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Wn(e=Re()){return/firefox\//i.test(e)}function Gn(e=Re()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Qn(e=Re()){return/crios\//i.test(e)}function Yn(e=Re()){return/iemobile/i.test(e)}function Xn(e=Re()){return/android/i.test(e)}function Jn(e=Re()){return/blackberry/i.test(e)}function Zn(e=Re()){return/webos/i.test(e)}function er(e=Re()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function tr(){return Oe()&&10===document.documentMode}function nr(e=Re()){return er(e)||Xn(e)||Zn(e)||Jn(e)||/windows phone/i.test(e)||Yn(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function br(e,t){return Sn(e,"POST","/v1/accounts:update",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function wr(e,t){return In(e,"POST","/v1/accounts:signInWithPassword",kn(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Xr(){return void 0!==Yr().WorkerGlobalScope&&"function"==typeof Yr().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const bi="pendingRedirect",wi=new Map;class Ei extends gi{async execute(){let e=wi.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Ti(t),r=Si(e);if(!await r._isAvailable())return!1;const i="true"===await r._get(n);return await r._remove(n),i}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}wi.set(this.auth._key(),e)}return this.bypassAuthState||wi.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}}async function _i(e,t){return Si(e)._set(Ti(t),"true")}function ki(e,t){wi.set(e._key(),t)}function Si(e){return zn(e._redirectPersistence)}function Ti(e){return qn(bi,e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const is=Ne("authIdTokenMaxAge")||300;let ss=null;function os(e=Vt()){const t=Pt(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Pt(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Ve(n.getOptions(),null!=t?t:{}))return e;on(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:es,persistence:[ai,qr,Kr]}),r=Ne("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>is)return;const r=null==t?void 0:t.token;ss!==r&&(ss=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){We(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){We(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=Te("auth");return s&&mr(n,`http://${s}`),n}var as;as="Browser",Ot(new Ge("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:s,authDomain:o}=n.options;hn(s&&!s.includes(":"),"invalid-api-key",{appName:n.name}),hn(!(null==o?void 0:o.includes(":")),"argument-error",{appName:n.name});const a={apiKey:s,authDomain:o,clientPlatform:as,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:rr(as)},l=new dr(n,r,i,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(zn);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(l,t),l}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Ot(new Ge("auth-internal",(e=>(e=>new rs(e))(fr(e.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),jt(ts,ns,function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(as)),jt(ts,ns,"esm2017");var ls,us="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==n?n:"undefined"!=typeof self?self:{},cs={},hs=hs||{},ds=us||self;function fs(){}function ps(e){var t=typeof e;return"array"==(t="object"!=t?t:e?Array.isArray(e)?"array":t:"null")||"object"==t&&"number"==typeof e.length}function ms(e){var t=typeof e;return"object"==t&&null!=e||"function"==t}var gs="closure_uid_"+(1e9*Math.random()>>>0),ys=0;function vs(e,t,n){return e.call.apply(e.bind,arguments)}function bs(e,t,n){if(!e)throw Error();if(2<arguments.length){var r=Array.prototype.slice.call(arguments,2);return function(){var n=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(n,r),e.apply(t,n)}}return function(){return e.apply(t,arguments)}}function ws(e,t,n){return(ws=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?vs:bs).apply(null,arguments)}function Es(e,t){var n=Array.prototype.slice.call(arguments,1);return function(){var t=n.slice();return t.push.apply(t,arguments),e.apply(this,t)}}function _s(e,t){function n(){}n.prototype=t.prototype,e.X=t.prototype,e.prototype=new n,e.prototype.constructor=e,e.Wb=function(e,n,r){for(var i=Array(arguments.length-2),s=2;s<arguments.length;s++)i[s-2]=arguments[s];return t.prototype[n].apply(e,i)}}function ks(){this.s=this.s,this.o=this.o}ks.prototype.s=!1,ks.prototype.na=function(){var e;!this.s&&(this.s=!0,this.M(),0)&&(e=this,Object.prototype.hasOwnProperty.call(e,gs)&&e[gs]||(e[gs]=++ys))},ks.prototype.M=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const Ss=Array.prototype.indexOf?function(e,t){return Array.prototype.indexOf.call(e,t,void 0)}:function(e,t){if("string"==typeof e)return"string"!=typeof t||1!=t.length?-1:e.indexOf(t,0);for(let n=0;n<e.length;n++)if(n in e&&e[n]===t)return n;return-1};function Ts(e){const t=e.length;if(0<t){const n=Array(t);for(let r=0;r<t;r++)n[r]=e[r];return n}return[]}function Is(e,t){for(let t=1;t<arguments.length;t++){const n=arguments[t];if(ps(n)){const t=e.length||0,r=n.length||0;e.length=t+r;for(let i=0;i<r;i++)e[t+i]=n[i]}else e.push(n)}}function Cs(e,t){this.type=e,this.g=this.target=t,this.defaultPrevented=!1}Cs.prototype.h=function(){this.defaultPrevented=!0};var Ns=function(){if(!ds.addEventListener||!Object.defineProperty)return!1;var e=!1,t=Object.defineProperty({},"passive",{get:function(){e=!0}});try{ds.addEventListener("test",fs,t),ds.removeEventListener("test",fs,t)}catch(e){}return e}();function xs(e){return/^[\s\xa0]*$/.test(e)}var As=String.prototype.trim?function(e){return e.trim()}:function(e){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(e)[1]};function Rs(e,t){return e<t?-1:e>t?1:0}function Ds(){var e=ds.navigator;return e&&(e=e.userAgent)?e:""}function Os(e){return-1!=Ds().indexOf(e)}function Ps(e){return Ps[" "](e),e}Ps[" "]=fs;var Ls,Ms,Fs=Os("Opera"),Us=Os("Trident")||Os("MSIE"),Vs=Os("Edge"),js=Vs||Us,zs=Os("Gecko")&&!(-1!=Ds().toLowerCase().indexOf("webkit")&&!Os("Edge"))&&!(Os("Trident")||Os("MSIE"))&&!Os("Edge"),Bs=-1!=Ds().toLowerCase().indexOf("webkit")&&!Os("Edge");function $s(){var e=ds.document;return e?e.documentMode:void 0}e:{var qs="",Hs=(Ms=Ds(),zs?/rv:([^\);]+)(\)|;)/.exec(Ms):Vs?/Edge\/([\d\.]+)/.exec(Ms):Us?/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(Ms):Bs?/WebKit\/(\S+)/.exec(Ms):Fs?/(?:Version)[ \/]?(\S+)/.exec(Ms):void 0);if(Hs&&(qs=Hs?Hs[1]:""),Us){var Ks=$s();if(null!=Ks&&Ks>parseFloat(qs)){Ls=String(Ks);break e}}Ls=qs}var Ws,Gs={};function Qs(){return function(e){var t=Gs;return Object.prototype.hasOwnProperty.call(t,9)?t[9]:t[9]=e(9)}((function(){let e=0;const t=As(String(Ls)).split("."),n=As("9").split("."),r=Math.max(t.length,n.length);for(let o=0;0==e&&o<r;o++){var i=t[o]||"",s=n[o]||"";do{if(i=/(\d*)(\D*)(.*)/.exec(i)||["","","",""],s=/(\d*)(\D*)(.*)/.exec(s)||["","","",""],0==i[0].length&&0==s[0].length)break;e=Rs(0==i[1].length?0:parseInt(i[1],10),0==s[1].length?0:parseInt(s[1],10))||Rs(0==i[2].length,0==s[2].length)||Rs(i[2],s[2]),i=i[3],s=s[3]}while(0==e)}return 0<=e}))}if(ds.document&&Us){var Ys=$s();Ws=Ys||(parseInt(Ls,10)||void 0)}else Ws=void 0;var Xs=Ws;function Js(e,t){if(Cs.call(this,e?e.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,e){var n=this.type=e.type,r=e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null;if(this.target=e.target||e.srcElement,this.g=t,t=e.relatedTarget){if(zs){e:{try{Ps(t.nodeName);var i=!0;break e}catch(e){}i=!1}i||(t=null)}}else"mouseover"==n?t=e.fromElement:"mouseout"==n&&(t=e.toElement);this.relatedTarget=t,r?(this.clientX=void 0!==r.clientX?r.clientX:r.pageX,this.clientY=void 0!==r.clientY?r.clientY:r.pageY,this.screenX=r.screenX||0,this.screenY=r.screenY||0):(this.clientX=void 0!==e.clientX?e.clientX:e.pageX,this.clientY=void 0!==e.clientY?e.clientY:e.pageY,this.screenX=e.screenX||0,this.screenY=e.screenY||0),this.button=e.button,this.key=e.key||"",this.ctrlKey=e.ctrlKey,this.altKey=e.altKey,this.shiftKey=e.shiftKey,this.metaKey=e.metaKey,this.pointerId=e.pointerId||0,this.pointerType="string"==typeof e.pointerType?e.pointerType:Zs[e.pointerType]||"",this.state=e.state,this.i=e,e.defaultPrevented&&Js.X.h.call(this)}}_s(Js,Cs);var Zs={2:"touch",3:"pen",4:"mouse"};Js.prototype.h=function(){Js.X.h.call(this);var e=this.i;e.preventDefault?e.preventDefault():e.returnValue=!1};var eo="closure_listenable_"+(1e6*Math.random()|0),to=0;function no(e,t,n,r,i){this.listener=e,this.proxy=null,this.src=t,this.type=n,this.capture=!!r,this.ha=i,this.key=++to,this.ba=this.ea=!1}function ro(e){e.ba=!0,e.listener=null,e.proxy=null,e.src=null,e.ha=null}function io(e,t,n){for(const r in e)t.call(n,e[r],r,e)}function so(e){const t={};for(const n in e)t[n]=e[n];return t}const oo="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function ao(e,t){let n,r;for(let t=1;t<arguments.length;t++){for(n in r=arguments[t],r)e[n]=r[n];for(let t=0;t<oo.length;t++)n=oo[t],Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}}function lo(e){this.src=e,this.g={},this.h=0}function uo(e,t){var n=t.type;if(n in e.g){var r,i=e.g[n],s=Ss(i,t);(r=0<=s)&&Array.prototype.splice.call(i,s,1),r&&(ro(t),0==e.g[n].length&&(delete e.g[n],e.h--))}}function co(e,t,n,r){for(var i=0;i<e.length;++i){var s=e[i];if(!s.ba&&s.listener==t&&s.capture==!!n&&s.ha==r)return i}return-1}lo.prototype.add=function(e,t,n,r,i){var s=e.toString();(e=this.g[s])||(e=this.g[s]=[],this.h++);var o=co(e,t,r,i);return-1<o?(t=e[o],n||(t.ea=!1)):((t=new no(t,this.src,s,!!r,i)).ea=n,e.push(t)),t};var ho="closure_lm_"+(1e6*Math.random()|0),fo={};function po(e,t,n,r,i){if(r&&r.once)return go(e,t,n,r,i);if(Array.isArray(t)){for(var s=0;s<t.length;s++)po(e,t[s],n,r,i);return null}return n=ko(n),e&&e[eo]?e.N(t,n,ms(r)?!!r.capture:!!r,i):mo(e,t,n,!1,r,i)}function mo(e,t,n,r,i,s){if(!t)throw Error("Invalid event type");var o=ms(i)?!!i.capture:!!i,a=Eo(e);if(a||(e[ho]=a=new lo(e)),(n=a.add(t,n,r,o,s)).proxy)return n;if(r=function(){function e(n){return t.call(e.src,e.listener,n)}const t=wo;return e}(),n.proxy=r,r.src=e,r.listener=n,e.addEventListener)Ns||(i=o),void 0===i&&(i=!1),e.addEventListener(t.toString(),r,i);else if(e.attachEvent)e.attachEvent(bo(t.toString()),r);else{if(!e.addListener||!e.removeListener)throw Error("addEventListener and attachEvent are unavailable.");e.addListener(r)}return n}function go(e,t,n,r,i){if(Array.isArray(t)){for(var s=0;s<t.length;s++)go(e,t[s],n,r,i);return null}return n=ko(n),e&&e[eo]?e.O(t,n,ms(r)?!!r.capture:!!r,i):mo(e,t,n,!0,r,i)}function yo(e,t,n,r,i){if(Array.isArray(t))for(var s=0;s<t.length;s++)yo(e,t[s],n,r,i);else r=ms(r)?!!r.capture:!!r,n=ko(n),e&&e[eo]?(e=e.i,(t=String(t).toString())in e.g&&(-1<(n=co(s=e.g[t],n,r,i))&&(ro(s[n]),Array.prototype.splice.call(s,n,1),0==s.length&&(delete e.g[t],e.h--)))):e&&(e=Eo(e))&&(t=e.g[t.toString()],e=-1,t&&(e=co(t,n,r,i)),(n=-1<e?t[e]:null)&&vo(n))}function vo(e){if("number"!=typeof e&&e&&!e.ba){var t=e.src;if(t&&t[eo])uo(t.i,e);else{var n=e.type,r=e.proxy;t.removeEventListener?t.removeEventListener(n,r,e.capture):t.detachEvent?t.detachEvent(bo(n),r):t.addListener&&t.removeListener&&t.removeListener(r),(n=Eo(t))?(uo(n,e),0==n.h&&(n.src=null,t[ho]=null)):ro(e)}}}function bo(e){return e in fo?fo[e]:fo[e]="on"+e}function wo(e,t){if(e.ba)e=!0;else{t=new Js(t,this);var n=e.listener,r=e.ha||e.src;e.ea&&vo(e),e=n.call(r,t)}return e}function Eo(e){return(e=e[ho])instanceof lo?e:null}var _o="__closure_events_fn_"+(1e9*Math.random()>>>0);function ko(e){return"function"==typeof e?e:(e[_o]||(e[_o]=function(t){return e.handleEvent(t)}),e[_o])}function So(){ks.call(this),this.i=new lo(this),this.P=this,this.I=null}function To(e,t){var n,r=e.I;if(r)for(n=[];r;r=r.I)n.push(r);if(e=e.P,r=t.type||t,"string"==typeof t)t=new Cs(t,e);else if(t instanceof Cs)t.target=t.target||e;else{var i=t;ao(t=new Cs(r,e),i)}if(i=!0,n)for(var s=n.length-1;0<=s;s--){var o=t.g=n[s];i=Io(o,r,!0,t)&&i}if(i=Io(o=t.g=e,r,!0,t)&&i,i=Io(o,r,!1,t)&&i,n)for(s=0;s<n.length;s++)i=Io(o=t.g=n[s],r,!1,t)&&i}function Io(e,t,n,r){if(!(t=e.i.g[String(t)]))return!0;t=t.concat();for(var i=!0,s=0;s<t.length;++s){var o=t[s];if(o&&!o.ba&&o.capture==n){var a=o.listener,l=o.ha||o.src;o.ea&&uo(e.i,o),i=!1!==a.call(l,r)&&i}}return i&&!r.defaultPrevented}_s(So,ks),So.prototype[eo]=!0,So.prototype.removeEventListener=function(e,t,n,r){yo(this,e,t,n,r)},So.prototype.M=function(){if(So.X.M.call(this),this.i){var e,t=this.i;for(e in t.g){for(var n=t.g[e],r=0;r<n.length;r++)ro(n[r]);delete t.g[e],t.h--}}this.I=null},So.prototype.N=function(e,t,n,r){return this.i.add(String(e),t,!1,n,r)},So.prototype.O=function(e,t,n,r){return this.i.add(String(e),t,!0,n,r)};var Co=ds.JSON.stringify;function No(){var e=Lo;let t=null;return e.g&&(t=e.g,e.g=e.g.next,e.g||(e.h=null),t.next=null),t}var xo,Ao=new class{get(){let e;return 0<this.h?(this.h--,e=this.g,this.g=e.next,e.next=null):e=this.i(),e}constructor(e,t){this.i=e,this.j=t,this.h=0,this.g=null}}((()=>new Ro),(e=>e.reset()));class Ro{set(e,t){this.h=e,this.g=t,this.next=null}reset(){this.next=this.g=this.h=null}constructor(){this.next=this.g=this.h=null}}function Do(e){ds.setTimeout((()=>{throw e}),0)}function Oo(e,t){xo||function(){var e=ds.Promise.resolve(void 0);xo=function(){e.then(Mo)}}(),Po||(xo(),Po=!0),Lo.add(e,t)}var Po=!1,Lo=new class{add(e,t){const n=Ao.get();n.set(e,t),this.h?this.h.next=n:this.g=n,this.h=n}constructor(){this.h=this.g=null}};function Mo(){for(var e;e=No();){try{e.h.call(e.g)}catch(e){Do(e)}var t=Ao;t.j(e),100>t.h&&(t.h++,e.next=t.g,t.g=e)}Po=!1}function Fo(e,t){So.call(this),this.h=e||1,this.g=t||ds,this.j=ws(this.lb,this),this.l=Date.now()}function Uo(e){e.ca=!1,e.R&&(e.g.clearTimeout(e.R),e.R=null)}function Vo(e,t,n){if("function"==typeof e)n&&(e=ws(e,n));else{if(!e||"function"!=typeof e.handleEvent)throw Error("Invalid listener argument");e=ws(e.handleEvent,e)}return 2147483647<Number(t)?-1:ds.setTimeout(e,t||0)}function jo(e){e.g=Vo((()=>{e.g=null,e.i&&(e.i=!1,jo(e))}),e.j);const t=e.h;e.h=null,e.m.apply(null,t)}_s(Fo,So),(ls=Fo.prototype).ca=!1,ls.R=null,ls.lb=function(){if(this.ca){var e=Date.now()-this.l;0<e&&e<.8*this.h?this.R=this.g.setTimeout(this.j,this.h-e):(this.R&&(this.g.clearTimeout(this.R),this.R=null),To(this,"tick"),this.ca&&(Uo(this),this.start()))}},ls.start=function(){this.ca=!0,this.R||(this.R=this.g.setTimeout(this.j,this.h),this.l=Date.now())},ls.M=function(){Fo.X.M.call(this),Uo(this),delete this.g};class zo extends ks{l(e){this.h=arguments,this.g?this.i=!0:jo(this)}M(){super.M(),this.g&&(ds.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}constructor(e,t){super(),this.m=e,this.j=t,this.h=null,this.i=!1,this.g=null}}function Bo(e){ks.call(this),this.h=e,this.g={}}_s(Bo,ks);var $o=[];function qo(e,t,n,r){Array.isArray(n)||(n&&($o[0]=n.toString()),n=$o);for(var i=0;i<n.length;i++){var s=po(t,n[i],r||e.handleEvent,!1,e.h||e);if(!s)break;e.g[s.key]=s}}function Ho(e){io(e.g,(function(e,t){this.g.hasOwnProperty(t)&&vo(e)}),e),e.g={}}function Ko(){this.g=!0}function Wo(e,t,n,r){e.info((function(){return"XMLHTTP TEXT ("+t+"): "+function(e,t){if(!e.g)return t;if(!t)return null;try{var n=JSON.parse(t);if(n)for(e=0;e<n.length;e++)if(Array.isArray(n[e])){var r=n[e];if(!(2>r.length)){var i=r[1];if(Array.isArray(i)&&!(1>i.length)){var s=i[0];if("noop"!=s&&"stop"!=s&&"close"!=s)for(var o=1;o<i.length;o++)i[o]=""}}}return Co(n)}catch(e){return t}}(e,n)+(r?" "+r:"")}))}Bo.prototype.M=function(){Bo.X.M.call(this),Ho(this)},Bo.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")},Ko.prototype.Aa=function(){this.g=!1},Ko.prototype.info=function(){};var Go={},Qo=null;function Yo(){return Qo=Qo||new So}function Xo(e){Cs.call(this,Go.Pa,e)}function Jo(e){const t=Yo();To(t,new Xo(t))}function Zo(e,t){Cs.call(this,Go.STAT_EVENT,e),this.stat=t}function ea(e){const t=Yo();To(t,new Zo(t,e))}function ta(e,t){Cs.call(this,Go.Qa,e),this.size=t}function na(e,t){if("function"!=typeof e)throw Error("Fn must not be null and must be a function");return ds.setTimeout((function(){e()}),t)}Go.Pa="serverreachability",_s(Xo,Cs),Go.STAT_EVENT="statevent",_s(Zo,Cs),Go.Qa="timingevent",_s(ta,Cs);var ra={NO_ERROR:0,mb:1,zb:2,yb:3,tb:4,xb:5,Ab:6,Ma:7,TIMEOUT:8,Db:9},ia={rb:"complete",Nb:"success",Na:"error",Ma:"abort",Fb:"ready",Gb:"readystatechange",TIMEOUT:"timeout",Bb:"incrementaldata",Eb:"progress",ub:"downloadprogress",Vb:"uploadprogress"};function sa(){}function oa(e){return e.h||(e.h=e.i())}function aa(){}sa.prototype.h=null;var la,ua={OPEN:"a",qb:"b",Na:"c",Cb:"d"};function ca(){Cs.call(this,"d")}function ha(){Cs.call(this,"c")}function da(){}function fa(e,t,n,r){this.l=e,this.j=t,this.m=n,this.U=r||1,this.S=new Bo(this),this.O=ma,e=js?125:void 0,this.T=new Fo(e),this.H=null,this.i=!1,this.s=this.A=this.v=this.K=this.F=this.V=this.B=null,this.D=[],this.g=null,this.C=0,this.o=this.u=null,this.Y=-1,this.I=!1,this.N=0,this.L=null,this.$=this.J=this.Z=this.P=!1,this.h=new pa}function pa(){this.i=null,this.g="",this.h=!1}_s(ca,Cs),_s(ha,Cs),_s(da,sa),da.prototype.g=function(){return new XMLHttpRequest},da.prototype.i=function(){return{}},la=new da;var ma=45e3,ga={},ya={};function va(e,t,n){e.K=1,e.v=Fa(Da(t)),e.s=n,e.P=!0,ba(e,null)}function ba(e,t){e.F=Date.now(),ka(e),e.A=Da(e.v);var n=e.A,r=e.U;Array.isArray(r)||(r=[String(r)]),Ya(n.i,"t",r),e.C=0,n=e.l.H,e.h=new pa,e.g=Ql(e.l,n?t:null,!e.s),0<e.N&&(e.L=new zo(ws(e.La,e,e.g),e.N)),qo(e.S,e.g,"readystatechange",e.ib),t=e.H?so(e.H):{},e.s?(e.u||(e.u="POST"),t["Content-Type"]="application/x-www-form-urlencoded",e.g.da(e.A,e.u,e.s,t)):(e.u="GET",e.g.da(e.A,e.u,null,t)),Jo(),function(e,t,n,r,i,s){e.info((function(){if(e.g)if(s)for(var o="",a=s.split("&"),l=0;l<a.length;l++){var u=a[l].split("=");if(1<u.length){var c=u[0];u=u[1];var h=c.split("_");o=2<=h.length&&"type"==h[1]?o+(c+"=")+u+"&":o+(c+"=redacted&")}}else o=null;else o=s;return"XMLHTTP REQ ("+r+") [attempt "+i+"]: "+t+"\n"+n+"\n"+o}))}(e.j,e.u,e.A,e.m,e.U,e.s)}function wa(e){return!!e.g&&("GET"==e.u&&2!=e.K&&e.l.Da)}function Ea(e,t,n){let r,i=!0;for(;!e.I&&e.C<n.length;){if(r=_a(e,n),r==ya){4==t&&(e.o=4,ea(14),i=!1),Wo(e.j,e.m,null,"[Incomplete Response]");break}if(r==ga){e.o=4,ea(15),Wo(e.j,e.m,n,"[Invalid Chunk]"),i=!1;break}Wo(e.j,e.m,r,null),Na(e,r)}wa(e)&&r!=ya&&r!=ga&&(e.h.g="",e.C=0),4!=t||0!=n.length||e.h.h||(e.o=1,ea(16),i=!1),e.i=e.i&&i,i?0<n.length&&!e.$&&(e.$=!0,(t=e.l).g==e&&t.$&&!t.K&&(t.j.info("Great, no buffering proxy detected. Bytes received: "+n.length),zl(t),t.K=!0,ea(11))):(Wo(e.j,e.m,n,"[Invalid Chunked Response]"),Ca(e),Ia(e))}function _a(e,t){var n=e.C,r=t.indexOf("\n",n);return-1==r?ya:(n=Number(t.substring(n,r)),isNaN(n)?ga:(r+=1)+n>t.length?ya:(t=t.substr(r,n),e.C=r+n,t))}function ka(e){e.V=Date.now()+e.O,Sa(e,e.O)}function Sa(e,t){if(null!=e.B)throw Error("WatchDog timer not null");e.B=na(ws(e.gb,e),t)}function Ta(e){e.B&&(ds.clearTimeout(e.B),e.B=null)}function Ia(e){0==e.l.G||e.I||ql(e.l,e)}function Ca(e){Ta(e);var t=e.L;t&&"function"==typeof t.na&&t.na(),e.L=null,Uo(e.T),Ho(e.S),e.g&&(t=e.g,e.g=null,t.abort(),t.na())}function Na(e,t){try{var n=e.l;if(0!=n.G&&(n.g==e||nl(n.h,e)))if(!e.J&&nl(n.h,e)&&3==n.G){try{var r=n.Fa.g.parse(t)}catch(e){r=null}if(Array.isArray(r)&&3==r.length){var i=r;if(0==i[0]){e:if(!n.u){if(n.g){if(!(n.g.F+3e3<e.F))break e;$l(n),Ol(n)}jl(n),ea(18)}}else n.Ba=i[1],0<n.Ba-n.T&&37500>i[2]&&n.L&&0==n.A&&!n.v&&(n.v=na(ws(n.cb,n),6e3));if(1>=tl(n.h)&&n.ja){try{n.ja()}catch(e){}n.ja=void 0}}else Kl(n,11)}else if((e.J||n.g==e)&&$l(n),!xs(t))for(i=n.Fa.g.parse(t),t=0;t<i.length;t++){let u=i[t];if(n.T=u[0],u=u[1],2==n.G)if("c"==u[0]){n.I=u[1],n.ka=u[2];const t=u[3];null!=t&&(n.ma=t,n.j.info("VER="+n.ma));const i=u[4];null!=i&&(n.Ca=i,n.j.info("SVER="+n.Ca));const c=u[5];null!=c&&"number"==typeof c&&0<c&&(r=1.5*c,n.J=r,n.j.info("backChannelRequestTimeoutMs_="+r)),r=n;const h=e.g;if(h){const e=h.g?h.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(e){var s=r.h;s.g||-1==e.indexOf("spdy")&&-1==e.indexOf("quic")&&-1==e.indexOf("h2")||(s.j=s.l,s.g=new Set,s.h&&(rl(s,s.h),s.h=null))}if(r.D){const e=h.g?h.g.getResponseHeader("X-HTTP-Session-Id"):null;e&&(r.za=e,Ma(r.F,r.D,e))}}n.G=3,n.l&&n.l.xa(),n.$&&(n.P=Date.now()-e.F,n.j.info("Handshake RTT: "+n.P+"ms"));var o=e;if((r=n).sa=Gl(r,r.H?r.ka:null,r.V),o.J){il(r.h,o);var a=o,l=r.J;l&&a.setTimeout(l),a.B&&(Ta(a),ka(a)),r.g=o}else Vl(r);0<n.i.length&&Ll(n)}else"stop"!=u[0]&&"close"!=u[0]||Kl(n,7);else 3==n.G&&("stop"==u[0]||"close"==u[0]?"stop"==u[0]?Kl(n,7):Dl(n):"noop"!=u[0]&&n.l&&n.l.wa(u),n.A=0)}Jo()}catch(e){}}function xa(e,t){if(e.forEach&&"function"==typeof e.forEach)e.forEach(t,void 0);else if(ps(e)||"string"==typeof e)Array.prototype.forEach.call(e,t,void 0);else for(var n=function(e){if(e.oa&&"function"==typeof e.oa)return e.oa();if(!e.W||"function"!=typeof e.W){if("undefined"!=typeof Map&&e instanceof Map)return Array.from(e.keys());if(!("undefined"!=typeof Set&&e instanceof Set)){if(ps(e)||"string"==typeof e){var t=[];e=e.length;for(var n=0;n<e;n++)t.push(n);return t}t=[],n=0;for(const r in e)t[n++]=r;return t}}}(e),r=function(e){if(e.W&&"function"==typeof e.W)return e.W();if("undefined"!=typeof Map&&e instanceof Map||"undefined"!=typeof Set&&e instanceof Set)return Array.from(e.values());if("string"==typeof e)return e.split("");if(ps(e)){for(var t=[],n=e.length,r=0;r<n;r++)t.push(e[r]);return t}for(r in t=[],n=0,e)t[n++]=e[r];return t}(e),i=r.length,s=0;s<i;s++)t.call(void 0,r[s],n&&n[s],e)}(ls=fa.prototype).setTimeout=function(e){this.O=e},ls.ib=function(e){e=e.target;const t=this.L;t&&3==Il(e)?t.l():this.La(e)},ls.La=function(e){try{if(e==this.g)e:{const c=Il(this.g);var t=this.g.Ea();this.g.aa();if(!(3>c)&&(3!=c||js||this.g&&(this.h.h||this.g.fa()||Cl(this.g)))){this.I||4!=c||7==t||Jo(),Ta(this);var n=this.g.aa();this.Y=n;t:if(wa(this)){var r=Cl(this.g);e="";var i=r.length,s=4==Il(this.g);if(!this.h.i){if("undefined"==typeof TextDecoder){Ca(this),Ia(this);var o="";break t}this.h.i=new ds.TextDecoder}for(t=0;t<i;t++)this.h.h=!0,e+=this.h.i.decode(r[t],{stream:s&&t==i-1});r.splice(0,i),this.h.g+=e,this.C=0,o=this.h.g}else o=this.g.fa();if(this.i=200==n,function(e,t,n,r,i,s,o){e.info((function(){return"XMLHTTP RESP ("+r+") [ attempt "+i+"]: "+t+"\n"+n+"\n"+s+" "+o}))}(this.j,this.u,this.A,this.m,this.U,c,n),this.i){if(this.Z&&!this.J){t:{if(this.g){var a,l=this.g;if((a=l.g?l.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!xs(a)){var u=a;break t}}u=null}if(!(n=u)){this.i=!1,this.o=3,ea(12),Ca(this),Ia(this);break e}Wo(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.J=!0,Na(this,n)}this.P?(Ea(this,c,o),js&&this.i&&3==c&&(qo(this.S,this.T,"tick",this.hb),this.T.start())):(Wo(this.j,this.m,o,null),Na(this,o)),4==c&&Ca(this),this.i&&!this.I&&(4==c?ql(this.l,this):(this.i=!1,ka(this)))}else 400==n&&0<o.indexOf("Unknown SID")?(this.o=3,ea(12)):(this.o=0,ea(13)),Ca(this),Ia(this)}}}catch(e){}},ls.hb=function(){if(this.g){var e=Il(this.g),t=this.g.fa();this.C<t.length&&(Ta(this),Ea(this,e,t),this.i&&4!=e&&ka(this))}},ls.cancel=function(){this.I=!0,Ca(this)},ls.gb=function(){this.B=null;const e=Date.now();0<=e-this.V?(function(e,t){e.info((function(){return"TIMEOUT: "+t}))}(this.j,this.A),2!=this.K&&(Jo(),ea(17)),Ca(this),this.o=2,Ia(this)):Sa(this,this.V-e)};var Aa=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Ra(e,t){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,e instanceof Ra){this.h=void 0!==t?t:e.h,Oa(this,e.j),this.s=e.s,this.g=e.g,Pa(this,e.m),this.l=e.l,t=e.i;var n=new Ka;n.i=t.i,t.g&&(n.g=new Map(t.g),n.h=t.h),La(this,n),this.o=e.o}else e&&(n=String(e).match(Aa))?(this.h=!!t,Oa(this,n[1]||"",!0),this.s=Ua(n[2]||""),this.g=Ua(n[3]||"",!0),Pa(this,n[4]),this.l=Ua(n[5]||"",!0),La(this,n[6]||"",!0),this.o=Ua(n[7]||"")):(this.h=!!t,this.i=new Ka(null,this.h))}function Da(e){return new Ra(e)}function Oa(e,t,n){e.j=n?Ua(t,!0):t,e.j&&(e.j=e.j.replace(/:$/,""))}function Pa(e,t){if(t){if(t=Number(t),isNaN(t)||0>t)throw Error("Bad port number "+t);e.m=t}else e.m=null}function La(e,t,n){t instanceof Ka?(e.i=t,function(e,t){t&&!e.j&&(Wa(e),e.i=null,e.g.forEach((function(e,t){var n=t.toLowerCase();t!=n&&(Ga(this,t),Ya(this,n,e))}),e)),e.j=t}(e.i,e.h)):(n||(t=Va(t,qa)),e.i=new Ka(t,e.h))}function Ma(e,t,n){e.i.set(t,n)}function Fa(e){return Ma(e,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),e}function Ua(e,t){return e?t?decodeURI(e.replace(/%25/g,"%2525")):decodeURIComponent(e):""}function Va(e,t,n){return"string"==typeof e?(e=encodeURI(e).replace(t,ja),n&&(e=e.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),e):null}function ja(e){return"%"+((e=e.charCodeAt(0))>>4&15).toString(16)+(15&e).toString(16)}Ra.prototype.toString=function(){var e=[],t=this.j;t&&e.push(Va(t,za,!0),":");var n=this.g;return(n||"file"==t)&&(e.push("//"),(t=this.s)&&e.push(Va(t,za,!0),"@"),e.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),null!=(n=this.m)&&e.push(":",String(n))),(n=this.l)&&(this.g&&"/"!=n.charAt(0)&&e.push("/"),e.push(Va(n,"/"==n.charAt(0)?$a:Ba,!0))),(n=this.i.toString())&&e.push("?",n),(n=this.o)&&e.push("#",Va(n,Ha)),e.join("")};var za=/[#\/\?@]/g,Ba=/[#\?:]/g,$a=/[#\?]/g,qa=/[#\?@]/g,Ha=/#/g;function Ka(e,t){this.h=this.g=null,this.i=e||null,this.j=!!t}function Wa(e){e.g||(e.g=new Map,e.h=0,e.i&&function(e,t){if(e){e=e.split("&");for(var n=0;n<e.length;n++){var r=e[n].indexOf("="),i=null;if(0<=r){var s=e[n].substring(0,r);i=e[n].substring(r+1)}else s=e[n];t(s,i?decodeURIComponent(i.replace(/\+/g," ")):"")}}}(e.i,(function(t,n){e.add(decodeURIComponent(t.replace(/\+/g," ")),n)})))}function Ga(e,t){Wa(e),t=Xa(e,t),e.g.has(t)&&(e.i=null,e.h-=e.g.get(t).length,e.g.delete(t))}function Qa(e,t){return Wa(e),t=Xa(e,t),e.g.has(t)}function Ya(e,t,n){Ga(e,t),0<n.length&&(e.i=null,e.g.set(Xa(e,t),Ts(n)),e.h+=n.length)}function Xa(e,t){return t=String(t),e.j&&(t=t.toLowerCase()),t}(ls=Ka.prototype).add=function(e,t){Wa(this),this.i=null,e=Xa(this,e);var n=this.g.get(e);return n||this.g.set(e,n=[]),n.push(t),this.h+=1,this},ls.forEach=function(e,t){Wa(this),this.g.forEach((function(n,r){n.forEach((function(n){e.call(t,n,r,this)}),this)}),this)},ls.oa=function(){Wa(this);const e=Array.from(this.g.values()),t=Array.from(this.g.keys()),n=[];for(let r=0;r<t.length;r++){const i=e[r];for(let e=0;e<i.length;e++)n.push(t[r])}return n},ls.W=function(e){Wa(this);let t=[];if("string"==typeof e)Qa(this,e)&&(t=t.concat(this.g.get(Xa(this,e))));else{e=Array.from(this.g.values());for(let n=0;n<e.length;n++)t=t.concat(e[n])}return t},ls.set=function(e,t){return Wa(this),this.i=null,Qa(this,e=Xa(this,e))&&(this.h-=this.g.get(e).length),this.g.set(e,[t]),this.h+=1,this},ls.get=function(e,t){return e&&0<(e=this.W(e)).length?String(e[0]):t},ls.toString=function(){if(this.i)return this.i;if(!this.g)return"";const e=[],t=Array.from(this.g.keys());for(var n=0;n<t.length;n++){var r=t[n];const s=encodeURIComponent(String(r)),o=this.W(r);for(r=0;r<o.length;r++){var i=s;""!==o[r]&&(i+="="+encodeURIComponent(String(o[r]))),e.push(i)}}return this.i=e.join("&")};function Ja(e){this.l=e||Za,ds.PerformanceNavigationTiming?e=0<(e=ds.performance.getEntriesByType("navigation")).length&&("hq"==e[0].nextHopProtocol||"h2"==e[0].nextHopProtocol):e=!!(ds.g&&ds.g.Ga&&ds.g.Ga()&&ds.g.Ga().$b),this.j=e?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var Za=10;function el(e){return!!e.h||!!e.g&&e.g.size>=e.j}function tl(e){return e.h?1:e.g?e.g.size:0}function nl(e,t){return e.h?e.h==t:!!e.g&&e.g.has(t)}function rl(e,t){e.g?e.g.add(t):e.h=t}function il(e,t){e.h&&e.h==t?e.h=null:e.g&&e.g.has(t)&&e.g.delete(t)}function sl(e){if(null!=e.h)return e.i.concat(e.h.D);if(null!=e.g&&0!==e.g.size){let t=e.i;for(const n of e.g.values())t=t.concat(n.D);return t}return Ts(e.i)}function ol(){}function al(){this.g=new ol}function ll(e,t,n){const r=n||"";try{xa(e,(function(e,n){let i=e;ms(e)&&(i=Co(e)),t.push(r+n+"="+encodeURIComponent(i))}))}catch(e){throw t.push(r+"type="+encodeURIComponent("_badmap")),e}}function ul(e,t,n,r,i){try{t.onload=null,t.onerror=null,t.onabort=null,t.ontimeout=null,i(r)}catch(e){}}function cl(e){this.l=e.ac||null,this.j=e.jb||!1}function hl(e,t){So.call(this),this.D=e,this.u=t,this.m=void 0,this.readyState=dl,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Ja.prototype.cancel=function(){if(this.i=sl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&0!==this.g.size){for(const e of this.g.values())e.cancel();this.g.clear()}},ol.prototype.stringify=function(e){return ds.JSON.stringify(e,void 0)},ol.prototype.parse=function(e){return ds.JSON.parse(e,void 0)},_s(cl,sa),cl.prototype.g=function(){return new hl(this.l,this.j)},cl.prototype.i=function(e){return function(){return e}}({}),_s(hl,So);var dl=0;function fl(e){e.j.read().then(e.Ta.bind(e)).catch(e.ga.bind(e))}function pl(e){e.readyState=4,e.l=null,e.j=null,e.A=null,ml(e)}function ml(e){e.onreadystatechange&&e.onreadystatechange.call(e)}(ls=hl.prototype).open=function(e,t){if(this.readyState!=dl)throw this.abort(),Error("Error reopening a connection");this.C=e,this.B=t,this.readyState=1,ml(this)},ls.send=function(e){if(1!=this.readyState)throw this.abort(),Error("need to call open() first. ");this.g=!0;const t={headers:this.v,method:this.C,credentials:this.m,cache:void 0};e&&(t.body=e),(this.D||ds).fetch(new Request(this.B,t)).then(this.Wa.bind(this),this.ga.bind(this))},ls.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch((()=>{})),1<=this.readyState&&this.g&&4!=this.readyState&&(this.g=!1,pl(this)),this.readyState=dl},ls.Wa=function(e){if(this.g&&(this.l=e,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=e.headers,this.readyState=2,ml(this)),this.g&&(this.readyState=3,ml(this),this.g)))if("arraybuffer"===this.responseType)e.arrayBuffer().then(this.Ua.bind(this),this.ga.bind(this));else if(void 0!==ds.ReadableStream&&"body"in e){if(this.j=e.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;fl(this)}else e.text().then(this.Va.bind(this),this.ga.bind(this))},ls.Ta=function(e){if(this.g){if(this.u&&e.value)this.response.push(e.value);else if(!this.u){var t=e.value?e.value:new Uint8Array(0);(t=this.A.decode(t,{stream:!e.done}))&&(this.response=this.responseText+=t)}e.done?pl(this):ml(this),3==this.readyState&&fl(this)}},ls.Va=function(e){this.g&&(this.response=this.responseText=e,pl(this))},ls.Ua=function(e){this.g&&(this.response=e,pl(this))},ls.ga=function(){this.g&&pl(this)},ls.setRequestHeader=function(e,t){this.v.append(e,t)},ls.getResponseHeader=function(e){return this.h&&this.h.get(e.toLowerCase())||""},ls.getAllResponseHeaders=function(){if(!this.h)return"";const e=[],t=this.h.entries();for(var n=t.next();!n.done;)n=n.value,e.push(n[0]+": "+n[1]),n=t.next();return e.join("\r\n")},Object.defineProperty(hl.prototype,"withCredentials",{get:function(){return"include"===this.m},set:function(e){this.m=e?"include":"same-origin"}});var gl=ds.JSON.parse;function yl(e){So.call(this),this.headers=new Map,this.u=e||null,this.h=!1,this.C=this.g=null,this.H="",this.m=0,this.j="",this.l=this.F=this.v=this.D=!1,this.B=0,this.A=null,this.J=vl,this.K=this.L=!1}_s(yl,So);var vl="",bl=/^https?$/i,wl=["POST","PUT"];function El(e,t){e.h=!1,e.g&&(e.l=!0,e.g.abort(),e.l=!1),e.j=t,e.m=5,_l(e),Sl(e)}function _l(e){e.D||(e.D=!0,To(e,"complete"),To(e,"error"))}function kl(e){if(e.h&&void 0!==hs&&(!e.C[1]||4!=Il(e)||2!=e.aa()))if(e.v&&4==Il(e))Vo(e.Ha,0,e);else if(To(e,"readystatechange"),4==Il(e)){e.h=!1;try{const a=e.aa();e:switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var t=!0;break e;default:t=!1}var n;if(!(n=t)){var r;if(r=0===a){var i=String(e.H).match(Aa)[1]||null;if(!i&&ds.self&&ds.self.location){var s=ds.self.location.protocol;i=s.substr(0,s.length-1)}r=!bl.test(i?i.toLowerCase():"")}n=r}if(n)To(e,"complete"),To(e,"success");else{e.m=6;try{var o=2<Il(e)?e.g.statusText:""}catch(e){o=""}e.j=o+" ["+e.aa()+"]",_l(e)}}finally{Sl(e)}}}function Sl(e,t){if(e.g){Tl(e);const n=e.g,r=e.C[0]?fs:null;e.g=null,e.C=null,t||To(e,"ready");try{n.onreadystatechange=r}catch(e){}}}function Tl(e){e.g&&e.K&&(e.g.ontimeout=null),e.A&&(ds.clearTimeout(e.A),e.A=null)}function Il(e){return e.g?e.g.readyState:0}function Cl(e){try{if(!e.g)return null;if("response"in e.g)return e.g.response;switch(e.J){case vl:case"text":return e.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in e.g)return e.g.mozResponseArrayBuffer}return null}catch(e){return null}}function Nl(e){let t="";return io(e,(function(e,n){t+=n,t+=":",t+=e,t+="\r\n"})),t}function xl(e,t,n){e:{for(r in n){var r=!1;break e}r=!0}r||(n=Nl(n),"string"==typeof e?null!=n&&encodeURIComponent(String(n)):Ma(e,t,n))}function Al(e,t,n){return n&&n.internalChannelParams&&n.internalChannelParams[e]||t}function Rl(e){this.Ca=0,this.i=[],this.j=new Ko,this.ka=this.sa=this.F=this.V=this.g=this.za=this.D=this.ia=this.o=this.S=this.s=null,this.ab=this.U=0,this.Za=Al("failFast",!1,e),this.L=this.v=this.u=this.m=this.l=null,this.Y=!0,this.pa=this.Ba=this.T=-1,this.Z=this.A=this.C=0,this.Xa=Al("baseRetryDelayMs",5e3,e),this.bb=Al("retryDelaySeedMs",1e4,e),this.$a=Al("forwardChannelMaxRetries",2,e),this.ta=Al("forwardChannelRequestTimeoutMs",2e4,e),this.ra=e&&e.xmlHttpFactory||void 0,this.Da=e&&e.Zb||!1,this.J=void 0,this.H=e&&e.supportsCrossDomainXhr||!1,this.I="",this.h=new Ja(e&&e.concurrentRequestLimit),this.Fa=new al,this.O=e&&e.fastHandshake||!1,this.N=e&&e.encodeInitMessageHeaders||!1,this.O&&this.N&&(this.N=!1),this.Ya=e&&e.Xb||!1,e&&e.Aa&&this.j.Aa(),e&&e.forceLongPolling&&(this.Y=!1),this.$=!this.O&&this.Y&&e&&e.detectBufferingProxy||!1,this.ja=void 0,this.P=0,this.K=!1,this.la=this.B=null}function Dl(e){if(Pl(e),3==e.G){var t=e.U++,n=Da(e.F);Ma(n,"SID",e.I),Ma(n,"RID",t),Ma(n,"TYPE","terminate"),Fl(e,n),(t=new fa(e,e.j,t,void 0)).K=2,t.v=Fa(Da(n)),n=!1,ds.navigator&&ds.navigator.sendBeacon&&(n=ds.navigator.sendBeacon(t.v.toString(),"")),!n&&ds.Image&&((new Image).src=t.v,n=!0),n||(t.g=Ql(t.l,null),t.g.da(t.v)),t.F=Date.now(),ka(t)}Wl(e)}function Ol(e){e.g&&(zl(e),e.g.cancel(),e.g=null)}function Pl(e){Ol(e),e.u&&(ds.clearTimeout(e.u),e.u=null),$l(e),e.h.cancel(),e.m&&("number"==typeof e.m&&ds.clearTimeout(e.m),e.m=null)}function Ll(e){el(e.h)||e.m||(e.m=!0,Oo(e.Ja,e),e.C=0)}function Ml(e,t){var n;n=t?t.m:e.U++;const r=Da(e.F);Ma(r,"SID",e.I),Ma(r,"RID",n),Ma(r,"AID",e.T),Fl(e,r),e.o&&e.s&&xl(r,e.o,e.s),n=new fa(e,e.j,n,e.C+1),null===e.o&&(n.H=e.s),t&&(e.i=t.D.concat(e.i)),t=Ul(e,n,1e3),n.setTimeout(Math.round(.5*e.ta)+Math.round(.5*e.ta*Math.random())),rl(e.h,n),va(n,r,t)}function Fl(e,t){e.ia&&io(e.ia,(function(e,n){Ma(t,n,e)})),e.l&&xa({},(function(e,n){Ma(t,n,e)}))}function Ul(e,t,n){n=Math.min(e.i.length,n);var r=e.l?ws(e.l.Ra,e.l,e):null;e:{var i=e.i;let t=-1;for(;;){const e=["count="+n];-1==t?0<n?(t=i[0].h,e.push("ofs="+t)):t=0:e.push("ofs="+t);let s=!0;for(let o=0;o<n;o++){let n=i[o].h;const a=i[o].g;if(n-=t,0>n)t=Math.max(0,i[o].h-100),s=!1;else try{ll(a,e,"req"+n+"_")}catch(e){r&&r(a)}}if(s){r=e.join("&");break e}}}return e=e.i.splice(0,n),t.D=e,r}function Vl(e){e.g||e.u||(e.Z=1,Oo(e.Ia,e),e.A=0)}function jl(e){return!(e.g||e.u||3<=e.A)&&(e.Z++,e.u=na(ws(e.Ia,e),Hl(e,e.A)),e.A++,!0)}function zl(e){null!=e.B&&(ds.clearTimeout(e.B),e.B=null)}function Bl(e){e.g=new fa(e,e.j,"rpc",e.Z),null===e.o&&(e.g.H=e.s),e.g.N=0;var t=Da(e.sa);Ma(t,"RID","rpc"),Ma(t,"SID",e.I),Ma(t,"CI",e.L?"0":"1"),Ma(t,"AID",e.T),Ma(t,"TYPE","xmlhttp"),Fl(e,t),e.o&&e.s&&xl(t,e.o,e.s),e.J&&e.g.setTimeout(e.J);var n=e.g;e=e.ka,n.K=1,n.v=Fa(Da(t)),n.s=null,n.P=!0,ba(n,e)}function $l(e){null!=e.v&&(ds.clearTimeout(e.v),e.v=null)}function ql(e,t){var n=null;if(e.g==t){$l(e),zl(e),e.g=null;var r=2}else{if(!nl(e.h,t))return;n=t.D,il(e.h,t),r=1}if(0!=e.G)if(e.pa=t.Y,t.i)if(1==r){n=t.s?t.s.length:0,t=Date.now()-t.F;var i=e.C;To(r=Yo(),new ta(r,n)),Ll(e)}else Vl(e);else if(3==(i=t.o)||0==i&&0<e.pa||!(1==r&&function(e,t){return!(tl(e.h)>=e.h.j-(e.m?1:0)||(e.m?(e.i=t.D.concat(e.i),0):1==e.G||2==e.G||e.C>=(e.Za?0:e.$a)||(e.m=na(ws(e.Ja,e,t),Hl(e,e.C)),e.C++,0)))}(e,t)||2==r&&jl(e)))switch(n&&0<n.length&&(t=e.h,t.i=t.i.concat(n)),i){case 1:Kl(e,5);break;case 4:Kl(e,10);break;case 3:Kl(e,6);break;default:Kl(e,2)}}function Hl(e,t){let n=e.Xa+Math.floor(Math.random()*e.bb);return e.l||(n*=2),n*t}function Kl(e,t){if(e.j.info("Error code "+t),2==t){var n=null;e.l&&(n=null);var r=ws(e.kb,e);n||(n=new Ra("//www.google.com/images/cleardot.gif"),ds.location&&"http"==ds.location.protocol||Oa(n,"https"),Fa(n)),function(e,t){const n=new Ko;if(ds.Image){const r=new Image;r.onload=Es(ul,n,r,"TestLoadImage: loaded",!0,t),r.onerror=Es(ul,n,r,"TestLoadImage: error",!1,t),r.onabort=Es(ul,n,r,"TestLoadImage: abort",!1,t),r.ontimeout=Es(ul,n,r,"TestLoadImage: timeout",!1,t),ds.setTimeout((function(){r.ontimeout&&r.ontimeout()}),1e4),r.src=e}else t(!1)}(n.toString(),r)}else ea(2);e.G=0,e.l&&e.l.va(t),Wl(e),Pl(e)}function Wl(e){if(e.G=0,e.la=[],e.l){const t=sl(e.h);0==t.length&&0==e.i.length||(Is(e.la,t),Is(e.la,e.i),e.h.i.length=0,Ts(e.i),e.i.length=0),e.l.ua()}}function Gl(e,t,n){var r=n instanceof Ra?Da(n):new Ra(n,void 0);if(""!=r.g)t&&(r.g=t+"."+r.g),Pa(r,r.m);else{var i=ds.location;r=i.protocol,t=t?t+"."+i.hostname:i.hostname,i=+i.port;var s=new Ra(null,void 0);r&&Oa(s,r),t&&(s.g=t),i&&Pa(s,i),n&&(s.l=n),r=s}return n=e.D,t=e.za,n&&t&&Ma(r,n,t),Ma(r,"VER",e.ma),Fl(e,r),r}function Ql(e,t,n){if(t&&!e.H)throw Error("Can't create secondary domain capable XhrIo object.");return(t=n&&e.Da&&!e.ra?new yl(new cl({jb:!0})):new yl(e.ra)).Ka(e.H),t}function Yl(){}function Xl(){if(Us&&!(10<=Number(Xs)))throw Error("Environmental error: no available transport.")}function Jl(e,t){So.call(this),this.g=new Rl(t),this.l=e,this.h=t&&t.messageUrlParams||null,e=t&&t.messageHeaders||null,t&&t.clientProtocolHeaderRequired&&(e?e["X-Client-Protocol"]="webchannel":e={"X-Client-Protocol":"webchannel"}),this.g.s=e,e=t&&t.initMessageHeaders||null,t&&t.messageContentType&&(e?e["X-WebChannel-Content-Type"]=t.messageContentType:e={"X-WebChannel-Content-Type":t.messageContentType}),t&&t.ya&&(e?e["X-WebChannel-Client-Profile"]=t.ya:e={"X-WebChannel-Client-Profile":t.ya}),this.g.S=e,(e=t&&t.Yb)&&!xs(e)&&(this.g.o=e),this.A=t&&t.supportsCrossDomainXhr||!1,this.v=t&&t.sendRawJson||!1,(t=t&&t.httpSessionIdParam)&&!xs(t)&&(this.g.D=t,null!==(e=this.h)&&t in e&&(t in(e=this.h)&&delete e[t])),this.j=new tu(this)}function Zl(e){ca.call(this);var t=e.__sm__;if(t){e:{for(const n in t){e=n;break e}e=void 0}(this.i=e)&&(e=this.i,t=null!==t&&e in t?t[e]:void 0),this.data=t}else this.data=e}function eu(){ha.call(this),this.status=1}function tu(e){this.g=e}(ls=yl.prototype).Ka=function(e){this.L=e},ls.da=function(e,t,n,r){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.H+"; newUri="+e);t=t?t.toUpperCase():"GET",this.H=e,this.j="",this.m=0,this.D=!1,this.h=!0,this.g=this.u?this.u.g():la.g(),this.C=this.u?oa(this.u):oa(la),this.g.onreadystatechange=ws(this.Ha,this);try{this.F=!0,this.g.open(t,String(e),!0),this.F=!1}catch(e){return void El(this,e)}if(e=n||"",n=new Map(this.headers),r)if(Object.getPrototypeOf(r)===Object.prototype)for(var i in r)n.set(i,r[i]);else{if("function"!=typeof r.keys||"function"!=typeof r.get)throw Error("Unknown input type for opt_headers: "+String(r));for(const e of r.keys())n.set(e,r.get(e))}r=Array.from(n.keys()).find((e=>"content-type"==e.toLowerCase())),i=ds.FormData&&e instanceof ds.FormData,!(0<=Ss(wl,t))||r||i||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[e,t]of n)this.g.setRequestHeader(e,t);this.J&&(this.g.responseType=this.J),"withCredentials"in this.g&&this.g.withCredentials!==this.L&&(this.g.withCredentials=this.L);try{Tl(this),0<this.B&&((this.K=function(e){return Us&&Qs()&&"number"==typeof e.timeout&&void 0!==e.ontimeout}(this.g))?(this.g.timeout=this.B,this.g.ontimeout=ws(this.qa,this)):this.A=Vo(this.qa,this.B,this)),this.v=!0,this.g.send(e),this.v=!1}catch(e){El(this,e)}},ls.qa=function(){void 0!==hs&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,To(this,"timeout"),this.abort(8))},ls.abort=function(e){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=e||7,To(this,"complete"),To(this,"abort"),Sl(this))},ls.M=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Sl(this,!0)),yl.X.M.call(this)},ls.Ha=function(){this.s||(this.F||this.v||this.l?kl(this):this.fb())},ls.fb=function(){kl(this)},ls.aa=function(){try{return 2<Il(this)?this.g.status:-1}catch(e){return-1}},ls.fa=function(){try{return this.g?this.g.responseText:""}catch(e){return""}},ls.Sa=function(e){if(this.g){var t=this.g.responseText;return e&&0==t.indexOf(e)&&(t=t.substring(e.length)),gl(t)}},ls.Ea=function(){return this.m},ls.Oa=function(){return"string"==typeof this.j?this.j:String(this.j)},(ls=Rl.prototype).ma=8,ls.G=1,ls.Ja=function(e){if(this.m)if(this.m=null,1==this.G){if(!e){this.U=Math.floor(1e5*Math.random()),e=this.U++;const i=new fa(this,this.j,e,void 0);let s=this.s;if(this.S&&(s?(s=so(s),ao(s,this.S)):s=this.S),null!==this.o||this.N||(i.H=s,s=null),this.O)e:{for(var t=0,n=0;n<this.i.length;n++){var r=this.i[n];if(void 0===(r="__data__"in r.g&&"string"==typeof(r=r.g.__data__)?r.length:void 0))break;if(4096<(t+=r)){t=n;break e}if(4096===t||n===this.i.length-1){t=n+1;break e}}t=1e3}else t=1e3;t=Ul(this,i,t),Ma(n=Da(this.F),"RID",e),Ma(n,"CVER",22),this.D&&Ma(n,"X-HTTP-Session-Id",this.D),Fl(this,n),s&&(this.N?t="headers="+encodeURIComponent(String(Nl(s)))+"&"+t:this.o&&xl(n,this.o,s)),rl(this.h,i),this.Ya&&Ma(n,"TYPE","init"),this.O?(Ma(n,"$req",t),Ma(n,"SID","null"),i.Z=!0,va(i,n,null)):va(i,n,t),this.G=2}}else 3==this.G&&(e?Ml(this,e):0==this.i.length||el(this.h)||Ml(this))},ls.Ia=function(){if(this.u=null,Bl(this),this.$&&!(this.K||null==this.g||0>=this.P)){var e=2*this.P;this.j.info("BP detection timer enabled: "+e),this.B=na(ws(this.eb,this),e)}},ls.eb=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.L=!1,this.K=!0,ea(10),Ol(this),Bl(this))},ls.cb=function(){null!=this.v&&(this.v=null,Ol(this),jl(this),ea(19))},ls.kb=function(e){e?(this.j.info("Successfully pinged google.com"),ea(2)):(this.j.info("Failed to ping google.com"),ea(1))},(ls=Yl.prototype).xa=function(){},ls.wa=function(){},ls.va=function(){},ls.ua=function(){},ls.Ra=function(){},Xl.prototype.g=function(e,t){return new Jl(e,t)},_s(Jl,So),Jl.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.H=!0);var e=this.g,t=this.l,n=this.h||void 0;ea(0),e.V=t,e.ia=n||{},e.L=e.Y,e.F=Gl(e,null,e.V),Ll(e)},Jl.prototype.close=function(){Dl(this.g)},Jl.prototype.u=function(e){var t=this.g;if("string"==typeof e){var n={};n.__data__=e,e=n}else this.v&&((n={}).__data__=Co(e),e=n);t.i.push(new class{constructor(e,t){this.h=e,this.g=t}}(t.ab++,e)),3==t.G&&Ll(t)},Jl.prototype.M=function(){this.g.l=null,delete this.j,Dl(this.g),delete this.g,Jl.X.M.call(this)},_s(Zl,ca),_s(eu,ha),_s(tu,Yl),tu.prototype.xa=function(){To(this.g,"a")},tu.prototype.wa=function(e){To(this.g,new Zl(e))},tu.prototype.va=function(e){To(this.g,new eu)},tu.prototype.ua=function(){To(this.g,"b")},Xl.prototype.createWebChannel=Xl.prototype.g,Jl.prototype.send=Jl.prototype.u,Jl.prototype.open=Jl.prototype.m,Jl.prototype.close=Jl.prototype.close,ra.NO_ERROR=0,ra.TIMEOUT=8,ra.HTTP_ERROR=6,ia.COMPLETE="complete",aa.EventType=ua,ua.OPEN="a",ua.CLOSE="b",ua.ERROR="c",ua.MESSAGE="d",So.prototype.listen=So.prototype.N,yl.prototype.listenOnce=yl.prototype.O,yl.prototype.getLastError=yl.prototype.Oa,yl.prototype.getLastErrorCode=yl.prototype.Ea,yl.prototype.getStatus=yl.prototype.aa,yl.prototype.getResponseJson=yl.prototype.Sa,yl.prototype.getResponseText=yl.prototype.fa,yl.prototype.send=yl.prototype.da,yl.prototype.setWithCredentials=yl.prototype.Ka;var nu=cs.createWebChannelTransport=function(){return new Xl},ru=cs.getStatEventTarget=function(){return Yo()},iu=cs.ErrorCode=ra,su=cs.EventType=ia,ou=cs.Event=Go,au=cs.Stat={sb:0,vb:1,wb:2,Pb:3,Ub:4,Rb:5,Sb:6,Qb:7,Ob:8,Tb:9,PROXY:10,NOPROXY:11,Mb:12,Ib:13,Jb:14,Hb:15,Kb:16,Lb:17,ob:18,nb:19,pb:20},lu=cs.FetchXmlHttpFactory=cl,uu=cs.WebChannel=aa,cu=cs.XhrIo=yl;const hu="@firebase/firestore";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class du{isAuthenticated(){return null!=this.uid}toKey(){return this.isAuthenticated()?"uid:"+this.uid:"anonymous-user"}isEqual(e){return e.uid===this.uid}constructor(e){this.uid=e}}du.UNAUTHENTICATED=new du(null),du.GOOGLE_CREDENTIALS=new du("google-credentials-uid"),du.FIRST_PARTY=new du("first-party-uid"),du.MOCK_USER=new du("mock-user");
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pu=new st("@firebase/firestore");function mu(){return pu.logLevel}function gu(e,...t){if(pu.logLevel<=Ze.DEBUG){const n=t.map(bu);pu.debug(`Firestore (${fu}): ${e}`,...n)}}function yu(e,...t){if(pu.logLevel<=Ze.ERROR){const n=t.map(bu);pu.error(`Firestore (${fu}): ${e}`,...n)}}function vu(e,...t){if(pu.logLevel<=Ze.WARN){const n=t.map(bu);pu.warn(`Firestore (${fu}): ${e}`,...n)}}function bu(e){if("string"==typeof e)return e;try{return t=e,JSON.stringify(t)}catch(t){return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wu(e="Unexpected state"){const t=`FIRESTORE (${fu}) INTERNAL ASSERTION FAILED: `+e;throw yu(t),new Error(t)}function Eu(e,t){e||wu()}function _u(e,t){return e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ku={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class Su extends Le{constructor(e,t){super(e,t),this.code=e,this.message=t,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Cu{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(du.UNAUTHENTICATED)))}shutdown(){}}class Nu{getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}constructor(e){this.token=e,this.changeListener=null}}class xu{start(e,t){let n=this.i;const r=e=>this.i!==n?(n=this.i,t(e)):Promise.resolve();let i=new Tu;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Tu,e.enqueueRetryable((()=>r(this.currentUser)))};const s=()=>{const t=i;e.enqueueRetryable((async()=>{await t.promise,await r(this.currentUser)}))},o=e=>{gu("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=e,this.auth.addAuthTokenListener(this.o),s()};this.t.onInit((e=>o(e))),setTimeout((()=>{if(!this.auth){const e=this.t.getImmediate({optional:!0});e?o(e):(gu("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Tu)}}),0),s()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((t=>this.i!==e?(gu("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?(Eu("string"==typeof t.accessToken),new Iu(t.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Eu(null===e||"string"==typeof e),new du(e)}constructor(e){this.t=e,this.currentUser=du.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}}class Au{p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const e=this.p();return e&&this.g.set("Authorization",e),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}constructor(e,t,n){this.h=e,this.l=t,this.m=n,this.type="FirstParty",this.user=du.FIRST_PARTY,this.g=new Map}}class Ru{getToken(){return Promise.resolve(new Au(this.h,this.l,this.m))}start(e,t){e.enqueueRetryable((()=>t(du.FIRST_PARTY)))}shutdown(){}invalidateToken(){}constructor(e,t,n){this.h=e,this.l=t,this.m=n}}class Du{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Ou{start(e,t){const n=e=>{null!=e.error&&gu("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);const n=e.token!==this.T;return this.T=e.token,gu("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable((()=>n(t)))};const r=e=>{gu("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.appCheck.addTokenListener(this.o)};this.I.onInit((e=>r(e))),setTimeout((()=>{if(!this.appCheck){const e=this.I.getImmediate({optional:!0});e?r(e):gu("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((e=>e?(Eu("string"==typeof e.token),this.T=e.token,new Du(e.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}constructor(e){this.I=e,this.forceRefresh=!1,this.appCheck=null,this.T=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Pu(e){const t="undefined"!=typeof self&&(self.crypto||self.msCrypto),n=new Uint8Array(e);if(t&&"function"==typeof t.getRandomValues)t.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(256*Math.random());return n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lu{static A(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=Math.floor(256/e.length)*e.length;let n="";for(;n.length<20;){const r=Pu(40);for(let i=0;i<r.length;++i)n.length<20&&r[i]<t&&(n+=e.charAt(r[i]%e.length))}return n}}function Mu(e,t){return e<t?-1:e>t?1:0}function Fu(e,t,n){return e.length===t.length&&e.every(((e,r)=>n(e,t[r])))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Uu{static now(){return Uu.fromMillis(Date.now())}static fromDate(e){return Uu.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),n=Math.floor(1e6*(e-1e3*t));return new Uu(t,n)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/1e6}_compareTo(e){return this.seconds===e.seconds?Mu(this.nanoseconds,e.nanoseconds):Mu(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds- -62135596800;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new Su(ku.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new Su(ku.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<-62135596800)throw new Su(ku.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new Su(ku.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu{static fromTimestamp(e){return new Vu(e)}static min(){return new Vu(new Uu(0,0))}static max(){return new Vu(new Uu(253402300799,999999999))}compareTo(e){return this.timestamp._compareTo(e.timestamp)}isEqual(e){return this.timestamp.isEqual(e.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}constructor(e){this.timestamp=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ju{get length(){return this.len}isEqual(e){return 0===ju.comparator(this,e)}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof ju?e.forEach((e=>{t.push(e)})):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=void 0===e?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return 0===this.length}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,n=this.limit();t<n;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const n=Math.min(e.length,t.length);for(let r=0;r<n;r++){const n=e.get(r),i=t.get(r);if(n<i)return-1;if(n>i)return 1}return e.length<t.length?-1:e.length>t.length?1:0}constructor(e,t,n){void 0===t?t=0:t>e.length&&wu(),void 0===n?n=e.length-t:n>e.length-t&&wu(),this.segments=e,this.offset=t,this.len=n}}class zu extends ju{construct(e,t,n){return new zu(e,t,n)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}static fromString(...e){const t=[];for(const n of e){if(n.indexOf("//")>=0)throw new Su(ku.INVALID_ARGUMENT,`Invalid segment (${n}). Paths must not contain // in them.`);t.push(...n.split("/").filter((e=>e.length>0)))}return new zu(t)}static emptyPath(){return new zu([])}}const Bu=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class $u extends ju{construct(e,t,n){return new $u(e,t,n)}static isValidIdentifier(e){return Bu.test(e)}canonicalString(){return this.toArray().map((e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),$u.isValidIdentifier(e)||(e="`"+e+"`"),e))).join(".")}toString(){return this.canonicalString()}isKeyField(){return 1===this.length&&"__name__"===this.get(0)}static keyField(){return new $u(["__name__"])}static fromServerFormat(e){const t=[];let n="",r=0;const i=()=>{if(0===n.length)throw new Su(ku.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(n),n=""};let s=!1;for(;r<e.length;){const t=e[r];if("\\"===t){if(r+1===e.length)throw new Su(ku.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const t=e[r+1];if("\\"!==t&&"."!==t&&"`"!==t)throw new Su(ku.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);n+=t,r+=2}else"`"===t?(s=!s,r++):"."!==t||s?(n+=t,r++):(i(),r++)}if(i(),s)throw new Su(ku.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new $u(t)}static emptyPath(){return new $u([])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qu{static fromPath(e){return new qu(zu.fromString(e))}static fromName(e){return new qu(zu.fromString(e).popFirst(5))}static empty(){return new qu(zu.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===zu.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return zu.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new qu(new zu(e.slice()))}constructor(e){this.path=e}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hu{constructor(e,t,n,r){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=r}}Hu.UNKNOWN_ID=-1;function Ku(e,t){const n=e.toTimestamp().seconds,r=e.toTimestamp().nanoseconds+1,i=Vu.fromTimestamp(1e9===r?new Uu(n+1,0):new Uu(n,r));return new Gu(i,qu.empty(),t)}function Wu(e){return new Gu(e.readTime,e.key,-1)}class Gu{static min(){return new Gu(Vu.min(),qu.empty(),-1)}static max(){return new Gu(Vu.max(),qu.empty(),-1)}constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}}function Qu(e,t){let n=e.readTime.compareTo(t.readTime);return 0!==n?n:(n=qu.comparator(e.documentKey,t.documentKey),0!==n?n:Mu(e.largestBatchId,t.largestBatchId))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yu="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Xu{addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}constructor(){this.onCommittedListeners=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ju(e){if(e.code!==ku.FAILED_PRECONDITION||e.message!==Yu)throw e;gu("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zu{catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&wu(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new Zu(((n,r)=>{this.nextCallback=t=>{this.wrapSuccess(e,t).next(n,r)},this.catchCallback=e=>{this.wrapFailure(t,e).next(n,r)}}))}toPromise(){return new Promise(((e,t)=>{this.next(e,t)}))}wrapUserFunction(e){try{const t=e();return t instanceof Zu?t:Zu.resolve(t)}catch(e){return Zu.reject(e)}}wrapSuccess(e,t){return e?this.wrapUserFunction((()=>e(t))):Zu.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction((()=>e(t))):Zu.reject(t)}static resolve(e){return new Zu(((t,n)=>{t(e)}))}static reject(e){return new Zu(((t,n)=>{n(e)}))}static waitFor(e){return new Zu(((t,n)=>{let r=0,i=0,s=!1;e.forEach((e=>{++r,e.next((()=>{++i,s&&i===r&&t()}),(e=>n(e)))})),s=!0,i===r&&t()}))}static or(e){let t=Zu.resolve(!1);for(const n of e)t=t.next((e=>e?Zu.resolve(e):n()));return t}static forEach(e,t){const n=[];return e.forEach(((e,r)=>{n.push(t.call(this,e,r))})),this.waitFor(n)}static mapArray(e,t){return new Zu(((n,r)=>{const i=e.length,s=new Array(i);let o=0;for(let a=0;a<i;a++){const l=a;t(e[l]).next((e=>{s[l]=e,++o,o===i&&n(s)}),(e=>r(e)))}}))}static doWhile(e,t){return new Zu(((n,r)=>{const i=()=>{!0===e()?t().next((()=>{i()}),r):n()};i()}))}constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e((e=>{this.isDone=!0,this.result=e,this.nextCallback&&this.nextCallback(e)}),(e=>{this.isDone=!0,this.error=e,this.catchCallback&&this.catchCallback(e)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class tc{ot(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.ut&&this.ut(e),e}constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=e=>this.ot(e),this.ut=e=>t.writeSequenceNumber(e))}}function nc(e){return null==e}function rc(e){return 0===e&&1/e==-1/0}function ic(e){return"number"==typeof e&&Number.isInteger(e)&&!rc(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function lc(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function uc(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function cc(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vc{static fromBase64String(e){const t=function(e){try{return atob(e)}catch(e){throw"undefined"!=typeof DOMException&&e instanceof DOMException?new yc("Invalid base64 string: "+e):e}}(e);return new vc(t)}static fromUint8Array(e){const t=function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new vc(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){var e;return e=this.binaryString,btoa(e)}toUint8Array(){return function(e){const t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Mu(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}constructor(e){this.binaryString=e}}vc.EMPTY_BYTE_STRING=new vc("");const bc=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function wc(e){if(Eu(!!e),"string"==typeof e){let t=0;const n=bc.exec(e);if(Eu(!!n),n[1]){let e=n[1];e=(e+"000000000").substr(0,9),t=Number(e)}const r=new Date(e);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:Ec(e.seconds),nanos:Ec(e.nanos)}}function Ec(e){return"number"==typeof e?e:"string"==typeof e?Number(e):0}function _c(e){return"string"==typeof e?vc.fromBase64String(e):vc.fromUint8Array(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kc(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function Sc(e){const t=e.mapValue.fields.__previous_value__;return kc(t)?Sc(t):t}function Tc(e){const t=wc(e.mapValue.fields.__local_write_time__.timestampValue);return new Uu(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ic{constructor(e,t,n,r,i,s,o,a){this.databaseId=e,this.appId=t,this.persistenceKey=n,this.host=r,this.ssl=i,this.forceLongPolling=s,this.autoDetectLongPolling=o,this.useFetchStreams=a}}class Cc{static empty(){return new Cc("","")}get isDefaultDatabase(){return"(default)"===this.database}isEqual(e){return e instanceof Cc&&e.projectId===this.projectId&&e.database===this.database}constructor(e,t){this.projectId=e,this.database=t||"(default)"}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nc={mapValue:{fields:{__type__:{stringValue:"__max__"}}}};function xc(e){return"nullValue"in e?0:"booleanValue"in e?1:"integerValue"in e||"doubleValue"in e?2:"timestampValue"in e?3:"stringValue"in e?5:"bytesValue"in e?6:"referenceValue"in e?7:"geoPointValue"in e?8:"arrayValue"in e?9:"mapValue"in e?kc(e)?4:$c(e)?9007199254740991:10:wu()}function Ac(e,t){if(e===t)return!0;const n=xc(e);if(n!==xc(t))return!1;switch(n){case 0:case 9007199254740991:return!0;case 1:return e.booleanValue===t.booleanValue;case 4:return Tc(e).isEqual(Tc(t));case 3:return function(e,t){if("string"==typeof e.timestampValue&&"string"==typeof t.timestampValue&&e.timestampValue.length===t.timestampValue.length)return e.timestampValue===t.timestampValue;const n=wc(e.timestampValue),r=wc(t.timestampValue);return n.seconds===r.seconds&&n.nanos===r.nanos}(e,t);case 5:return e.stringValue===t.stringValue;case 6:return function(e,t){return _c(e.bytesValue).isEqual(_c(t.bytesValue))}(e,t);case 7:return e.referenceValue===t.referenceValue;case 8:return function(e,t){return Ec(e.geoPointValue.latitude)===Ec(t.geoPointValue.latitude)&&Ec(e.geoPointValue.longitude)===Ec(t.geoPointValue.longitude)}(e,t);case 2:return function(e,t){if("integerValue"in e&&"integerValue"in t)return Ec(e.integerValue)===Ec(t.integerValue);if("doubleValue"in e&&"doubleValue"in t){const n=Ec(e.doubleValue),r=Ec(t.doubleValue);return n===r?rc(n)===rc(r):isNaN(n)&&isNaN(r)}return!1}(e,t);case 9:return Fu(e.arrayValue.values||[],t.arrayValue.values||[],Ac);case 10:return function(e,t){const n=e.mapValue.fields||{},r=t.mapValue.fields||{};if(lc(n)!==lc(r))return!1;for(const e in n)if(n.hasOwnProperty(e)&&(void 0===r[e]||!Ac(n[e],r[e])))return!1;return!0}(e,t);default:return wu()}}function Rc(e,t){return void 0!==(e.values||[]).find((e=>Ac(e,t)))}function Dc(e,t){if(e===t)return 0;const n=xc(e),r=xc(t);if(n!==r)return Mu(n,r);switch(n){case 0:case 9007199254740991:return 0;case 1:return Mu(e.booleanValue,t.booleanValue);case 2:return function(e,t){const n=Ec(e.integerValue||e.doubleValue),r=Ec(t.integerValue||t.doubleValue);return n<r?-1:n>r?1:n===r?0:isNaN(n)?isNaN(r)?0:-1:1}(e,t);case 3:return Oc(e.timestampValue,t.timestampValue);case 4:return Oc(Tc(e),Tc(t));case 5:return Mu(e.stringValue,t.stringValue);case 6:return function(e,t){const n=_c(e),r=_c(t);return n.compareTo(r)}(e.bytesValue,t.bytesValue);case 7:return function(e,t){const n=e.split("/"),r=t.split("/");for(let e=0;e<n.length&&e<r.length;e++){const t=Mu(n[e],r[e]);if(0!==t)return t}return Mu(n.length,r.length)}(e.referenceValue,t.referenceValue);case 8:return function(e,t){const n=Mu(Ec(e.latitude),Ec(t.latitude));return 0!==n?n:Mu(Ec(e.longitude),Ec(t.longitude))}(e.geoPointValue,t.geoPointValue);case 9:return function(e,t){const n=e.values||[],r=t.values||[];for(let e=0;e<n.length&&e<r.length;++e){const t=Dc(n[e],r[e]);if(t)return t}return Mu(n.length,r.length)}(e.arrayValue,t.arrayValue);case 10:return function(e,t){if(e===Nc.mapValue&&t===Nc.mapValue)return 0;if(e===Nc.mapValue)return 1;if(t===Nc.mapValue)return-1;const n=e.fields||{},r=Object.keys(n),i=t.fields||{},s=Object.keys(i);r.sort(),s.sort();for(let e=0;e<r.length&&e<s.length;++e){const t=Mu(r[e],s[e]);if(0!==t)return t;const o=Dc(n[r[e]],i[s[e]]);if(0!==o)return o}return Mu(r.length,s.length)}(e.mapValue,t.mapValue);default:throw wu()}}function Oc(e,t){if("string"==typeof e&&"string"==typeof t&&e.length===t.length)return Mu(e,t);const n=wc(e),r=wc(t),i=Mu(n.seconds,r.seconds);return 0!==i?i:Mu(n.nanos,r.nanos)}function Pc(e){return Lc(e)}function Lc(e){var t,n;return"nullValue"in e?"null":"booleanValue"in e?""+e.booleanValue:"integerValue"in e?""+e.integerValue:"doubleValue"in e?""+e.doubleValue:"timestampValue"in e?function(e){const t=wc(e);return`time(${t.seconds},${t.nanos})`}(e.timestampValue):"stringValue"in e?e.stringValue:"bytesValue"in e?_c(e.bytesValue).toBase64():"referenceValue"in e?(n=e.referenceValue,qu.fromName(n).toString()):"geoPointValue"in e?`geo(${(t=e.geoPointValue).latitude},${t.longitude})`:"arrayValue"in e?function(e){let t="[",n=!0;for(const r of e.values||[])n?n=!1:t+=",",t+=Lc(r);return t+"]"}(e.arrayValue):"mapValue"in e?function(e){const t=Object.keys(e.fields||{}).sort();let n="{",r=!0;for(const i of t)r?r=!1:n+=",",n+=`${i}:${Lc(e.fields[i])}`;return n+"}"}(e.mapValue):wu()}function Mc(e,t){return{referenceValue:`projects/${e.projectId}/databases/${e.database}/documents/${t.path.canonicalString()}`}}function Fc(e){return!!e&&"integerValue"in e}function Uc(e){return!!e&&"arrayValue"in e}function Vc(e){return!!e&&"nullValue"in e}function jc(e){return!!e&&"doubleValue"in e&&isNaN(Number(e.doubleValue))}function zc(e){return!!e&&"mapValue"in e}function Bc(e){if(e.geoPointValue)return{geoPointValue:Object.assign({},e.geoPointValue)};if(e.timestampValue&&"object"==typeof e.timestampValue)return{timestampValue:Object.assign({},e.timestampValue)};if(e.mapValue){const t={mapValue:{fields:{}}};return uc(e.mapValue.fields,((e,n)=>t.mapValue.fields[e]=Bc(n))),t}if(e.arrayValue){const t={arrayValue:{values:[]}};for(let n=0;n<(e.arrayValue.values||[]).length;++n)t.arrayValue.values[n]=Bc(e.arrayValue.values[n]);return t}return Object.assign({},e)}function $c(e){return"__max__"===(((e.mapValue||{}).fields||{}).__type__||{}).stringValue}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class qc{static empty(){return new qc({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!zc(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Bc(t)}setAll(e){let t=$u.emptyPath(),n={},r=[];e.forEach(((e,i)=>{if(!t.isImmediateParentOf(i)){const e=this.getFieldsMap(t);this.applyChanges(e,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=Bc(e):r.push(i.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,n,r)}delete(e){const t=this.field(e.popLast());zc(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ac(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];zc(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}applyChanges(e,t,n){uc(t,((t,n)=>e[t]=n));for(const t of n)delete e[t]}clone(){return new qc(Bc(this.value))}constructor(e){this.value=e}}function Hc(e){const t=[];return uc(e.fields,((e,n)=>{const r=new $u([e]);if(zc(n)){const e=Hc(n.mapValue).fields;if(0===e.length)t.push(r);else for(const n of e)t.push(r.child(n))}else t.push(r)})),new gc(t)
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wc{constructor(e,t){this.position=e,this.inclusive=t}}function Gc(e,t,n){let r=0;for(let i=0;i<e.position.length;i++){const s=t[i],o=e.position[i];if(r=s.field.isKeyField()?qu.comparator(qu.fromName(o.referenceValue),n.key):Dc(o,n.data.field(s.field)),"desc"===s.dir&&(r*=-1),0!==r)break}return r}function Qc(e,t){if(null===e)return null===t;if(null===t)return!1;if(e.inclusive!==t.inclusive||e.position.length!==t.position.length)return!1;for(let n=0;n<e.position.length;n++)if(!Ac(e.position[n],t.position[n]))return!1;return!0}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yc{constructor(e,t="asc"){this.field=e,this.dir=t}}function Xc(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc{}class Zc extends Jc{static create(e,t,n){return e.isKeyField()?"in"===t||"not-in"===t?this.createKeyFieldInFilter(e,t,n):new ah(e,t,n):"array-contains"===t?new hh(e,n):"in"===t?new dh(e,n):"not-in"===t?new fh(e,n):"array-contains-any"===t?new ph(e,n):new Zc(e,t,n)}static createKeyFieldInFilter(e,t,n){return"in"===t?new lh(e,n):new uh(e,n)}matches(e){const t=e.data.field(this.field);return"!="===this.op?null!==t&&this.matchesComparison(Dc(t,this.value)):null!==t&&xc(this.value)===xc(t)&&this.matchesComparison(Dc(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return wu()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}}class eh extends Jc{static create(e,t){return new eh(e,t)}matches(e){return th(this)?void 0===this.filters.find((t=>!t.matches(e))):void 0!==this.filters.find((t=>t.matches(e)))}getFlattenedFilters(){return null!==this.ht||(this.ht=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.ht}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const e=this.lt((e=>e.isInequality()));return null!==e?e.field:null}lt(e){for(const t of this.getFlattenedFilters())if(e(t))return t;return null}constructor(e,t){super(),this.filters=e,this.op=t,this.ht=null}}function th(e){return"and"===e.op}function nh(e){return rh(e)&&th(e)}function rh(e){for(const t of e.filters)if(t instanceof eh)return!1;return!0}function ih(e){if(e instanceof Zc)return e.field.canonicalString()+e.op.toString()+Pc(e.value);if(nh(e))return e.filters.map((e=>ih(e))).join(",");{const t=e.filters.map((e=>ih(e))).join(",");return`${e.op}(${t})`}}function sh(e,t){return e instanceof Zc?function(e,t){return t instanceof Zc&&e.op===t.op&&e.field.isEqual(t.field)&&Ac(e.value,t.value)}(e,t):e instanceof eh?function(e,t){return t instanceof eh&&e.op===t.op&&e.filters.length===t.filters.length&&e.filters.reduce(((e,n,r)=>e&&sh(n,t.filters[r])),!0)}(e,t):void wu()}function oh(e){return e instanceof Zc?function(e){return`${e.field.canonicalString()} ${e.op} ${Pc(e.value)}`}(e):e instanceof eh?function(e){return e.op.toString()+" {"+e.getFilters().map(oh).join(" ,")+"}"}(e):"Filter"}class ah extends Zc{matches(e){const t=qu.comparator(e.key,this.key);return this.matchesComparison(t)}constructor(e,t,n){super(e,t,n),this.key=qu.fromName(n.referenceValue)}}class lh extends Zc{matches(e){return this.keys.some((t=>t.isEqual(e.key)))}constructor(e,t){super(e,"in",t),this.keys=ch("in",t)}}class uh extends Zc{matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}constructor(e,t){super(e,"not-in",t),this.keys=ch("not-in",t)}}function ch(e,t){var n;return((null===(n=t.arrayValue)||void 0===n?void 0:n.values)||[]).map((e=>qu.fromName(e.referenceValue)))}class hh extends Zc{matches(e){const t=e.data.field(this.field);return Uc(t)&&Rc(t.arrayValue,this.value)}constructor(e,t){super(e,"array-contains",t)}}class dh extends Zc{matches(e){const t=e.data.field(this.field);return null!==t&&Rc(this.value.arrayValue,t)}constructor(e,t){super(e,"in",t)}}class fh extends Zc{matches(e){if(Rc(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return null!==t&&!Rc(this.value.arrayValue,t)}constructor(e,t){super(e,"not-in",t)}}class ph extends Zc{matches(e){const t=e.data.field(this.field);return!(!Uc(t)||!t.arrayValue.values)&&t.arrayValue.values.some((e=>Rc(this.value.arrayValue,e)))}constructor(e,t){super(e,"array-contains-any",t)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mh{constructor(e,t=null,n=[],r=[],i=null,s=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=r,this.limit=i,this.startAt=s,this.endAt=o,this.ft=null}}function gh(e,t=null,n=[],r=[],i=null,s=null,o=null){return new mh(e,t,n,r,i,s,o)}function yh(e){const t=_u(e);if(null===t.ft){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map((e=>ih(e))).join(","),e+="|ob:",e+=t.orderBy.map((e=>function(e){return e.field.canonicalString()+e.dir}(e))).join(","),nc(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map((e=>Pc(e))).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map((e=>Pc(e))).join(",")),t.ft=e}return t.ft}function vh(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++)if(!Xc(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let n=0;n<e.filters.length;n++)if(!sh(e.filters[n],t.filters[n]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!Qc(e.startAt,t.startAt)&&Qc(e.endAt,t.endAt)}function bh(e){return qu.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class wh{constructor(e,t=null,n=[],r=[],i=null,s="F",o=null,a=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=r,this.limit=i,this.limitType=s,this.startAt=o,this.endAt=a,this.dt=null,this.wt=null,this.startAt,this.endAt}}function Eh(e,t,n,r,i,s,o,a){return new wh(e,t,n,r,i,s,o,a)}function _h(e){return new wh(e)}function kh(e){return 0===e.filters.length&&null===e.limit&&null==e.startAt&&null==e.endAt&&(0===e.explicitOrderBy.length||1===e.explicitOrderBy.length&&e.explicitOrderBy[0].field.isKeyField())}function Sh(e){return e.explicitOrderBy.length>0?e.explicitOrderBy[0].field:null}function Th(e){for(const t of e.filters){const e=t.getFirstInequalityField();if(null!==e)return e}return null}function Ih(e){return null!==e.collectionGroup}function Ch(e){const t=_u(e);if(null===t.dt){t.dt=[];const e=Th(t),n=Sh(t);if(null!==e&&null===n)e.isKeyField()||t.dt.push(new Yc(e)),t.dt.push(new Yc($u.keyField(),"asc"));else{let e=!1;for(const n of t.explicitOrderBy)t.dt.push(n),n.field.isKeyField()&&(e=!0);if(!e){const e=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";t.dt.push(new Yc($u.keyField(),e))}}}return t.dt}function Nh(e){const t=_u(e);if(!t.wt)if("F"===t.limitType)t.wt=gh(t.path,t.collectionGroup,Ch(t),t.filters,t.limit,t.startAt,t.endAt);else{const e=[];for(const n of Ch(t)){const t="desc"===n.dir?"asc":"desc";e.push(new Yc(n.field,t))}const n=t.endAt?new Wc(t.endAt.position,t.endAt.inclusive):null,r=t.startAt?new Wc(t.startAt.position,t.startAt.inclusive):null;t.wt=gh(t.path,t.collectionGroup,e,t.filters,t.limit,n,r)}return t.wt}function xh(e,t){t.getFirstInequalityField(),Th(e);const n=e.filters.concat([t]);return new wh(e.path,e.collectionGroup,e.explicitOrderBy.slice(),n,e.limit,e.limitType,e.startAt,e.endAt)}function Ah(e,t,n){return new wh(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function Rh(e,t){return vh(Nh(e),Nh(t))&&e.limitType===t.limitType}function Dh(e){return`${yh(Nh(e))}|lt:${e.limitType}`}function Oh(e){return`Query(target=${function(e){let t=e.path.canonicalString();return null!==e.collectionGroup&&(t+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(t+=`, filters: [${e.filters.map((e=>oh(e))).join(", ")}]`),nc(e.limit)||(t+=", limit: "+e.limit),e.orderBy.length>0&&(t+=`, orderBy: [${e.orderBy.map((e=>function(e){return`${e.field.canonicalString()} (${e.dir})`}(e))).join(", ")}]`),e.startAt&&(t+=", startAt: ",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((e=>Pc(e))).join(",")),e.endAt&&(t+=", endAt: ",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((e=>Pc(e))).join(",")),`Target(${t})`}(Nh(e))}; limitType=${e.limitType})`}function Ph(e,t){return t.isFoundDocument()&&function(e,t){const n=t.key.path;return null!==e.collectionGroup?t.key.hasCollectionId(e.collectionGroup)&&e.path.isPrefixOf(n):qu.isDocumentKey(e.path)?e.path.isEqual(n):e.path.isImmediateParentOf(n)}(e,t)&&function(e,t){for(const n of Ch(e))if(!n.field.isKeyField()&&null===t.data.field(n.field))return!1;return!0}(e,t)&&function(e,t){for(const n of e.filters)if(!n.matches(t))return!1;return!0}(e,t)&&function(e,t){return!(e.startAt&&!function(e,t,n){const r=Gc(e,t,n);return e.inclusive?r<=0:r<0}(e.startAt,Ch(e),t))&&!(e.endAt&&!function(e,t,n){const r=Gc(e,t,n);return e.inclusive?r>=0:r>0}(e.endAt,Ch(e),t))}(e,t)}function Lh(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}function Mh(e){return(t,n)=>{let r=!1;for(const i of Ch(e)){const e=Fh(i,t,n);if(0!==e)return e;r=r||i.field.isKeyField()}return 0}}function Fh(e,t,n){const r=e.field.isKeyField()?qu.comparator(t.key,n.key):function(e,t,n){const r=t.data.field(e),i=n.data.field(e);return null!==r&&null!==i?Dc(r,i):wu()}(e.field,t,n);switch(e.dir){case"asc":return r;case"desc":return-1*r;default:return wu()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uh{get(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0!==n)for(const[t,r]of n)if(this.equalsFn(t,e))return r}has(e){return void 0!==this.get(e)}set(e,t){const n=this.mapKeyFn(e),r=this.inner[n];if(void 0===r)return this.inner[n]=[[e,t]],void this.innerSize++;for(let n=0;n<r.length;n++)if(this.equalsFn(r[n][0],e))return void(r[n]=[e,t]);r.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0===n)return!1;for(let r=0;r<n.length;r++)if(this.equalsFn(n[r][0],e))return 1===n.length?delete this.inner[t]:n.splice(r,1),this.innerSize--,!0;return!1}forEach(e){uc(this.inner,((t,n)=>{for(const[t,r]of n)e(t,r)}))}isEmpty(){return cc(this.inner)}size(){return this.innerSize}constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vh=new hc(qu.comparator);function jh(){return Vh}const zh=new hc(qu.comparator);function Bh(...e){let t=zh;for(const n of e)t=t.insert(n.key,n);return t}function $h(e){let t=zh;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function qh(){return Kh()}function Hh(){return Kh()}function Kh(){return new Uh((e=>e.toString()),((e,t)=>e.isEqual(t)))}const Wh=new hc(qu.comparator),Gh=new pc(qu.comparator);function Qh(...e){let t=Gh;for(const n of e)t=t.add(n);return t}const Yh=new pc(Mu);function Xh(){return Yh}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jh(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:rc(t)?"-0":t}}function Zh(e){return{integerValue:""+e}}function ed(e,t){return ic(t)?Zh(t):Jh(e,t)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class td{constructor(){this._=void 0}}function nd(e,t,n){return e instanceof sd?function(e,t){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&(n.fields.__previous_value__=t),{mapValue:n}}(n,t):e instanceof od?ad(e,t):e instanceof ld?ud(e,t):function(e,t){const n=id(e,t),r=hd(n)+hd(e._t);return Fc(n)&&Fc(e._t)?Zh(r):Jh(e.serializer,r)}(e,t)}function rd(e,t,n){return e instanceof od?ad(e,t):e instanceof ld?ud(e,t):n}function id(e,t){var n;return e instanceof cd?Fc(n=t)||function(e){return!!e&&"doubleValue"in e}(n)?t:{integerValue:0}:null}class sd extends td{}class od extends td{constructor(e){super(),this.elements=e}}function ad(e,t){const n=dd(t);for(const t of e.elements)n.some((e=>Ac(e,t)))||n.push(t);return{arrayValue:{values:n}}}class ld extends td{constructor(e){super(),this.elements=e}}function ud(e,t){let n=dd(t);for(const t of e.elements)n=n.filter((e=>!Ac(e,t)));return{arrayValue:{values:n}}}class cd extends td{constructor(e,t){super(),this.serializer=e,this._t=t}}function hd(e){return Ec(e.integerValue||e.doubleValue)}function dd(e){return Uc(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fd{constructor(e,t){this.version=e,this.transformResults=t}}class pd{static none(){return new pd}static exists(e){return new pd(void 0,e)}static updateTime(e){return new pd(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}constructor(e,t){this.updateTime=e,this.exists=t}}function md(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class gd{}function yd(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new Cd(e.key,pd.none()):new _d(e.key,e.data,pd.none());{const n=e.data,r=qc.empty();let i=new pc($u.comparator);for(let e of t.fields)if(!i.has(e)){let t=n.field(e);null===t&&e.length>1&&(e=e.popLast(),t=n.field(e)),null===t?r.delete(e):r.set(e,t),i=i.add(e)}return new kd(e.key,r,new gc(i.toArray()),pd.none())}}function vd(e,t,n){e instanceof _d?function(e,t,n){const r=e.value.clone(),i=Td(e.fieldTransforms,t,n.transformResults);r.setAll(i),t.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(e,t,n):e instanceof kd?function(e,t,n){if(!md(e.precondition,t))return void t.convertToUnknownDocument(n.version);const r=Td(e.fieldTransforms,t,n.transformResults),i=t.data;i.setAll(Sd(e)),i.setAll(r),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):function(e,t,n){t.convertToNoDocument(n.version).setHasCommittedMutations()}(0,t,n)}function bd(e,t,n,r){return e instanceof _d?function(e,t,n,r){if(!md(e.precondition,t))return n;const i=e.value.clone(),s=Id(e.fieldTransforms,r,t);return i.setAll(s),t.convertToFoundDocument(t.version,i).setHasLocalMutations(),null}(e,t,n,r):e instanceof kd?function(e,t,n,r){if(!md(e.precondition,t))return n;const i=Id(e.fieldTransforms,r,t),s=t.data;return s.setAll(Sd(e)),s.setAll(i),t.convertToFoundDocument(t.version,s).setHasLocalMutations(),null===n?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map((e=>e.field)))}(e,t,n,r):function(e,t,n){return md(e.precondition,t)?(t.convertToNoDocument(t.version).setHasLocalMutations(),null):n}(e,t,n)}function wd(e,t){let n=null;for(const r of e.fieldTransforms){const e=t.data.field(r.field),i=id(r.transform,e||null);null!=i&&(null===n&&(n=qc.empty()),n.set(r.field,i))}return n||null}function Ed(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&!!function(e,t){return void 0===e&&void 0===t||!(!e||!t)&&Fu(e,t,((e,t)=>function(e,t){return e.field.isEqual(t.field)&&function(e,t){return e instanceof od&&t instanceof od||e instanceof ld&&t instanceof ld?Fu(e.elements,t.elements,Ac):e instanceof cd&&t instanceof cd?Ac(e._t,t._t):e instanceof sd&&t instanceof sd}(e.transform,t.transform)}(e,t)))}(e.fieldTransforms,t.fieldTransforms)&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask))}class _d extends gd{getFieldMask(){return null}constructor(e,t,n,r=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=r,this.type=0}}class kd extends gd{getFieldMask(){return this.fieldMask}constructor(e,t,n,r,i=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=r,this.fieldTransforms=i,this.type=1}}function Sd(e){const t=new Map;return e.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const r=e.data.field(n);t.set(n,r)}})),t}function Td(e,t,n){const r=new Map;Eu(e.length===n.length);for(let i=0;i<n.length;i++){const s=e[i],o=s.transform,a=t.data.field(s.field);r.set(s.field,rd(o,a,n[i]))}return r}function Id(e,t,n){const r=new Map;for(const i of e){const e=i.transform,s=n.data.field(i.field);r.set(i.field,nd(e,s,t))}return r}class Cd extends gd{getFieldMask(){return null}constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}}class Nd extends gd{getFieldMask(){return null}constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xd{applyToRemoteDocument(e,t){const n=t.mutationResults;for(let t=0;t<this.mutations.length;t++){const r=this.mutations[t];r.key.isEqual(e.key)&&vd(r,e,n[t])}}applyToLocalView(e,t){for(const n of this.baseMutations)n.key.isEqual(e.key)&&(t=bd(n,e,t,this.localWriteTime));for(const n of this.mutations)n.key.isEqual(e.key)&&(t=bd(n,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const n=Hh();return this.mutations.forEach((r=>{const i=e.get(r.key),s=i.overlayedDocument;let o=this.applyToLocalView(s,i.mutatedFields);o=t.has(r.key)?null:o;const a=yd(s,o);null!==a&&n.set(r.key,a),s.isValidDocument()||s.convertToNoDocument(Vu.min())})),n}keys(){return this.mutations.reduce(((e,t)=>e.add(t.key)),Qh())}isEqual(e){return this.batchId===e.batchId&&Fu(this.mutations,e.mutations,((e,t)=>Ed(e,t)))&&Fu(this.baseMutations,e.baseMutations,((e,t)=>Ed(e,t)))}constructor(e,t,n,r){this.batchId=e,this.localWriteTime=t,this.baseMutations=n,this.mutations=r}}class Ad{static from(e,t,n){Eu(e.mutations.length===n.length);let r=Wh;const i=e.mutations;for(let e=0;e<i.length;e++)r=r.insert(i[e].key,n[e].version);return new Ad(e,t,n,r)}constructor(e,t,n,r){this.batch=e,this.commitVersion=t,this.mutationResults=n,this.docVersions=r}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rd{getKey(){return this.mutation.key}isEqual(e){return null!==e&&this.mutation===e.mutation}toString(){return`Overlay{\n      largestBatchId: ${this.largestBatchId},\n      mutation: ${this.mutation.toString()}\n    }`}constructor(e,t){this.largestBatchId=e,this.mutation=t}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Od,Pd;function Ld(e){switch(e){default:return wu();case ku.CANCELLED:case ku.UNKNOWN:case ku.DEADLINE_EXCEEDED:case ku.RESOURCE_EXHAUSTED:case ku.INTERNAL:case ku.UNAVAILABLE:case ku.UNAUTHENTICATED:return!1;case ku.INVALID_ARGUMENT:case ku.NOT_FOUND:case ku.ALREADY_EXISTS:case ku.PERMISSION_DENIED:case ku.FAILED_PRECONDITION:case ku.ABORTED:case ku.OUT_OF_RANGE:case ku.UNIMPLEMENTED:case ku.DATA_LOSS:return!0}}function Md(e){if(void 0===e)return yu("GRPC error has no .code"),ku.UNKNOWN;switch(e){case Od.OK:return ku.OK;case Od.CANCELLED:return ku.CANCELLED;case Od.UNKNOWN:return ku.UNKNOWN;case Od.DEADLINE_EXCEEDED:return ku.DEADLINE_EXCEEDED;case Od.RESOURCE_EXHAUSTED:return ku.RESOURCE_EXHAUSTED;case Od.INTERNAL:return ku.INTERNAL;case Od.UNAVAILABLE:return ku.UNAVAILABLE;case Od.UNAUTHENTICATED:return ku.UNAUTHENTICATED;case Od.INVALID_ARGUMENT:return ku.INVALID_ARGUMENT;case Od.NOT_FOUND:return ku.NOT_FOUND;case Od.ALREADY_EXISTS:return ku.ALREADY_EXISTS;case Od.PERMISSION_DENIED:return ku.PERMISSION_DENIED;case Od.FAILED_PRECONDITION:return ku.FAILED_PRECONDITION;case Od.ABORTED:return ku.ABORTED;case Od.OUT_OF_RANGE:return ku.OUT_OF_RANGE;case Od.UNIMPLEMENTED:return ku.UNIMPLEMENTED;case Od.DATA_LOSS:return ku.DATA_LOSS;default:return wu()}}(Pd=Od||(Od={}))[Pd.OK=0]="OK",Pd[Pd.CANCELLED=1]="CANCELLED",Pd[Pd.UNKNOWN=2]="UNKNOWN",Pd[Pd.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",Pd[Pd.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",Pd[Pd.NOT_FOUND=5]="NOT_FOUND",Pd[Pd.ALREADY_EXISTS=6]="ALREADY_EXISTS",Pd[Pd.PERMISSION_DENIED=7]="PERMISSION_DENIED",Pd[Pd.UNAUTHENTICATED=16]="UNAUTHENTICATED",Pd[Pd.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",Pd[Pd.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",Pd[Pd.ABORTED=10]="ABORTED",Pd[Pd.OUT_OF_RANGE=11]="OUT_OF_RANGE",Pd[Pd.UNIMPLEMENTED=12]="UNIMPLEMENTED",Pd[Pd.INTERNAL=13]="INTERNAL",Pd[Pd.UNAVAILABLE=14]="UNAVAILABLE",Pd[Pd.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * limitations under the License.
 */
class Fd{static get instance(){return Ud}static getOrCreateInstance(){return null===Ud&&(Ud=new Fd),Ud}onExistenceFilterMismatch(e){const t=Symbol();return this.onExistenceFilterMismatchCallbacks.set(t,e),()=>this.onExistenceFilterMismatchCallbacks.delete(t)}notifyOnExistenceFilterMismatch(e){this.onExistenceFilterMismatchCallbacks.forEach((t=>t(e)))}constructor(){this.onExistenceFilterMismatchCallbacks=new Map}}let Ud=null;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vd{static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,jd.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new Vd(Vu.min(),r,Xh(),jh(),Qh())}constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}}class jd{static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new jd(n,t,Qh(),Qh(),Qh())}constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zd{constructor(e,t,n,r){this.It=e,this.removedTargetIds=t,this.key=n,this.Tt=r}}class Bd{constructor(e,t){this.targetId=e,this.Et=t}}class $d{constructor(e,t,n=vc.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=r}}class qd{get current(){return this.bt}get resumeToken(){return this.vt}get Vt(){return 0!==this.At}get St(){return this.Pt}Dt(e){e.approximateByteSize()>0&&(this.Pt=!0,this.vt=e)}Ct(){let e=Qh(),t=Qh(),n=Qh();return this.Rt.forEach(((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:wu()}})),new jd(this.vt,this.bt,e,t,n)}xt(){this.Pt=!1,this.Rt=Wd()}Nt(e,t){this.Pt=!0,this.Rt=this.Rt.insert(e,t)}kt(e){this.Pt=!0,this.Rt=this.Rt.remove(e)}Ot(){this.At+=1}$t(){this.At-=1}Mt(){this.Pt=!0,this.bt=!0}constructor(){this.At=0,this.Rt=Wd(),this.vt=vc.EMPTY_BYTE_STRING,this.bt=!1,this.Pt=!0}}class Hd{Kt(e){for(const t of e.It)e.Tt&&e.Tt.isFoundDocument()?this.Gt(t,e.Tt):this.Qt(t,e.key,e.Tt);for(const t of e.removedTargetIds)this.Qt(t,e.key,e.Tt)}zt(e){this.forEachTarget(e,(t=>{const n=this.jt(t);switch(e.state){case 0:this.Wt(t)&&n.Dt(e.resumeToken);break;case 1:n.$t(),n.Vt||n.xt(),n.Dt(e.resumeToken);break;case 2:n.$t(),n.Vt||this.removeTarget(t);break;case 3:this.Wt(t)&&(n.Mt(),n.Dt(e.resumeToken));break;case 4:this.Wt(t)&&(this.Ht(t),n.Dt(e.resumeToken));break;default:wu()}}))}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Bt.forEach(((e,n)=>{this.Wt(n)&&t(n)}))}Jt(e){var t;const n=e.targetId,r=e.Et.count,i=this.Yt(n);if(i){const s=i.target;if(bh(s))if(0===r){const e=new qu(s.path);this.Qt(n,e,Kc.newNoDocument(e,Vu.min()))}else Eu(1===r);else{const i=this.Zt(n);i!==r&&(this.Ht(n),this.Ut=this.Ut.add(n),null===(t=Fd.instance)||void 0===t||t.notifyOnExistenceFilterMismatch({localCacheCount:i,existenceFilterCount:e.Et.count}))}}}Xt(e){const t=new Map;this.Bt.forEach(((n,r)=>{const i=this.Yt(r);if(i){if(n.current&&bh(i.target)){const t=new qu(i.target.path);null!==this.Lt.get(t)||this.te(r,t)||this.Qt(r,t,Kc.newNoDocument(t,e))}n.St&&(t.set(r,n.Ct()),n.xt())}}));let n=Qh();this.qt.forEach(((e,t)=>{let r=!0;t.forEachWhile((e=>{const t=this.Yt(e);return!t||2===t.purpose||(r=!1,!1)})),r&&(n=n.add(e))})),this.Lt.forEach(((t,n)=>n.setReadTime(e)));const r=new Vd(e,t,this.Ut,this.Lt,n);return this.Lt=jh(),this.qt=Kd(),this.Ut=new pc(Mu),r}Gt(e,t){if(!this.Wt(e))return;const n=this.te(e,t.key)?2:0;this.jt(e).Nt(t.key,n),this.Lt=this.Lt.insert(t.key,t),this.qt=this.qt.insert(t.key,this.ee(t.key).add(e))}Qt(e,t,n){if(!this.Wt(e))return;const r=this.jt(e);this.te(e,t)?r.Nt(t,1):r.kt(t),this.qt=this.qt.insert(t,this.ee(t).delete(e)),n&&(this.Lt=this.Lt.insert(t,n))}removeTarget(e){this.Bt.delete(e)}Zt(e){const t=this.jt(e).Ct();return this.Ft.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ot(e){this.jt(e).Ot()}jt(e){let t=this.Bt.get(e);return t||(t=new qd,this.Bt.set(e,t)),t}ee(e){let t=this.qt.get(e);return t||(t=new pc(Mu),this.qt=this.qt.insert(e,t)),t}Wt(e){const t=null!==this.Yt(e);return t||gu("WatchChangeAggregator","Detected inactive target",e),t}Yt(e){const t=this.Bt.get(e);return t&&t.Vt?null:this.Ft.ne(e)}Ht(e){this.Bt.set(e,new qd),this.Ft.getRemoteKeysForTarget(e).forEach((t=>{this.Qt(e,t,null)}))}te(e,t){return this.Ft.getRemoteKeysForTarget(e).has(t)}constructor(e){this.Ft=e,this.Bt=new Map,this.Lt=jh(),this.qt=Kd(),this.Ut=new pc(Mu)}}function Kd(){return new hc(qu.comparator)}function Wd(){return new hc(qu.comparator)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gd={asc:"ASCENDING",desc:"DESCENDING"},Qd={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},Yd={and:"AND",or:"OR"};class Xd{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Jd(e,t){return e.useProto3Json?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function Zd(e,t){return e.useProto3Json?t.toBase64():t.toUint8Array()}function ef(e,t){return Jd(e,t.toTimestamp())}function tf(e){return Eu(!!e),Vu.fromTimestamp(function(e){const t=wc(e);return new Uu(t.seconds,t.nanos)}(e))}function nf(e,t){return function(e){return new zu(["projects",e.projectId,"databases",e.database])}(e).child("documents").child(t).canonicalString()}function rf(e){const t=zu.fromString(e);return Eu(Sf(t)),t}function sf(e,t){return nf(e.databaseId,t.path)}function of(e,t){const n=rf(t);if(n.get(1)!==e.databaseId.projectId)throw new Su(ku.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new Su(ku.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new qu(cf(n))}function af(e,t){return nf(e.databaseId,t)}function lf(e){const t=rf(e);return 4===t.length?zu.emptyPath():cf(t)}function uf(e){return new zu(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function cf(e){return Eu(e.length>4&&"documents"===e.get(4)),e.popFirst(5)}function hf(e,t,n){return{name:sf(e,t),fields:n.value.mapValue.fields}}function df(e,t){let n;if(t instanceof _d)n={update:hf(e,t.key,t.value)};else if(t instanceof Cd)n={delete:sf(e,t.key)};else if(t instanceof kd)n={update:hf(e,t.key,t.data),updateMask:kf(t.fieldMask)};else{if(!(t instanceof Nd))return wu();n={verify:sf(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map((e=>function(e,t){const n=t.transform;if(n instanceof sd)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof od)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof ld)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof cd)return{fieldPath:t.field.canonicalString(),increment:n._t};throw wu()}(0,e)))),t.precondition.isNone||(n.currentDocument=function(e,t){return void 0!==t.updateTime?{updateTime:ef(e,t.updateTime)}:void 0!==t.exists?{exists:t.exists}:wu()}(e,t.precondition)),n}function ff(e,t){return{documents:[af(e,t.path)]}}function pf(e,t){const n={structuredQuery:{}},r=t.path;null!==t.collectionGroup?(n.parent=af(e,r),n.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(n.parent=af(e,r.popLast()),n.structuredQuery.from=[{collectionId:r.lastSegment()}]);const i=function(e){if(0!==e.length)return _f(eh.create(e,"and"))}(t.filters);i&&(n.structuredQuery.where=i);const s=function(e){if(0!==e.length)return e.map((e=>function(e){return{field:wf(e.field),direction:yf(e.dir)}}(e)))}(t.orderBy);s&&(n.structuredQuery.orderBy=s);const o=function(e,t){return e.useProto3Json||nc(t)?t:{value:t}}(e,t.limit);var a;return null!==o&&(n.structuredQuery.limit=o),t.startAt&&(n.structuredQuery.startAt={before:(a=t.startAt).inclusive,values:a.position}),t.endAt&&(n.structuredQuery.endAt=function(e){return{before:!e.inclusive,values:e.position}}(t.endAt)),n}function mf(e){let t=lf(e.parent);const n=e.structuredQuery,r=n.from?n.from.length:0;let i=null;if(r>0){Eu(1===r);const e=n.from[0];e.allDescendants?i=e.collectionId:t=t.child(e.collectionId)}let s=[];n.where&&(s=function(e){const t=gf(e);return t instanceof eh&&nh(t)?t.getFilters():[t]}(n.where));let o=[];n.orderBy&&(o=n.orderBy.map((e=>function(e){return new Yc(Ef(e.field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(e.direction))}(e))));let a=null;n.limit&&(a=function(e){let t;return t="object"==typeof e?e.value:e,nc(t)?null:t}(n.limit));let l=null;n.startAt&&(l=function(e){const t=!!e.before,n=e.values||[];return new Wc(n,t)}(n.startAt));let u=null;return n.endAt&&(u=function(e){const t=!e.before,n=e.values||[];return new Wc(n,t)}(n.endAt)),Eh(t,i,o,s,a,"F",l,u)}function gf(e){return void 0!==e.unaryFilter?function(e){switch(e.unaryFilter.op){case"IS_NAN":const t=Ef(e.unaryFilter.field);return Zc.create(t,"==",{doubleValue:NaN});case"IS_NULL":const n=Ef(e.unaryFilter.field);return Zc.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=Ef(e.unaryFilter.field);return Zc.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const i=Ef(e.unaryFilter.field);return Zc.create(i,"!=",{nullValue:"NULL_VALUE"});default:return wu()}}(e):void 0!==e.fieldFilter?function(e){return Zc.create(Ef(e.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return wu()}}(e.fieldFilter.op),e.fieldFilter.value)}(e):void 0!==e.compositeFilter?function(e){return eh.create(e.compositeFilter.filters.map((e=>gf(e))),function(e){switch(e){case"AND":return"and";case"OR":return"or";default:return wu()}}(e.compositeFilter.op))}(e):wu()}function yf(e){return Gd[e]}function vf(e){return Qd[e]}function bf(e){return Yd[e]}function wf(e){return{fieldPath:e.canonicalString()}}function Ef(e){return $u.fromServerFormat(e.fieldPath)}function _f(e){return e instanceof Zc?function(e){if("=="===e.op){if(jc(e.value))return{unaryFilter:{field:wf(e.field),op:"IS_NAN"}};if(Vc(e.value))return{unaryFilter:{field:wf(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(jc(e.value))return{unaryFilter:{field:wf(e.field),op:"IS_NOT_NAN"}};if(Vc(e.value))return{unaryFilter:{field:wf(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:wf(e.field),op:vf(e.op),value:e.value}}}(e):e instanceof eh?function(e){const t=e.getFilters().map((e=>_f(e)));return 1===t.length?t[0]:{compositeFilter:{op:bf(e.op),filters:t}}}(e):wu()}function kf(e){const t=[];return e.fields.forEach((e=>t.push(e.canonicalString()))),{fieldPaths:t}}function Sf(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tf{withSequenceNumber(e){return new Tf(this.target,this.targetId,this.purpose,e,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken)}withResumeToken(e,t){return new Tf(this.target,this.targetId,this.purpose,this.sequenceNumber,t,this.lastLimboFreeSnapshotVersion,e)}withLastLimboFreeSnapshotVersion(e){return new Tf(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,e,this.resumeToken)}constructor(e,t,n,r,i=Vu.min(),s=Vu.min(),o=vc.EMPTY_BYTE_STRING){this.target=e,this.targetId=t,this.purpose=n,this.sequenceNumber=r,this.snapshotVersion=i,this.lastLimboFreeSnapshotVersion=s,this.resumeToken=o}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class If{constructor(e){this.se=e}}function Cf(e){const t=mf({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?Ah(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nf{oe(e,t){this.ue(e,t),t.ce()}ue(e,t){if("nullValue"in e)this.ae(t,5);else if("booleanValue"in e)this.ae(t,10),t.he(e.booleanValue?1:0);else if("integerValue"in e)this.ae(t,15),t.he(Ec(e.integerValue));else if("doubleValue"in e){const n=Ec(e.doubleValue);isNaN(n)?this.ae(t,13):(this.ae(t,15),rc(n)?t.he(0):t.he(n))}else if("timestampValue"in e){const n=e.timestampValue;this.ae(t,20),"string"==typeof n?t.le(n):(t.le(`${n.seconds||""}`),t.he(n.nanos||0))}else if("stringValue"in e)this.fe(e.stringValue,t),this.de(t);else if("bytesValue"in e)this.ae(t,30),t.we(_c(e.bytesValue)),this.de(t);else if("referenceValue"in e)this._e(e.referenceValue,t);else if("geoPointValue"in e){const n=e.geoPointValue;this.ae(t,45),t.he(n.latitude||0),t.he(n.longitude||0)}else"mapValue"in e?$c(e)?this.ae(t,Number.MAX_SAFE_INTEGER):(this.me(e.mapValue,t),this.de(t)):"arrayValue"in e?(this.ge(e.arrayValue,t),this.de(t)):wu()}fe(e,t){this.ae(t,25),this.ye(e,t)}ye(e,t){t.le(e)}me(e,t){const n=e.fields||{};this.ae(t,55);for(const e of Object.keys(n))this.fe(e,t),this.ue(n[e],t)}ge(e,t){const n=e.values||[];this.ae(t,50);for(const e of n)this.ue(e,t)}_e(e,t){this.ae(t,37),qu.fromName(e).path.forEach((e=>{this.ae(t,60),this.ye(e,t)}))}ae(e,t){e.he(t)}de(e){e.he(2)}constructor(){}}Nf.pe=new Nf;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class xf{addToCollectionParentIndex(e,t){return this.He.add(t),Zu.resolve()}getCollectionParents(e,t){return Zu.resolve(this.He.getEntries(t))}addFieldIndex(e,t){return Zu.resolve()}deleteFieldIndex(e,t){return Zu.resolve()}getDocumentsMatchingTarget(e,t){return Zu.resolve(null)}getIndexType(e,t){return Zu.resolve(0)}getFieldIndexes(e,t){return Zu.resolve([])}getNextCollectionGroupToUpdate(e){return Zu.resolve(null)}getMinOffset(e,t){return Zu.resolve(Gu.min())}getMinOffsetFromCollectionGroup(e,t){return Zu.resolve(Gu.min())}updateCollectionGroup(e,t,n){return Zu.resolve()}updateIndexEntries(e,t){return Zu.resolve()}constructor(){this.He=new Af}}class Af{add(e){const t=e.lastSegment(),n=e.popLast(),r=this.index[t]||new pc(zu.comparator),i=!r.has(n);return this.index[t]=r.add(n),i}has(e){const t=e.lastSegment(),n=e.popLast(),r=this.index[t];return r&&r.has(n)}getEntries(e){return(this.index[e]||new pc(zu.comparator)).toArray()}constructor(){this.index={}}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new Uint8Array(0);class Rf{static withCacheSize(e){return new Rf(e,Rf.DEFAULT_COLLECTION_PERCENTILE,Rf.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,t,n){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=n}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Df{next(){return this.Rn+=2,this.Rn}static vn(){return new Df(0)}static bn(){return new Df(-1)}constructor(e){this.Rn=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Of{addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Kc.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?Zu.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}constructor(){this.changes=new Uh((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lf{getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next((r=>(n=r,this.remoteDocumentCache.getEntry(e,t)))).next((e=>(null!==n&&bd(n.mutation,e,gc.empty(),Uu.now()),e)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((t=>this.getLocalViewOfDocuments(e,t,Qh()).next((()=>t))))}getLocalViewOfDocuments(e,t,n=Qh()){const r=qh();return this.populateOverlays(e,r,t).next((()=>this.computeViews(e,t,r,n).next((e=>{let t=Bh();return e.forEach(((e,n)=>{t=t.insert(e,n.overlayedDocument)})),t}))))}getOverlayedDocuments(e,t){const n=qh();return this.populateOverlays(e,n,t).next((()=>this.computeViews(e,t,n,Qh())))}populateOverlays(e,t,n){const r=[];return n.forEach((e=>{t.has(e)||r.push(e)})),this.documentOverlayCache.getOverlays(e,r).next((e=>{e.forEach(((e,n)=>{t.set(e,n)}))}))}computeViews(e,t,n,r){let i=jh();const s=Kh(),o=Kh();return t.forEach(((e,t)=>{const o=n.get(t.key);r.has(t.key)&&(void 0===o||o.mutation instanceof kd)?i=i.insert(t.key,t):void 0!==o?(s.set(t.key,o.mutation.getFieldMask()),bd(o.mutation,t,o.mutation.getFieldMask(),Uu.now())):s.set(t.key,gc.empty())})),this.recalculateAndSaveOverlays(e,i).next((e=>(e.forEach(((e,t)=>s.set(e,t))),t.forEach(((e,t)=>{var n;return o.set(e,new Pf(t,null!==(n=s.get(e))&&void 0!==n?n:null))})),o)))}recalculateAndSaveOverlays(e,t){const n=Kh();let r=new hc(((e,t)=>e-t)),i=Qh();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((e=>{for(const i of e)i.keys().forEach((e=>{const s=t.get(e);if(null===s)return;let o=n.get(e)||gc.empty();o=i.applyToLocalView(s,o),n.set(e,o);const a=(r.get(i.batchId)||Qh()).add(e);r=r.insert(i.batchId,a)}))})).next((()=>{const s=[],o=r.getReverseIterator();for(;o.hasNext();){const r=o.getNext(),a=r.key,l=r.value,u=Hh();l.forEach((e=>{if(!i.has(e)){const r=yd(t.get(e),n.get(e));null!==r&&u.set(e,r),i=i.add(e)}})),s.push(this.documentOverlayCache.saveOverlays(e,a,u))}return Zu.waitFor(s)})).next((()=>n))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((t=>this.recalculateAndSaveOverlays(e,t)))}getDocumentsMatchingQuery(e,t,n){return function(e){return qu.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Ih(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n):this.getDocumentsMatchingCollectionQuery(e,t,n)}getNextDocuments(e,t,n,r){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,r).next((i=>{const s=r-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,r-i.size):Zu.resolve(qh());let o=-1,a=i;return s.next((t=>Zu.forEach(t,((t,n)=>(o<n.largestBatchId&&(o=n.largestBatchId),i.get(t)?Zu.resolve():this.remoteDocumentCache.getEntry(e,t).next((e=>{a=a.insert(t,e)}))))).next((()=>this.populateOverlays(e,t,i))).next((()=>this.computeViews(e,a,t,Qh()))).next((e=>({batchId:o,changes:$h(e)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new qu(t)).next((e=>{let t=Bh();return e.isFoundDocument()&&(t=t.insert(e.key,e)),t}))}getDocumentsMatchingCollectionGroupQuery(e,t,n){const r=t.collectionGroup;let i=Bh();return this.indexManager.getCollectionParents(e,r).next((s=>Zu.forEach(s,(s=>{const o=function(e,t){return new wh(t,null,e.explicitOrderBy.slice(),e.filters.slice(),e.limit,e.limitType,e.startAt,e.endAt)}(t,s.child(r));return this.getDocumentsMatchingCollectionQuery(e,o,n).next((e=>{e.forEach(((e,t)=>{i=i.insert(e,t)}))}))})).next((()=>i))))}getDocumentsMatchingCollectionQuery(e,t,n){let r;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId).next((i=>(r=i,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,n,r)))).next((e=>{r.forEach(((t,n)=>{const r=n.getKey();null===e.get(r)&&(e=e.insert(r,Kc.newInvalidDocument(r)))}));let n=Bh();return e.forEach(((e,i)=>{const s=r.get(e);void 0!==s&&bd(s.mutation,i,gc.empty(),Uu.now()),Ph(t,i)&&(n=n.insert(e,i))})),n}))}constructor(e,t,n,r){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=r}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mf{getBundleMetadata(e,t){return Zu.resolve(this.Zn.get(t))}saveBundleMetadata(e,t){var n;return this.Zn.set(t.id,{id:(n=t).id,version:n.version,createTime:tf(n.createTime)}),Zu.resolve()}getNamedQuery(e,t){return Zu.resolve(this.Xn.get(t))}saveNamedQuery(e,t){return this.Xn.set(t.name,function(e){return{name:e.name,query:Cf(e.bundledQuery),readTime:tf(e.readTime)}}(t)),Zu.resolve()}constructor(e){this.serializer=e,this.Zn=new Map,this.Xn=new Map}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ff{getOverlay(e,t){return Zu.resolve(this.overlays.get(t))}getOverlays(e,t){const n=qh();return Zu.forEach(t,(t=>this.getOverlay(e,t).next((e=>{null!==e&&n.set(t,e)})))).next((()=>n))}saveOverlays(e,t,n){return n.forEach(((n,r)=>{this.re(e,t,r)})),Zu.resolve()}removeOverlaysForBatchId(e,t,n){const r=this.ts.get(n);return void 0!==r&&(r.forEach((e=>this.overlays=this.overlays.remove(e))),this.ts.delete(n)),Zu.resolve()}getOverlaysForCollection(e,t,n){const r=qh(),i=t.length+1,s=new qu(t.child("")),o=this.overlays.getIteratorFrom(s);for(;o.hasNext();){const e=o.getNext().value,s=e.getKey();if(!t.isPrefixOf(s.path))break;s.path.length===i&&e.largestBatchId>n&&r.set(e.getKey(),e)}return Zu.resolve(r)}getOverlaysForCollectionGroup(e,t,n,r){let i=new hc(((e,t)=>e-t));const s=this.overlays.getIterator();for(;s.hasNext();){const e=s.getNext().value;if(e.getKey().getCollectionGroup()===t&&e.largestBatchId>n){let t=i.get(e.largestBatchId);null===t&&(t=qh(),i=i.insert(e.largestBatchId,t)),t.set(e.getKey(),e)}}const o=qh(),a=i.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach(((e,t)=>o.set(e,t))),!(o.size()>=r)););return Zu.resolve(o)}re(e,t,n){const r=this.overlays.get(n.key);if(null!==r){const e=this.ts.get(r.largestBatchId).delete(n.key);this.ts.set(r.largestBatchId,e)}this.overlays=this.overlays.insert(n.key,new Rd(t,n));let i=this.ts.get(t);void 0===i&&(i=Qh(),this.ts.set(t,i)),this.ts.set(t,i.add(n.key))}constructor(){this.overlays=new hc(qu.comparator),this.ts=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uf{isEmpty(){return this.es.isEmpty()}addReference(e,t){const n=new Vf(e,t);this.es=this.es.add(n),this.ss=this.ss.add(n)}os(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.us(new Vf(e,t))}cs(e,t){e.forEach((e=>this.removeReference(e,t)))}hs(e){const t=new qu(new zu([])),n=new Vf(t,e),r=new Vf(t,e+1),i=[];return this.ss.forEachInRange([n,r],(e=>{this.us(e),i.push(e.key)})),i}ls(){this.es.forEach((e=>this.us(e)))}us(e){this.es=this.es.delete(e),this.ss=this.ss.delete(e)}fs(e){const t=new qu(new zu([])),n=new Vf(t,e),r=new Vf(t,e+1);let i=Qh();return this.ss.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new Vf(e,0),n=this.es.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}constructor(){this.es=new pc(Vf.ns),this.ss=new pc(Vf.rs)}}class Vf{static ns(e,t){return qu.comparator(e.key,t.key)||Mu(e.ds,t.ds)}static rs(e,t){return Mu(e.ds,t.ds)||qu.comparator(e.key,t.key)}constructor(e,t){this.key=e,this.ds=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jf{checkEmpty(e){return Zu.resolve(0===this.mutationQueue.length)}addMutationBatch(e,t,n,r){const i=this.ws;this.ws++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const s=new xd(i,t,n,r);this.mutationQueue.push(s);for(const t of r)this._s=this._s.add(new Vf(t.key,i)),this.indexManager.addToCollectionParentIndex(e,t.key.path.popLast());return Zu.resolve(s)}lookupMutationBatch(e,t){return Zu.resolve(this.gs(t))}getNextMutationBatchAfterBatchId(e,t){const n=t+1,r=this.ys(n),i=r<0?0:r;return Zu.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return Zu.resolve(0===this.mutationQueue.length?-1:this.ws-1)}getAllMutationBatches(e){return Zu.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const n=new Vf(t,0),r=new Vf(t,Number.POSITIVE_INFINITY),i=[];return this._s.forEachInRange([n,r],(e=>{const t=this.gs(e.ds);i.push(t)})),Zu.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new pc(Mu);return t.forEach((e=>{const t=new Vf(e,0),r=new Vf(e,Number.POSITIVE_INFINITY);this._s.forEachInRange([t,r],(e=>{n=n.add(e.ds)}))})),Zu.resolve(this.ps(n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,r=n.length+1;let i=n;qu.isDocumentKey(i)||(i=i.child(""));const s=new Vf(new qu(i),0);let o=new pc(Mu);return this._s.forEachWhile((e=>{const t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===r&&(o=o.add(e.ds)),!0)}),s),Zu.resolve(this.ps(o))}ps(e){const t=[];return e.forEach((e=>{const n=this.gs(e);null!==n&&t.push(n)})),t}removeMutationBatch(e,t){Eu(0===this.Is(t.batchId,"removed")),this.mutationQueue.shift();let n=this._s;return Zu.forEach(t.mutations,(r=>{const i=new Vf(r.key,t.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)})).next((()=>{this._s=n}))}En(e){}containsKey(e,t){const n=new Vf(t,0),r=this._s.firstAfterOrEqual(n);return Zu.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,Zu.resolve()}Is(e,t){return this.ys(e)}ys(e){return 0===this.mutationQueue.length?0:e-this.mutationQueue[0].batchId}gs(e){const t=this.ys(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.ws=1,this._s=new pc(Vf.ns)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zf{setIndexManager(e){this.indexManager=e}addEntry(e,t){const n=t.key,r=this.docs.get(n),i=r?r.size:0,s=this.Ts(t);return this.docs=this.docs.insert(n,{document:t.mutableCopy(),size:s}),this.size+=s-i,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const n=this.docs.get(t);return Zu.resolve(n?n.document.mutableCopy():Kc.newInvalidDocument(t))}getEntries(e,t){let n=jh();return t.forEach((e=>{const t=this.docs.get(e);n=n.insert(e,t?t.document.mutableCopy():Kc.newInvalidDocument(e))})),Zu.resolve(n)}getDocumentsMatchingQuery(e,t,n,r){let i=jh();const s=t.path,o=new qu(s.child("")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){const{key:e,value:{document:o}}=a.getNext();if(!s.isPrefixOf(e.path))break;e.path.length>s.length+1||Qu(Wu(o),n)<=0||(r.has(o.key)||Ph(t,o))&&(i=i.insert(o.key,o.mutableCopy()))}return Zu.resolve(i)}getAllFromCollectionGroup(e,t,n,r){wu()}Es(e,t){return Zu.forEach(this.docs,(e=>t(e)))}newChangeBuffer(e){return new Bf(this)}getSize(e){return Zu.resolve(this.size)}constructor(e){this.Ts=e,this.docs=new hc(qu.comparator),this.size=0}}class Bf extends Of{applyChanges(e){const t=[];return this.changes.forEach(((n,r)=>{r.isValidDocument()?t.push(this.Jn.addEntry(e,r)):this.Jn.removeEntry(n)})),Zu.waitFor(t)}getFromCache(e,t){return this.Jn.getEntry(e,t)}getAllFromCache(e,t){return this.Jn.getEntries(e,t)}constructor(e){super(),this.Jn=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $f{forEachTarget(e,t){return this.As.forEach(((e,n)=>t(n))),Zu.resolve()}getLastRemoteSnapshotVersion(e){return Zu.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return Zu.resolve(this.Rs)}allocateTargetId(e){return this.highestTargetId=this.bs.next(),Zu.resolve(this.highestTargetId)}setTargetsMetadata(e,t,n){return n&&(this.lastRemoteSnapshotVersion=n),t>this.Rs&&(this.Rs=t),Zu.resolve()}Sn(e){this.As.set(e.target,e);const t=e.targetId;t>this.highestTargetId&&(this.bs=new Df(t),this.highestTargetId=t),e.sequenceNumber>this.Rs&&(this.Rs=e.sequenceNumber)}addTargetData(e,t){return this.Sn(t),this.targetCount+=1,Zu.resolve()}updateTargetData(e,t){return this.Sn(t),Zu.resolve()}removeTargetData(e,t){return this.As.delete(t.target),this.vs.hs(t.targetId),this.targetCount-=1,Zu.resolve()}removeTargets(e,t,n){let r=0;const i=[];return this.As.forEach(((s,o)=>{o.sequenceNumber<=t&&null===n.get(o.targetId)&&(this.As.delete(s),i.push(this.removeMatchingKeysForTargetId(e,o.targetId)),r++)})),Zu.waitFor(i).next((()=>r))}getTargetCount(e){return Zu.resolve(this.targetCount)}getTargetData(e,t){const n=this.As.get(t)||null;return Zu.resolve(n)}addMatchingKeys(e,t,n){return this.vs.os(t,n),Zu.resolve()}removeMatchingKeys(e,t,n){this.vs.cs(t,n);const r=this.persistence.referenceDelegate,i=[];return r&&t.forEach((t=>{i.push(r.markPotentiallyOrphaned(e,t))})),Zu.waitFor(i)}removeMatchingKeysForTargetId(e,t){return this.vs.hs(t),Zu.resolve()}getMatchingKeysForTargetId(e,t){const n=this.vs.fs(t);return Zu.resolve(n)}containsKey(e,t){return Zu.resolve(this.vs.containsKey(t))}constructor(e){this.persistence=e,this.As=new Uh((e=>yh(e)),vh),this.lastRemoteSnapshotVersion=Vu.min(),this.highestTargetId=0,this.Rs=0,this.vs=new Uf,this.targetCount=0,this.bs=Df.vn()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qf{start(){return Promise.resolve()}shutdown(){return this.Ss=!1,Promise.resolve()}get started(){return this.Ss}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Ff,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.Ps[e.toKey()];return n||(n=new jf(t,this.referenceDelegate),this.Ps[e.toKey()]=n),n}getTargetCache(){return this.Ds}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.xs}runTransaction(e,t,n){gu("MemoryPersistence","Starting transaction:",e);const r=new Hf(this.Vs.next());return this.referenceDelegate.Ns(),n(r).next((e=>this.referenceDelegate.ks(r).next((()=>e)))).toPromise().then((e=>(r.raiseOnCommittedEvent(),e)))}Os(e,t){return Zu.or(Object.values(this.Ps).map((n=>()=>n.containsKey(e,t))))}constructor(e,t){this.Ps={},this.overlays={},this.Vs=new tc(0),this.Ss=!1,this.Ss=!0,this.referenceDelegate=e(this),this.Ds=new $f(this),this.indexManager=new xf,this.remoteDocumentCache=function(e){return new zf(e)}((e=>this.referenceDelegate.Cs(e))),this.serializer=new If(t),this.xs=new Mf(this.serializer)}}class Hf extends Xu{constructor(e){super(),this.currentSequenceNumber=e}}class Kf{static Fs(e){return new Kf(e)}get Bs(){if(this.Ms)return this.Ms;throw wu()}addReference(e,t,n){return this.$s.addReference(n,t),this.Bs.delete(n.toString()),Zu.resolve()}removeReference(e,t,n){return this.$s.removeReference(n,t),this.Bs.add(n.toString()),Zu.resolve()}markPotentiallyOrphaned(e,t){return this.Bs.add(t.toString()),Zu.resolve()}removeTarget(e,t){this.$s.hs(t.targetId).forEach((e=>this.Bs.add(e.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next((e=>{e.forEach((e=>this.Bs.add(e.toString())))})).next((()=>n.removeTargetData(e,t)))}Ns(){this.Ms=new Set}ks(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Zu.forEach(this.Bs,(n=>{const r=qu.fromPath(n);return this.Ls(e,r).next((e=>{e||t.removeEntry(r,Vu.min())}))})).next((()=>(this.Ms=null,t.apply(e))))}updateLimboDocument(e,t){return this.Ls(e,t).next((e=>{e?this.Bs.delete(t.toString()):this.Bs.add(t.toString())}))}Cs(e){return 0}Ls(e,t){return Zu.or([()=>Zu.resolve(this.$s.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Os(e,t)])}constructor(e){this.persistence=e,this.$s=new Uf,this.Ms=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Wf{static Di(e,t){let n=Qh(),r=Qh();for(const e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:r=r.add(e.doc.key)}return new Wf(e,t.fromCache,n,r)}constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Vi=n,this.Si=r}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gf{initialize(e,t){this.xi=e,this.indexManager=t,this.Ci=!0}getDocumentsMatchingQuery(e,t,n,r){return this.Ni(e,t).next((i=>i||this.ki(e,t,r,n))).next((n=>n||this.Oi(e,t)))}Ni(e,t){if(kh(t))return Zu.resolve(null);let n=Nh(t);return this.indexManager.getIndexType(e,n).next((r=>0===r?null:(null!==t.limit&&1===r&&(t=Ah(t,null,"F"),n=Nh(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next((r=>{const i=Qh(...r);return this.xi.getDocuments(e,i).next((r=>this.indexManager.getMinOffset(e,n).next((n=>{const s=this.$i(t,r);return this.Mi(t,s,i,n.readTime)?this.Ni(e,Ah(t,null,"F")):this.Fi(e,s,t,n)}))))})))))}ki(e,t,n,r){return kh(t)||r.isEqual(Vu.min())?this.Oi(e,t):this.xi.getDocuments(e,n).next((i=>{const s=this.$i(t,i);return this.Mi(t,s,n,r)?this.Oi(e,t):(mu()<=Ze.DEBUG&&gu("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Oh(t)),this.Fi(e,s,t,Ku(r,-1)))}))}$i(e,t){let n=new pc(Mh(e));return t.forEach(((t,r)=>{Ph(e,r)&&(n=n.add(r))})),n}Mi(e,t,n,r){if(null===e.limit)return!1;if(n.size!==t.size)return!0;const i="F"===e.limitType?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Oi(e,t){return mu()<=Ze.DEBUG&&gu("QueryEngine","Using full collection scan to execute query:",Oh(t)),this.xi.getDocumentsMatchingQuery(e,t,Gu.min())}Fi(e,t,n,r){return this.xi.getDocumentsMatchingQuery(e,n,r).next((e=>(t.forEach((t=>{e=e.insert(t.key,t)})),e)))}constructor(){this.Ci=!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qf{Gi(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new Lf(this.Ki,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Ki.setIndexManager(this.indexManager),this.Bi.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(t=>e.collect(t,this.Li)))}constructor(e,t,n,r){this.persistence=e,this.Bi=t,this.serializer=r,this.Li=new hc(Mu),this.qi=new Uh((e=>yh(e)),vh),this.Ui=new Map,this.Ki=e.getRemoteDocumentCache(),this.Ds=e.getTargetCache(),this.xs=e.getBundleCache(),this.Gi(n)}}function Yf(e,t,n,r){return new Qf(e,t,n,r)}async function Xf(e,t){const n=_u(e);return await n.persistence.runTransaction("Handle user change","readonly",(e=>{let r;return n.mutationQueue.getAllMutationBatches(e).next((i=>(r=i,n.Gi(t),n.mutationQueue.getAllMutationBatches(e)))).next((t=>{const i=[],s=[];let o=Qh();for(const e of r){i.push(e.batchId);for(const t of e.mutations)o=o.add(t.key)}for(const e of t){s.push(e.batchId);for(const t of e.mutations)o=o.add(t.key)}return n.localDocuments.getDocuments(e,o).next((e=>({Qi:e,removedBatchIds:i,addedBatchIds:s})))}))}))}function Jf(e){const t=_u(e);return t.persistence.runTransaction("Get last remote snapshot version","readonly",(e=>t.Ds.getLastRemoteSnapshotVersion(e)))}function Zf(e,t,n){let r=Qh(),i=Qh();return n.forEach((e=>r=r.add(e))),t.getEntries(e,r).next((e=>{let r=jh();return n.forEach(((n,s)=>{const o=e.get(n);s.isFoundDocument()!==o.isFoundDocument()&&(i=i.add(n)),s.isNoDocument()&&s.version.isEqual(Vu.min())?(t.removeEntry(n,s.readTime),r=r.insert(n,s)):!o.isValidDocument()||s.version.compareTo(o.version)>0||0===s.version.compareTo(o.version)&&o.hasPendingWrites?(t.addEntry(s),r=r.insert(n,s)):gu("LocalStore","Ignoring outdated watch update for ",n,". Current version:",o.version," Watch version:",s.version)})),{zi:r,ji:i}}))}function ep(e,t){const n=_u(e);return n.persistence.runTransaction("Get next mutation batch","readonly",(e=>(void 0===t&&(t=-1),n.mutationQueue.getNextMutationBatchAfterBatchId(e,t))))}function tp(e,t){const n=_u(e);return n.persistence.runTransaction("Allocate target","readwrite",(e=>{let r;return n.Ds.getTargetData(e,t).next((i=>i?(r=i,Zu.resolve(r)):n.Ds.allocateTargetId(e).next((i=>(r=new Tf(t,i,0,e.currentSequenceNumber),n.Ds.addTargetData(e,r).next((()=>r)))))))})).then((e=>{const r=n.Li.get(e.targetId);return(null===r||e.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(n.Li=n.Li.insert(e.targetId,e),n.qi.set(t,e.targetId)),e}))}async function np(e,t,n){const r=_u(e),i=r.Li.get(t),s=n?"readwrite":"readwrite-primary";try{n||await r.persistence.runTransaction("Release target",s,(e=>r.persistence.referenceDelegate.removeTarget(e,i)))}catch(e){if(!ec(e))throw e;gu("LocalStore",`Failed to update sequence numbers for target ${t}: ${e}`)}r.Li=r.Li.remove(t),r.qi.delete(i.target)}function rp(e,t,n){const r=_u(e);let i=Vu.min(),s=Qh();return r.persistence.runTransaction("Execute query","readonly",(e=>function(e,t,n){const r=_u(e),i=r.qi.get(n);return void 0!==i?Zu.resolve(r.Li.get(i)):r.Ds.getTargetData(t,n)}(r,e,Nh(t)).next((t=>{if(t)return i=t.lastLimboFreeSnapshotVersion,r.Ds.getMatchingKeysForTargetId(e,t.targetId).next((e=>{s=e}))})).next((()=>r.Bi.getDocumentsMatchingQuery(e,t,n?i:Vu.min(),n?s:Qh()))).next((e=>(ip(r,Lh(t),e),{documents:e,Wi:s})))))}function ip(e,t,n){let r=e.Ui.get(t)||Vu.min();n.forEach(((e,t)=>{t.readTime.compareTo(r)>0&&(r=t.readTime)})),e.Ui.set(t,r)}class sp{tr(e){this.activeTargetIds=this.activeTargetIds.add(e)}er(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Xi(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}constructor(){this.activeTargetIds=Xh()}}class op{addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e){return this.Br.tr(e),this.Lr[e]||"not-current"}updateQueryState(e,t,n){this.Lr[e]=t}removeLocalQueryTarget(e){this.Br.er(e)}isLocalQueryTarget(e){return this.Br.activeTargetIds.has(e)}clearQueryState(e){delete this.Lr[e]}getAllActiveQueryTargets(){return this.Br.activeTargetIds}isActiveQueryTarget(e){return this.Br.activeTargetIds.has(e)}start(){return this.Br=new sp,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}constructor(){this.Br=new sp,this.Lr={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lp{qr(e){this.zr.push(e)}shutdown(){window.removeEventListener("online",this.Ur),window.removeEventListener("offline",this.Gr)}jr(){window.addEventListener("online",this.Ur),window.addEventListener("offline",this.Gr)}Kr(){gu("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.zr)e(0)}Qr(){gu("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.zr)e(1)}static D(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}constructor(){this.Ur=()=>this.Kr(),this.Gr=()=>this.Qr(),this.zr=[],this.jr()}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let up=null;function cp(){return null===up?up=268435456+Math.round(2147483648*Math.random()):up++,"0x"+up.toString(16)
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dp{Jr(e){this.Yr=e}Zr(e){this.Xr=e}onMessage(e){this.eo=e}close(){this.Hr()}send(e){this.Wr(e)}no(){this.Yr()}so(e){this.Xr(e)}io(e){this.eo(e)}constructor(e){this.Wr=e.Wr,this.Hr=e.Hr}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fp="WebChannelConnection";class pp extends class{get uo(){return!1}co(e,t,n,r,i){const s=cp(),o=this.ao(e,t);gu("RestConnection",`Sending RPC '${e}' ${s}:`,o,n);const a={};return this.ho(a,r,i),this.lo(e,o,a,n).then((t=>(gu("RestConnection",`Received RPC '${e}' ${s}: `,t),t)),(t=>{throw vu("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",o,"request:",n),t}))}fo(e,t,n,r,i,s){return this.co(e,t,n,r,i)}ho(e,t,n){e["X-Goog-Api-Client"]="gl-js/ fire/"+fu,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((t,n)=>e[n]=t)),n&&n.headers.forEach(((t,n)=>e[n]=t))}ao(e,t){const n=hp[e];return`${this.ro}/v1/${t}:${n}`}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http";this.ro=t+"://"+e.host,this.oo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}}{lo(e,t,n,r){const i=cp();return new Promise(((s,o)=>{const a=new cu;a.setWithCredentials(!0),a.listenOnce(su.COMPLETE,(()=>{try{switch(a.getLastErrorCode()){case iu.NO_ERROR:const t=a.getResponseJson();gu(fp,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case iu.TIMEOUT:gu(fp,`RPC '${e}' ${i} timed out`),o(new Su(ku.DEADLINE_EXCEEDED,"Request time out"));break;case iu.HTTP_ERROR:const n=a.getStatus();if(gu(fp,`RPC '${e}' ${i} failed with status:`,n,"response text:",a.getResponseText()),n>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);const t=null==e?void 0:e.error;if(t&&t.status&&t.message){const e=function(e){const t=e.toLowerCase().replace(/_/g,"-");return Object.values(ku).indexOf(t)>=0?t:ku.UNKNOWN}(t.status);o(new Su(e,t.message))}else o(new Su(ku.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new Su(ku.UNAVAILABLE,"Connection failed."));break;default:wu()}}finally{gu(fp,`RPC '${e}' ${i} completed.`)}}));const l=JSON.stringify(r);gu(fp,`RPC '${e}' ${i} sending request:`,r),a.send(t,"POST",l,n,15)}))}wo(e,t,n){const r=cp(),i=[this.ro,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=nu(),o=ru(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(a.xmlHttpFactory=new lu({})),this.ho(a.initMessageHeaders,t,n),a.encodeInitMessageHeaders=!0;const l=i.join("");gu(fp,`Creating RPC '${e}' stream ${r}: ${l}`,a);const u=s.createWebChannel(l,a);let c=!1,h=!1;const d=new dp({Wr:t=>{h?gu(fp,`Not sending because RPC '${e}' stream ${r} is closed:`,t):(c||(gu(fp,`Opening RPC '${e}' stream ${r} transport.`),u.open(),c=!0),gu(fp,`RPC '${e}' stream ${r} sending:`,t),u.send(t))},Hr:()=>u.close()}),f=(e,t,n)=>{e.listen(t,(e=>{try{n(e)}catch(e){setTimeout((()=>{throw e}),0)}}))};return f(u,uu.EventType.OPEN,(()=>{h||gu(fp,`RPC '${e}' stream ${r} transport opened.`)})),f(u,uu.EventType.CLOSE,(()=>{h||(h=!0,gu(fp,`RPC '${e}' stream ${r} transport closed`),d.so())})),f(u,uu.EventType.ERROR,(t=>{h||(h=!0,vu(fp,`RPC '${e}' stream ${r} transport errored:`,t),d.so(new Su(ku.UNAVAILABLE,"The operation could not be completed")))})),f(u,uu.EventType.MESSAGE,(t=>{var n;if(!h){const i=t.data[0];Eu(!!i);const s=i,o=s.error||(null===(n=s[0])||void 0===n?void 0:n.error);if(o){gu(fp,`RPC '${e}' stream ${r} received error:`,o);const t=o.status;let n=function(e){const t=Od[e];if(void 0!==t)return Md(t)}(t),i=o.message;void 0===n&&(n=ku.INTERNAL,i="Unknown error status: "+t+" with message "+o.message),h=!0,d.so(new Su(n,i)),u.close()}else gu(fp,`RPC '${e}' stream ${r} received:`,i),d.io(i)}})),f(o,ou.STAT_EVENT,(t=>{t.stat===au.PROXY?gu(fp,`RPC '${e}' stream ${r} detected buffering proxy`):t.stat===au.NOPROXY&&gu(fp,`RPC '${e}' stream ${r} detected no buffering proxy`)})),setTimeout((()=>{d.no()}),0),d}constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gp(e){return new Xd(e,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vp{xo(){return 1===this.state||5===this.state||this.No()}No(){return 2===this.state||3===this.state}start(){4!==this.state?this.auth():this.ko()}async stop(){this.xo()&&await this.close(0)}Oo(){this.state=0,this.Co.reset()}$o(){this.No()&&null===this.So&&(this.So=this.Ws.enqueueAfterDelay(this.bo,6e4,(()=>this.Mo())))}Fo(e){this.Bo(),this.stream.send(e)}async Mo(){if(this.No())return this.close(0)}Bo(){this.So&&(this.So.cancel(),this.So=null)}Lo(){this.Do&&(this.Do.cancel(),this.Do=null)}async close(e,t){this.Bo(),this.Lo(),this.Co.cancel(),this.Vo++,4!==e?this.Co.reset():t&&t.code===ku.RESOURCE_EXHAUSTED?(yu(t.toString()),yu("Using maximum backoff delay to prevent overloading the backend."),this.Co.Eo()):t&&t.code===ku.UNAUTHENTICATED&&3!==this.state&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),null!==this.stream&&(this.qo(),this.stream.close(),this.stream=null),this.state=e,await this.listener.Zr(t)}qo(){}auth(){this.state=1;const e=this.Uo(this.Vo),t=this.Vo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([e,n])=>{this.Vo===t&&this.Ko(e,n)}),(t=>{e((()=>{const e=new Su(ku.UNKNOWN,"Fetching auth token failed: "+t.message);return this.Go(e)}))}))}Ko(e,t){const n=this.Uo(this.Vo);this.stream=this.Qo(e,t),this.stream.Jr((()=>{n((()=>(this.state=2,this.Do=this.Ws.enqueueAfterDelay(this.Po,1e4,(()=>(this.No()&&(this.state=3),Promise.resolve()))),this.listener.Jr())))})),this.stream.Zr((e=>{n((()=>this.Go(e)))})),this.stream.onMessage((e=>{n((()=>this.onMessage(e)))}))}ko(){this.state=5,this.Co.Ao((async()=>{this.state=0,this.start()}))}Go(e){return gu("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}Uo(e){return t=>{this.Ws.enqueueAndForget((()=>this.Vo===e?t():(gu("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}constructor(e,t,n,r,i,s,o,a){this.Ws=e,this.bo=n,this.Po=r,this.connection=i,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=o,this.listener=a,this.state=0,this.Vo=0,this.So=null,this.Do=null,this.stream=null,this.Co=new yp(e,t)}}class bp extends vp{Qo(e,t){return this.connection.wo("Listen",e,t)}onMessage(e){this.Co.reset();const t=function(e,t){let n;if("targetChange"in t){t.targetChange;const r=function(e){return"NO_CHANGE"===e?0:"ADD"===e?1:"REMOVE"===e?2:"CURRENT"===e?3:"RESET"===e?4:wu()}(t.targetChange.targetChangeType||"NO_CHANGE"),i=t.targetChange.targetIds||[],s=function(e,t){return e.useProto3Json?(Eu(void 0===t||"string"==typeof t),vc.fromBase64String(t||"")):(Eu(void 0===t||t instanceof Uint8Array),vc.fromUint8Array(t||new Uint8Array))}(e,t.targetChange.resumeToken),o=t.targetChange.cause,a=o&&function(e){const t=void 0===e.code?ku.UNKNOWN:Md(e.code);return new Su(t,e.message||"")}(o);n=new $d(r,i,s,a||null)}else if("documentChange"in t){t.documentChange;const r=t.documentChange;r.document,r.document.name,r.document.updateTime;const i=of(e,r.document.name),s=tf(r.document.updateTime),o=r.document.createTime?tf(r.document.createTime):Vu.min(),a=new qc({mapValue:{fields:r.document.fields}}),l=Kc.newFoundDocument(i,s,o,a),u=r.targetIds||[],c=r.removedTargetIds||[];n=new zd(u,c,l.key,l)}else if("documentDelete"in t){t.documentDelete;const r=t.documentDelete;r.document;const i=of(e,r.document),s=r.readTime?tf(r.readTime):Vu.min(),o=Kc.newNoDocument(i,s),a=r.removedTargetIds||[];n=new zd([],a,o.key,o)}else if("documentRemove"in t){t.documentRemove;const r=t.documentRemove;r.document;const i=of(e,r.document),s=r.removedTargetIds||[];n=new zd([],s,i,null)}else{if(!("filter"in t))return wu();{t.filter;const e=t.filter;e.targetId;const r=e.count||0,i=new Dd(r),s=e.targetId;n=new Bd(s,i)}}return n}(this.serializer,e),n=function(e){if(!("targetChange"in e))return Vu.min();const t=e.targetChange;return t.targetIds&&t.targetIds.length?Vu.min():t.readTime?tf(t.readTime):Vu.min()}(e);return this.listener.zo(t,n)}jo(e){const t={};t.database=uf(this.serializer),t.addTarget=function(e,t){let n;const r=t.target;return n=bh(r)?{documents:ff(e,r)}:{query:pf(e,r)},n.targetId=t.targetId,t.resumeToken.approximateByteSize()>0?n.resumeToken=Zd(e,t.resumeToken):t.snapshotVersion.compareTo(Vu.min())>0&&(n.readTime=Jd(e,t.snapshotVersion.toTimestamp())),n}(this.serializer,e);const n=function(e,t){const n=function(e,t){switch(t){case 0:return null;case 1:return"existence-filter-mismatch";case 2:return"limbo-document";default:return wu()}}(0,t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.serializer,e);n&&(t.labels=n),this.Fo(t)}Wo(e){const t={};t.database=uf(this.serializer),t.removeTarget=e,this.Fo(t)}constructor(e,t,n,r,i,s){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,r,s),this.serializer=i}}class wp extends vp{get Jo(){return this.Ho}start(){this.Ho=!1,this.lastStreamToken=void 0,super.start()}qo(){this.Ho&&this.Yo([])}Qo(e,t){return this.connection.wo("Write",e,t)}onMessage(e){if(Eu(!!e.streamToken),this.lastStreamToken=e.streamToken,this.Ho){this.Co.reset();const t=function(e,t){return e&&e.length>0?(Eu(void 0!==t),e.map((e=>function(e,t){let n=e.updateTime?tf(e.updateTime):tf(t);return n.isEqual(Vu.min())&&(n=tf(t)),new fd(n,e.transformResults||[])}(e,t)))):[]}(e.writeResults,e.commitTime),n=tf(e.commitTime);return this.listener.Zo(n,t)}return Eu(!e.writeResults||0===e.writeResults.length),this.Ho=!0,this.listener.Xo()}tu(){const e={};e.database=uf(this.serializer),this.Fo(e)}Yo(e){const t={streamToken:this.lastStreamToken,writes:e.map((e=>df(this.serializer,e)))};this.Fo(t)}constructor(e,t,n,r,i,s){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,r,s),this.serializer=i,this.Ho=!1}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ep extends class{}{nu(){if(this.eu)throw new Su(ku.FAILED_PRECONDITION,"The client has already been terminated.")}co(e,t,n){return this.nu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([r,i])=>this.connection.co(e,t,n,r,i))).catch((e=>{throw"FirebaseError"===e.name?(e.code===ku.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new Su(ku.UNKNOWN,e.toString())}))}fo(e,t,n,r){return this.nu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([i,s])=>this.connection.fo(e,t,n,i,s,r))).catch((e=>{throw"FirebaseError"===e.name?(e.code===ku.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new Su(ku.UNKNOWN,e.toString())}))}terminate(){this.eu=!0}constructor(e,t,n,r){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=n,this.serializer=r,this.eu=!1}}class _p{ou(){0===this.su&&(this.uu("Unknown"),this.iu=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this.iu=null,this.cu("Backend didn't respond within 10 seconds."),this.uu("Offline"),Promise.resolve()))))}au(e){"Online"===this.state?this.uu("Unknown"):(this.su++,this.su>=1&&(this.hu(),this.cu(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.uu("Offline")))}set(e){this.hu(),this.su=0,"Online"===e&&(this.ru=!1),this.uu(e)}uu(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}cu(e){const t=`Could not reach Cloud Firestore backend. ${e}\nThis typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.ru?(yu(t),this.ru=!1):gu("OnlineStateTracker",t)}hu(){null!==this.iu&&(this.iu.cancel(),this.iu=null)}constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.su=0,this.iu=null,this.ru=!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.lu=[],this.fu=new Map,this.du=new Set,this.wu=[],this._u=i,this._u.qr((e=>{n.enqueueAndForget((async()=>{Dp(this)&&(gu("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=_u(e);t.du.add(4),await Tp(t),t.mu.set("Unknown"),t.du.delete(4),await Sp(t)}(this))}))})),this.mu=new _p(n,r)}}async function Sp(e){if(Dp(e))for(const t of e.wu)await t(!0)}async function Tp(e){for(const t of e.wu)await t(!1)}function Ip(e,t){const n=_u(e);n.fu.has(t.targetId)||(n.fu.set(t.targetId,t),Rp(n)?Ap(n):Yp(n).No()&&Np(n,t))}function Cp(e,t){const n=_u(e),r=Yp(n);n.fu.delete(t),r.No()&&xp(n,t),0===n.fu.size&&(r.No()?r.$o():Dp(n)&&n.mu.set("Unknown"))}function Np(e,t){e.gu.Ot(t.targetId),Yp(e).jo(t)}function xp(e,t){e.gu.Ot(t),Yp(e).Wo(t)}function Ap(e){e.gu=new Hd({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ne:t=>e.fu.get(t)||null}),Yp(e).start(),e.mu.ou()}function Rp(e){return Dp(e)&&!Yp(e).xo()&&e.fu.size>0}function Dp(e){return 0===_u(e).du.size}function Op(e){e.gu=void 0}async function Pp(e){e.fu.forEach(((t,n)=>{Np(e,t)}))}async function Lp(e,t){Op(e),Rp(e)?(e.mu.au(t),Ap(e)):e.mu.set("Unknown")}async function Mp(e,t,n){if(e.mu.set("Online"),t instanceof $d&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.fu.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.fu.delete(r),e.gu.removeTarget(r))}(e,t)}catch(n){gu("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Fp(e,n)}else if(t instanceof zd?e.gu.Kt(t):t instanceof Bd?e.gu.Jt(t):e.gu.zt(t),!n.isEqual(Vu.min()))try{const t=await Jf(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.gu.Xt(t);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.fu.get(r);i&&e.fu.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach((t=>{const n=e.fu.get(t);if(!n)return;e.fu.set(t,n.withResumeToken(vc.EMPTY_BYTE_STRING,n.snapshotVersion)),xp(e,t);const r=new Tf(n.target,t,1,n.sequenceNumber);Np(e,r)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){gu("RemoteStore","Failed to raise snapshot:",t),await Fp(e,t)}}async function Fp(e,t,n){if(!ec(t))throw t;e.du.add(1),await Tp(e),e.mu.set("Offline"),n||(n=()=>Jf(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{gu("RemoteStore","Retrying IndexedDB access"),await n(),e.du.delete(1),await Sp(e)}))}function Up(e,t){return t().catch((n=>Fp(e,n,t)))}async function Vp(e){const t=_u(e),n=Xp(t);let r=t.lu.length>0?t.lu[t.lu.length-1].batchId:-1;for(;jp(t);)try{const e=await ep(t.localStore,r);if(null===e){0===t.lu.length&&n.$o();break}r=e.batchId,zp(t,e)}catch(e){await Fp(t,e)}Bp(t)&&$p(t)}function jp(e){return Dp(e)&&e.lu.length<10}function zp(e,t){e.lu.push(t);const n=Xp(e);n.No()&&n.Jo&&n.Yo(t.mutations)}function Bp(e){return Dp(e)&&!Xp(e).xo()&&e.lu.length>0}function $p(e){Xp(e).start()}async function qp(e){Xp(e).tu()}async function Hp(e){const t=Xp(e);for(const n of e.lu)t.Yo(n.mutations)}async function Kp(e,t,n){const r=e.lu.shift(),i=Ad.from(r,t,n);await Up(e,(()=>e.remoteSyncer.applySuccessfulWrite(i))),await Vp(e)}async function Wp(e,t){t&&Xp(e).Jo&&await async function(e,t){if(Ld(n=t.code)&&n!==ku.ABORTED){const n=e.lu.shift();Xp(e).Oo(),await Up(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await Vp(e)}var n}(e,t),Bp(e)&&$p(e)}async function Gp(e,t){const n=_u(e);n.asyncQueue.verifyOperationInProgress(),gu("RemoteStore","RemoteStore received new credentials");const r=Dp(n);n.du.add(3),await Tp(n),r&&n.mu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.du.delete(3),await Sp(n)}async function Qp(e,t){const n=_u(e);t?(n.du.delete(2),await Sp(n)):t||(n.du.add(2),await Tp(n),n.mu.set("Unknown"))}function Yp(e){return e.yu||(e.yu=function(e,t,n){const r=_u(e);return r.nu(),new bp(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{Jr:Pp.bind(null,e),Zr:Lp.bind(null,e),zo:Mp.bind(null,e)}),e.wu.push((async t=>{t?(e.yu.Oo(),Rp(e)?Ap(e):e.mu.set("Unknown")):(await e.yu.stop(),Op(e))}))),e.yu}function Xp(e){return e.pu||(e.pu=function(e,t,n){const r=_u(e);return r.nu(),new wp(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{Jr:qp.bind(null,e),Zr:Wp.bind(null,e),Xo:Hp.bind(null,e),Zo:Kp.bind(null,e)}),e.wu.push((async t=>{t?(e.pu.Oo(),await Vp(e)):(await e.pu.stop(),e.lu.length>0&&(gu("RemoteStore",`Stopping write stream with ${e.lu.length} pending writes`),e.lu=[]))}))),e.pu
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class em{static emptySet(e){return new em(e.comparator)}has(e){return null!=this.keyedMap.get(e)}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const t=this.keyedMap.get(e);return t?this.sortedSet.indexOf(t):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal(((t,n)=>(e(t),!1)))}add(e){const t=this.delete(e.key);return t.copy(t.keyedMap.insert(e.key,e),t.sortedSet.insert(e,null))}delete(e){const t=this.get(e);return t?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(t)):this}isEqual(e){if(!(e instanceof em))return!1;if(this.size!==e.size)return!1;const t=this.sortedSet.getIterator(),n=e.sortedSet.getIterator();for(;t.hasNext();){const e=t.getNext().key,r=n.getNext().key;if(!e.isEqual(r))return!1}return!0}toString(){const e=[];return this.forEach((t=>{e.push(t.toString())})),0===e.length?"DocumentSet ()":"DocumentSet (\n  "+e.join("  \n")+"\n)"}copy(e,t){const n=new em;return n.comparator=this.comparator,n.keyedMap=e,n.sortedSet=t,n}constructor(e){this.comparator=e?(t,n)=>e(t,n)||qu.comparator(t.key,n.key):(e,t)=>qu.comparator(e.key,t.key),this.keyedMap=Bh(),this.sortedSet=new hc(this.comparator)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tm{track(e){const t=e.doc.key,n=this.Iu.get(t);n?0!==e.type&&3===n.type?this.Iu=this.Iu.insert(t,e):3===e.type&&1!==n.type?this.Iu=this.Iu.insert(t,{type:n.type,doc:e.doc}):2===e.type&&2===n.type?this.Iu=this.Iu.insert(t,{type:2,doc:e.doc}):2===e.type&&0===n.type?this.Iu=this.Iu.insert(t,{type:0,doc:e.doc}):1===e.type&&0===n.type?this.Iu=this.Iu.remove(t):1===e.type&&2===n.type?this.Iu=this.Iu.insert(t,{type:1,doc:n.doc}):0===e.type&&1===n.type?this.Iu=this.Iu.insert(t,{type:2,doc:e.doc}):wu():this.Iu=this.Iu.insert(t,e)}Tu(){const e=[];return this.Iu.inorderTraversal(((t,n)=>{e.push(n)})),e}constructor(){this.Iu=new hc(qu.comparator)}}class nm{static fromInitialDocuments(e,t,n,r,i){const s=[];return t.forEach((e=>{s.push({type:0,doc:e})})),new nm(e,t,em.emptySet(t),s,n,r,!0,!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Rh(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(let e=0;e<t.length;e++)if(t[e].type!==n[e].type||!t[e].doc.isEqual(n[e].doc))return!1;return!0}constructor(e,t,n,r,i,s,o,a,l){this.query=e,this.docs=t,this.oldDocs=n,this.docChanges=r,this.mutatedKeys=i,this.fromCache=s,this.syncStateChanged=o,this.excludesMetadataChanges=a,this.hasCachedResults=l}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rm{constructor(){this.Eu=void 0,this.listeners=[]}}class im{constructor(){this.queries=new Uh((e=>Dh(e)),Rh),this.onlineState="Unknown",this.Au=new Set}}async function sm(e,t){const n=_u(e),r=t.query;let i=!1,s=n.queries.get(r);if(s||(i=!0,s=new rm),i)try{s.Eu=await n.onListen(r)}catch(e){const n=Zp(e,`Initialization of query '${Oh(t.query)}' failed`);return void t.onError(n)}n.queries.set(r,s),s.listeners.push(t),t.Ru(n.onlineState),s.Eu&&t.vu(s.Eu)&&um(n)}async function om(e,t){const n=_u(e),r=t.query;let i=!1;const s=n.queries.get(r);if(s){const e=s.listeners.indexOf(t);e>=0&&(s.listeners.splice(e,1),i=0===s.listeners.length)}if(i)return n.queries.delete(r),n.onUnlisten(r)}function am(e,t){const n=_u(e);let r=!1;for(const e of t){const t=e.query,i=n.queries.get(t);if(i){for(const t of i.listeners)t.vu(e)&&(r=!0);i.Eu=e}}r&&um(n)}function lm(e,t,n){const r=_u(e),i=r.queries.get(t);if(i)for(const e of i.listeners)e.onError(n);r.queries.delete(t)}function um(e){e.Au.forEach((e=>{e.next()}))}class cm{vu(e){if(!this.options.includeMetadataChanges){const t=[];for(const n of e.docChanges)3!==n.type&&t.push(n);e=new nm(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Pu?this.Su(e)&&(this.bu.next(e),t=!0):this.Du(e,this.onlineState)&&(this.Cu(e),t=!0),this.Vu=e,t}onError(e){this.bu.error(e)}Ru(e){this.onlineState=e;let t=!1;return this.Vu&&!this.Pu&&this.Du(this.Vu,e)&&(this.Cu(this.Vu),t=!0),t}Du(e,t){if(!e.fromCache)return!0;const n="Offline"!==t;return(!this.options.xu||!n)&&(!e.docs.isEmpty()||e.hasCachedResults||"Offline"===t)}Su(e){if(e.docChanges.length>0)return!0;const t=this.Vu&&this.Vu.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}Cu(e){e=nm.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Pu=!0,this.bu.next(e)}constructor(e,t,n){this.query=e,this.bu=t,this.Pu=!1,this.Vu=null,this.onlineState="Unknown",this.options=n||{}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class hm{constructor(e){this.key=e}}class dm{constructor(e){this.key=e}}class fm{get Qu(){return this.Lu}zu(e,t){const n=t?t.ju:new tm,r=t?t.Gu:this.Gu;let i=t?t.mutatedKeys:this.mutatedKeys,s=r,o=!1;const a="F"===this.query.limitType&&r.size===this.query.limit?r.last():null,l="L"===this.query.limitType&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal(((e,t)=>{const u=r.get(e),c=Ph(this.query,t)?t:null,h=!!u&&this.mutatedKeys.has(u.key),d=!!c&&(c.hasLocalMutations||this.mutatedKeys.has(c.key)&&c.hasCommittedMutations);let f=!1;u&&c?u.data.isEqual(c.data)?h!==d&&(n.track({type:3,doc:c}),f=!0):this.Wu(u,c)||(n.track({type:2,doc:c}),f=!0,(a&&this.Ku(c,a)>0||l&&this.Ku(c,l)<0)&&(o=!0)):!u&&c?(n.track({type:0,doc:c}),f=!0):u&&!c&&(n.track({type:1,doc:u}),f=!0,(a||l)&&(o=!0)),f&&(c?(s=s.add(c),i=d?i.add(e):i.delete(e)):(s=s.delete(e),i=i.delete(e)))})),null!==this.query.limit)for(;s.size>this.query.limit;){const e="F"===this.query.limitType?s.last():s.first();s=s.delete(e.key),i=i.delete(e.key),n.track({type:1,doc:e})}return{Gu:s,ju:n,Mi:o,mutatedKeys:i}}Wu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n){const r=this.Gu;this.Gu=e.Gu,this.mutatedKeys=e.mutatedKeys;const i=e.ju.Tu();i.sort(((e,t)=>function(e,t){const n=e=>{switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return wu()}};return n(e)-n(t)}(e.type,t.type)||this.Ku(e.doc,t.doc))),this.Hu(n);const s=t?this.Ju():[],o=0===this.Uu.size&&this.current?1:0,a=o!==this.qu;return this.qu=o,0!==i.length||a?{snapshot:new nm(this.query,e.Gu,r,i,e.mutatedKeys,0===o,a,!1,!!n&&n.resumeToken.approximateByteSize()>0),Yu:s}:{Yu:s}}Ru(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({Gu:this.Gu,ju:new tm,mutatedKeys:this.mutatedKeys,Mi:!1},!1)):{Yu:[]}}Zu(e){return!this.Lu.has(e)&&!!this.Gu.has(e)&&!this.Gu.get(e).hasLocalMutations}Hu(e){e&&(e.addedDocuments.forEach((e=>this.Lu=this.Lu.add(e))),e.modifiedDocuments.forEach((e=>{})),e.removedDocuments.forEach((e=>this.Lu=this.Lu.delete(e))),this.current=e.current)}Ju(){if(!this.current)return[];const e=this.Uu;this.Uu=Qh(),this.Gu.forEach((e=>{this.Zu(e.key)&&(this.Uu=this.Uu.add(e.key))}));const t=[];return e.forEach((e=>{this.Uu.has(e)||t.push(new dm(e))})),this.Uu.forEach((n=>{e.has(n)||t.push(new hm(n))})),t}Xu(e){this.Lu=e.Wi,this.Uu=Qh();const t=this.zu(e.documents);return this.applyChanges(t,!0)}tc(){return nm.fromInitialDocuments(this.query,this.Gu,this.mutatedKeys,0===this.qu,this.hasCachedResults)}constructor(e,t){this.query=e,this.Lu=t,this.qu=null,this.hasCachedResults=!1,this.current=!1,this.Uu=Qh(),this.mutatedKeys=Qh(),this.Ku=Mh(e),this.Gu=new em(this.Ku)}}class pm{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class mm{constructor(e){this.key=e,this.ec=!1}}class gm{get isPrimaryClient(){return!0===this.fc}constructor(e,t,n,r,i,s){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.nc={},this.sc=new Uh((e=>Dh(e)),Rh),this.ic=new Map,this.rc=new Set,this.oc=new hc(qu.comparator),this.uc=new Map,this.cc=new Uf,this.ac={},this.hc=new Map,this.lc=Df.bn(),this.onlineState="Unknown",this.fc=void 0}}async function ym(e,t){const n=Lm(e);let r,i;const s=n.sc.get(t);if(s)r=s.targetId,n.sharedClientState.addLocalQueryTarget(r),i=s.view.tc();else{const e=await tp(n.localStore,Nh(t));n.isPrimaryClient&&Ip(n.remoteStore,e);const s=n.sharedClientState.addLocalQueryTarget(e.targetId);r=e.targetId,i=await vm(n,t,r,"current"===s,e.resumeToken)}return i}async function vm(e,t,n,r,i){e.dc=(t,n,r)=>async function(e,t,n,r){let i=t.view.zu(n);i.Mi&&(i=await rp(e.localStore,t.query,!1).then((({documents:e})=>t.view.zu(e,i))));const s=r&&r.targetChanges.get(t.targetId),o=t.view.applyChanges(i,e.isPrimaryClient,s);return xm(e,t.targetId,o.Yu),o.snapshot}(e,t,n,r);const s=await rp(e.localStore,t,!0),o=new fm(t,s.Wi),a=o.zu(s.documents),l=jd.createSynthesizedTargetChangeForCurrentChange(n,r&&"Offline"!==e.onlineState,i),u=o.applyChanges(a,e.isPrimaryClient,l);xm(e,n,u.Yu);const c=new pm(t,n,o);return e.sc.set(t,c),e.ic.has(n)?e.ic.get(n).push(t):e.ic.set(n,[t]),u.snapshot}async function bm(e,t){const n=_u(e),r=n.sc.get(t),i=n.ic.get(r.targetId);if(i.length>1)return n.ic.set(r.targetId,i.filter((e=>!Rh(e,t)))),void n.sc.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await np(n.localStore,r.targetId,!1).then((()=>{n.sharedClientState.clearQueryState(r.targetId),Cp(n.remoteStore,r.targetId),Cm(n,r.targetId)})).catch(Ju)):(Cm(n,r.targetId),await np(n.localStore,r.targetId,!0))}async function wm(e,t){const n=_u(e);try{const e=await function(e,t){const n=_u(e),r=t.snapshotVersion;let i=n.Li;return n.persistence.runTransaction("Apply remote event","readwrite-primary",(e=>{const s=n.Ki.newChangeBuffer({trackRemovals:!0});i=n.Li;const o=[];t.targetChanges.forEach(((s,a)=>{const l=i.get(a);if(!l)return;o.push(n.Ds.removeMatchingKeys(e,s.removedDocuments,a).next((()=>n.Ds.addMatchingKeys(e,s.addedDocuments,a))));let u=l.withSequenceNumber(e.currentSequenceNumber);t.targetMismatches.has(a)?u=u.withResumeToken(vc.EMPTY_BYTE_STRING,Vu.min()).withLastLimboFreeSnapshotVersion(Vu.min()):s.resumeToken.approximateByteSize()>0&&(u=u.withResumeToken(s.resumeToken,r)),i=i.insert(a,u),function(e,t,n){return 0===e.resumeToken.approximateByteSize()||t.snapshotVersion.toMicroseconds()-e.snapshotVersion.toMicroseconds()>=3e8||n.addedDocuments.size+n.modifiedDocuments.size+n.removedDocuments.size>0}(l,u,s)&&o.push(n.Ds.updateTargetData(e,u))}));let a=jh(),l=Qh();if(t.documentUpdates.forEach((r=>{t.resolvedLimboDocuments.has(r)&&o.push(n.persistence.referenceDelegate.updateLimboDocument(e,r))})),o.push(Zf(e,s,t.documentUpdates).next((e=>{a=e.zi,l=e.ji}))),!r.isEqual(Vu.min())){const t=n.Ds.getLastRemoteSnapshotVersion(e).next((t=>n.Ds.setTargetsMetadata(e,e.currentSequenceNumber,r)));o.push(t)}return Zu.waitFor(o).next((()=>s.apply(e))).next((()=>n.localDocuments.getLocalViewOfDocuments(e,a,l))).next((()=>a))})).then((e=>(n.Li=i,e)))}(n.localStore,t);t.targetChanges.forEach(((e,t)=>{const r=n.uc.get(t);r&&(Eu(e.addedDocuments.size+e.modifiedDocuments.size+e.removedDocuments.size<=1),e.addedDocuments.size>0?r.ec=!0:e.modifiedDocuments.size>0?Eu(r.ec):e.removedDocuments.size>0&&(Eu(r.ec),r.ec=!1))})),await Dm(n,e,t)}catch(e){await Ju(e)}}function Em(e,t,n){const r=_u(e);if(r.isPrimaryClient&&0===n||!r.isPrimaryClient&&1===n){const e=[];r.sc.forEach(((n,r)=>{const i=r.view.Ru(t);i.snapshot&&e.push(i.snapshot)})),function(e,t){const n=_u(e);n.onlineState=t;let r=!1;n.queries.forEach(((e,n)=>{for(const e of n.listeners)e.Ru(t)&&(r=!0)})),r&&um(n)}(r.eventManager,t),e.length&&r.nc.zo(e),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}async function _m(e,t,n){const r=_u(e);r.sharedClientState.updateQueryState(t,"rejected",n);const i=r.uc.get(t),s=i&&i.key;if(s){let e=new hc(qu.comparator);e=e.insert(s,Kc.newNoDocument(s,Vu.min()));const n=Qh().add(s),i=new Vd(Vu.min(),new Map,new pc(Mu),e,n);await wm(r,i),r.oc=r.oc.remove(s),r.uc.delete(t),Rm(r)}else await np(r.localStore,t,!1).then((()=>Cm(r,t,n))).catch(Ju)}async function km(e,t){const n=_u(e),r=t.batch.batchId;try{const e=await function(e,t){const n=_u(e);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",(e=>{const r=t.batch.keys(),i=n.Ki.newChangeBuffer({trackRemovals:!0});return function(e,t,n,r){const i=n.batch,s=i.keys();let o=Zu.resolve();return s.forEach((e=>{o=o.next((()=>r.getEntry(t,e))).next((t=>{const s=n.docVersions.get(e);Eu(null!==s),t.version.compareTo(s)<0&&(i.applyToRemoteDocument(t,n),t.isValidDocument()&&(t.setReadTime(n.commitVersion),r.addEntry(t)))}))})),o.next((()=>e.mutationQueue.removeMutationBatch(t,i)))}(n,e,t,i).next((()=>i.apply(e))).next((()=>n.mutationQueue.performConsistencyCheck(e))).next((()=>n.documentOverlayCache.removeOverlaysForBatchId(e,r,t.batch.batchId))).next((()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,function(e){let t=Qh();for(let n=0;n<e.mutationResults.length;++n)e.mutationResults[n].transformResults.length>0&&(t=t.add(e.batch.mutations[n].key));return t}(t)))).next((()=>n.localDocuments.getDocuments(e,r)))}))}(n.localStore,t);Im(n,r,null),Tm(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await Dm(n,e)}catch(e){await Ju(e)}}async function Sm(e,t,n){const r=_u(e);try{const e=await function(e,t){const n=_u(e);return n.persistence.runTransaction("Reject batch","readwrite-primary",(e=>{let r;return n.mutationQueue.lookupMutationBatch(e,t).next((t=>(Eu(null!==t),r=t.keys(),n.mutationQueue.removeMutationBatch(e,t)))).next((()=>n.mutationQueue.performConsistencyCheck(e))).next((()=>n.documentOverlayCache.removeOverlaysForBatchId(e,r,t))).next((()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,r))).next((()=>n.localDocuments.getDocuments(e,r)))}))}(r.localStore,t);Im(r,t,n),Tm(r,t),r.sharedClientState.updateMutationState(t,"rejected",n),await Dm(r,e)}catch(n){await Ju(n)}}function Tm(e,t){(e.hc.get(t)||[]).forEach((e=>{e.resolve()})),e.hc.delete(t)}function Im(e,t,n){const r=_u(e);let i=r.ac[r.currentUser.toKey()];if(i){const e=i.get(t);e&&(n?e.reject(n):e.resolve(),i=i.remove(t)),r.ac[r.currentUser.toKey()]=i}}function Cm(e,t,n=null){e.sharedClientState.removeLocalQueryTarget(t);for(const r of e.ic.get(t))e.sc.delete(r),n&&e.nc.wc(r,n);e.ic.delete(t),e.isPrimaryClient&&e.cc.hs(t).forEach((t=>{e.cc.containsKey(t)||Nm(e,t)}))}function Nm(e,t){e.rc.delete(t.path.canonicalString());const n=e.oc.get(t);null!==n&&(Cp(e.remoteStore,n),e.oc=e.oc.remove(t),e.uc.delete(n),Rm(e))}function xm(e,t,n){for(const r of n)r instanceof hm?(e.cc.addReference(r.key,t),Am(e,r)):r instanceof dm?(gu("SyncEngine","Document no longer in limbo: "+r.key),e.cc.removeReference(r.key,t),e.cc.containsKey(r.key)||Nm(e,r.key)):wu()}function Am(e,t){const n=t.key,r=n.path.canonicalString();e.oc.get(n)||e.rc.has(r)||(gu("SyncEngine","New document in limbo: "+n),e.rc.add(r),Rm(e))}function Rm(e){for(;e.rc.size>0&&e.oc.size<e.maxConcurrentLimboResolutions;){const t=e.rc.values().next().value;e.rc.delete(t);const n=new qu(zu.fromString(t)),r=e.lc.next();e.uc.set(r,new mm(n)),e.oc=e.oc.insert(n,r),Ip(e.remoteStore,new Tf(Nh(_h(n.path)),r,2,tc.ct))}}async function Dm(e,t,n){const r=_u(e),i=[],s=[],o=[];r.sc.isEmpty()||(r.sc.forEach(((e,a)=>{o.push(r.dc(a,t,n).then((e=>{if((e||n)&&r.isPrimaryClient&&r.sharedClientState.updateQueryState(a.targetId,(null==e?void 0:e.fromCache)?"not-current":"current"),e){i.push(e);const t=Wf.Di(a.targetId,e);s.push(t)}})))})),await Promise.all(o),r.nc.zo(i),await async function(e,t){const n=_u(e);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",(e=>Zu.forEach(t,(t=>Zu.forEach(t.Vi,(r=>n.persistence.referenceDelegate.addReference(e,t.targetId,r))).next((()=>Zu.forEach(t.Si,(r=>n.persistence.referenceDelegate.removeReference(e,t.targetId,r)))))))))}catch(e){if(!ec(e))throw e;gu("LocalStore","Failed to update sequence numbers: "+e)}for(const e of t){const t=e.targetId;if(!e.fromCache){const e=n.Li.get(t),r=e.snapshotVersion,i=e.withLastLimboFreeSnapshotVersion(r);n.Li=n.Li.insert(t,i)}}}(r.localStore,s))}async function Om(e,t){const n=_u(e);if(!n.currentUser.isEqual(t)){gu("SyncEngine","User change. New user:",t.toKey());const e=await Xf(n.localStore,t);n.currentUser=t,function(e,t){e.hc.forEach((e=>{e.forEach((e=>{e.reject(new Su(ku.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))}))})),e.hc.clear()}(n),n.sharedClientState.handleUserChange(t,e.removedBatchIds,e.addedBatchIds),await Dm(n,e.Qi)}}function Pm(e,t){const n=_u(e),r=n.uc.get(t);if(r&&r.ec)return Qh().add(r.key);{let e=Qh();const r=n.ic.get(t);if(!r)return e;for(const t of r){const r=n.sc.get(t);e=e.unionWith(r.view.Qu)}return e}}function Lm(e){const t=_u(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=wm.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=Pm.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=_m.bind(null,t),t.nc.zo=am.bind(null,t.eventManager),t.nc.wc=lm.bind(null,t.eventManager),t}function Mm(e){const t=_u(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=km.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Sm.bind(null,t),t}class Fm{async initialize(e){this.serializer=gp(e.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(e),this.persistence=this.createPersistence(e),await this.persistence.start(),this.localStore=this.createLocalStore(e),this.gcScheduler=this.createGarbageCollectionScheduler(e,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(e,this.localStore)}createGarbageCollectionScheduler(e,t){return null}createIndexBackfillerScheduler(e,t){return null}createLocalStore(e){return Yf(this.persistence,new Gf,e.initialUser,this.serializer)}createPersistence(e){return new qf(Kf.Fs,this.serializer)}createSharedClientState(e){return new op}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}constructor(){this.synchronizeTabs=!1}}class Um{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>Em(this.syncEngine,e,1),this.remoteStore.remoteSyncer.handleCredentialChange=Om.bind(null,this.syncEngine),await Qp(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new im}createDatastore(e){const t=gp(e.databaseInfo.databaseId),n=(r=e.databaseInfo,new pp(r));var r;return function(e,t,n,r){return new Ep(e,t,n,r)}(e.authCredentials,e.appCheckCredentials,n,t)}createRemoteStore(e){var t,n,r,i,s;return t=this.localStore,n=this.datastore,r=e.asyncQueue,i=e=>Em(this.syncEngine,e,0),s=lp.D()?new lp:new ap,new kp(t,n,r,i,s)}createSyncEngine(e,t){return function(e,t,n,r,i,s,o){const a=new gm(e,t,n,r,i,s);return o&&(a.fc=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}terminate(){return async function(e){const t=_u(e);gu("RemoteStore","RemoteStore shutting down."),t.du.add(5),await Tp(t),t._u.shutdown(),t.mu.set("Unknown")}(this.remoteStore)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Vm{next(e){this.observer.next&&this.gc(this.observer.next,e)}error(e){this.observer.error?this.gc(this.observer.error,e):yu("Uncaught Error in snapshot listener:",e.toString())}yc(){this.muted=!0}gc(e,t){this.muted||setTimeout((()=>{this.muted||e(t)}),0)}constructor(e){this.observer=e,this.muted=!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class jm{async getConfiguration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}verifyNotTerminated(){if(this.asyncQueue.isShuttingDown)throw new Su(ku.FAILED_PRECONDITION,"The client has already been terminated.")}terminate(){this.asyncQueue.enterRestrictedMode();const e=new Tu;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const n=Zp(t,"Failed to shutdown persistence");e.reject(n)}})),e.promise}constructor(e,t,n,r){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=n,this.databaseInfo=r,this.user=du.UNAUTHENTICATED,this.clientId=Lu.A(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this.authCredentials.start(n,(async e=>{gu("FirestoreClient","Received user=",e.uid),await this.authCredentialListener(e),this.user=e})),this.appCheckCredentials.start(n,(e=>(gu("FirestoreClient","Received new app check token=",e),this.appCheckCredentialListener(e,this.user))))}}async function zm(e,t){e.asyncQueue.verifyOperationInProgress(),gu("FirestoreClient","Initializing OfflineComponentProvider");const n=await e.getConfiguration();await t.initialize(n);let r=n.initialUser;e.setCredentialChangeListener((async e=>{r.isEqual(e)||(await Xf(t.localStore,e),r=e)})),t.persistence.setDatabaseDeletedListener((()=>e.terminate())),e._offlineComponents=t}async function Bm(e,t){e.asyncQueue.verifyOperationInProgress();const n=await qm(e);gu("FirestoreClient","Initializing OnlineComponentProvider");const r=await e.getConfiguration();await t.initialize(n,r),e.setCredentialChangeListener((e=>Gp(t.remoteStore,e))),e.setAppCheckTokenChangeListener(((e,n)=>Gp(t.remoteStore,n))),e._onlineComponents=t}function $m(e){return"FirebaseError"===e.name?e.code===ku.FAILED_PRECONDITION||e.code===ku.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&e instanceof DOMException)||22===e.code||20===e.code||11===e.code}async function qm(e){if(!e._offlineComponents)if(e._uninitializedComponentsProvider){gu("FirestoreClient","Using user provided OfflineComponentProvider");try{await zm(e,e._uninitializedComponentsProvider._offline)}catch(t){const n=t;if(!$m(n))throw n;vu("Error using user provided cache. Falling back to memory cache: "+n),await zm(e,new Fm)}}else gu("FirestoreClient","Using default OfflineComponentProvider"),await zm(e,new Fm);return e._offlineComponents}async function Hm(e){return e._onlineComponents||(e._uninitializedComponentsProvider?(gu("FirestoreClient","Using user provided OnlineComponentProvider"),await Bm(e,e._uninitializedComponentsProvider._online)):(gu("FirestoreClient","Using default OnlineComponentProvider"),await Bm(e,new Um))),e._onlineComponents}function Km(e){return Hm(e).then((e=>e.syncEngine))}async function Wm(e){const t=await Hm(e),n=t.eventManager;return n.onListen=ym.bind(null,t.syncEngine),n.onUnlisten=bm.bind(null,t.syncEngine),n}function Gm(e,t,n={}){const r=new Tu;return e.asyncQueue.enqueueAndForget((async()=>function(e,t,n,r,i){const s=new Vm({next:n=>{t.enqueueAndForget((()=>om(e,o))),n.fromCache&&"server"===r.source?i.reject(new Su(ku.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new cm(n,s,{includeMetadataChanges:!0,xu:!0});return sm(e,o)}(await Wm(e),e.asyncQueue,t,n,r))),r.promise}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ym(e,t,n){if(!n)throw new Su(ku.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function Xm(e){if(!qu.isDocumentKey(e))throw new Su(ku.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function Jm(e){if(qu.isDocumentKey(e))throw new Su(ku.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function Zm(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{const t=function(e){return e.constructor?e.constructor.name:null}(e);return t?`a custom ${t} object`:"an object"}}return"function"==typeof e?"a function":wu()}function eg(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new Su(ku.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=Zm(e);throw new Su(ku.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class tg{isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}constructor(e){var t;if(void 0===e.host){if(void 0!==e.ssl)throw new Su(ku.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=null===(t=e.ssl)||void 0===t||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.cache=e.localCache,void 0===e.cacheSizeBytes)this.cacheSizeBytes=41943040;else{if(-1!==e.cacheSizeBytes&&e.cacheSizeBytes<1048576)throw new Su(ku.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.useFetchStreams=!!e.useFetchStreams,function(e,t,n,r){if(!0===t&&!0===r)throw new Su(ku.INVALID_ARGUMENT,`${e} and ${n} cannot be used together.`)}("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ng{get app(){if(!this._app)throw new Su(ku.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return void 0!==this._terminateTask}_setSettings(e){if(this._settingsFrozen)throw new Su(ku.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new tg(e),void 0!==e.credentials&&(this._authCredentials=function(e){if(!e)return new Cu;switch(e.type){case"firstParty":return new Ru(e.sessionIndex||"0",e.iamToken||null,e.authTokenFactory||null);case"provider":return e.client;default:throw new Su(ku.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){const t=Qm.get(e);t&&(gu("ComponentProvider","Removing Datastore"),Qm.delete(e),t.terminate())}(this),Promise.resolve()}constructor(e,t,n,r){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=n,this._app=r,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new tg({}),this._settingsFrozen=!1}}function rg(e,t,n,r={}){var i;const s=(e=eg(e,ng))._getSettings();if("firestore.googleapis.com"!==s.host&&s.host!==t&&vu("Host has been set in both settings() and useEmulator(), emulator host will be used"),e._setSettings(Object.assign(Object.assign({},s),{host:`${t}:${n}`,ssl:!1})),r.mockUserToken){let t,n;if("string"==typeof r.mockUserToken)t=r.mockUserToken,n=du.MOCK_USER;else{t=Ae(r.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);const s=r.mockUserToken.sub||r.mockUserToken.user_id;if(!s)throw new Su(ku.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new du(s)}e._authCredentials=new Nu(new Iu(t,n))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ig{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new og(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ig(this.firestore,e,this._key)}constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}}class sg{withConverter(e){return new sg(this.firestore,e,this._query)}constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}}class og extends sg{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ig(this.firestore,null,new qu(e))}withConverter(e){return new og(this.firestore,e,this._path)}constructor(e,t,n){super(e,t,_h(n)),this._path=n,this.type="collection"}}function ag(e,t,...n){if(e=We(e),Ym("collection","path",t),e instanceof ng){const r=zu.fromString(t,...n);return Jm(r),new og(e,null,r)}{if(!(e instanceof ig||e instanceof og))throw new Su(ku.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(zu.fromString(t,...n));return Jm(r),new og(e.firestore,null,r)}}function lg(e,t,...n){if(e=We(e),1===arguments.length&&(t=Lu.A()),Ym("doc","path",t),e instanceof ng){const r=zu.fromString(t,...n);return Xm(r),new ig(e,null,new qu(r))}{if(!(e instanceof ig||e instanceof og))throw new Su(ku.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(zu.fromString(t,...n));return Xm(r),new ig(e.firestore,e instanceof og?e.converter:null,new qu(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ug{get isShuttingDown(){return this.Oc}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Uc(),this.Kc(e)}enterRestrictedMode(e){if(!this.Oc){this.Oc=!0,this.Bc=e||!1;const t=mp();t&&"function"==typeof t.removeEventListener&&t.removeEventListener("visibilitychange",this.qc)}}enqueue(e){if(this.Uc(),this.Oc)return new Promise((()=>{}));const t=new Tu;return this.Kc((()=>this.Oc&&this.Bc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.kc.push(e),this.Gc())))}async Gc(){if(0!==this.kc.length){try{await this.kc[0](),this.kc.shift(),this.Co.reset()}catch(e){if(!ec(e))throw e;gu("AsyncQueue","Operation failed with retryable error: "+e)}this.kc.length>0&&this.Co.Ao((()=>this.Gc()))}}Kc(e){const t=this.Nc.then((()=>(this.Fc=!0,e().catch((e=>{this.Mc=e,this.Fc=!1;const t=function(e){let t=e.message||"";return e.stack&&(t=e.stack.includes(e.message)?e.stack:e.message+"\n"+e.stack),t}(e);throw yu("INTERNAL UNHANDLED ERROR: ",t),e})).then((e=>(this.Fc=!1,e))))));return this.Nc=t,t}enqueueAfterDelay(e,t,n){this.Uc(),this.Lc.indexOf(e)>-1&&(t=0);const r=Jp.createAndSchedule(this,e,t,n,(e=>this.Qc(e)));return this.$c.push(r),r}Uc(){this.Mc&&wu()}verifyOperationInProgress(){}async zc(){let e;do{e=this.Nc,await e}while(e!==this.Nc)}jc(e){for(const t of this.$c)if(t.timerId===e)return!0;return!1}Wc(e){return this.zc().then((()=>{this.$c.sort(((e,t)=>e.targetTimeMs-t.targetTimeMs));for(const t of this.$c)if(t.skipDelay(),"all"!==e&&t.timerId===e)break;return this.zc()}))}Hc(e){this.Lc.push(e)}Qc(e){const t=this.$c.indexOf(e);this.$c.splice(t,1)}constructor(){this.Nc=Promise.resolve(),this.kc=[],this.Oc=!1,this.$c=[],this.Mc=null,this.Fc=!1,this.Bc=!1,this.Lc=[],this.Co=new yp(this,"async_queue_retry"),this.qc=()=>{const e=mp();e&&gu("AsyncQueue","Visibility state changed to "+e.visibilityState),this.Co.vo()};const e=mp();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.qc)}}class cg extends ng{_terminate(){return this._firestoreClient||fg(this),this._firestoreClient.terminate()}constructor(e,t,n,r){super(e,t,n,r),this.type="firestore",this._queue=new ug,this._persistenceKey=(null==r?void 0:r.name)||"[DEFAULT]"}}function hg(e,t){const n="string"==typeof e?e:t||"(default)",r=Pt("object"==typeof e?e:Vt(),"firestore").getImmediate({identifier:n});if(!r._initialized){const e=Ie("firestore");e&&rg(r,...e)}return r}function dg(e){return e._firestoreClient||fg(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function fg(e){var t,n,r;const i=e._freezeSettings(),s=function(e,t,n,r){return new Ic(e,t,n,r.host,r.ssl,r.experimentalForceLongPolling,r.experimentalAutoDetectLongPolling,r.useFetchStreams)}(e._databaseId,(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",e._persistenceKey,i);e._firestoreClient=new jm(e._authCredentials,e._appCheckCredentials,e._queue,s),(null===(n=i.cache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(r=i.cache)||void 0===r?void 0:r._onlineComponentProvider)&&(e._firestoreClient._uninitializedComponentsProvider={_offlineKind:i.cache.kind,_offline:i.cache._offlineComponentProvider,_online:i.cache._onlineComponentProvider})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class pg{static fromBase64String(e){try{return new pg(vc.fromBase64String(e))}catch(e){throw new Su(ku.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new pg(vc.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}constructor(e){this._byteString=e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mg{isEqual(e){return this._internalPath.isEqual(e._internalPath)}constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new Su(ku.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $u(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yg{get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Mu(this._lat,e._lat)||Mu(this._long,e._long)}constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new Su(ku.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new Su(ku.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vg=/^__.*__$/;class bg{toMutation(e,t){return null!==this.fieldMask?new kd(e,this.data,this.fieldMask,t,this.fieldTransforms):new _d(e,this.data,t,this.fieldTransforms)}constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}}function wg(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw wu()}}class Eg{get path(){return this.settings.path}get Yc(){return this.settings.Yc}Zc(e){return new Eg(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Xc(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Zc({path:n,ta:!1});return r.ea(e),r}na(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Zc({path:n,ta:!1});return r.Jc(),r}sa(e){return this.Zc({path:void 0,ta:!0})}ia(e){return Og(e,this.settings.methodName,this.settings.ra||!1,this.path,this.settings.oa)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}Jc(){if(this.path)for(let e=0;e<this.path.length;e++)this.ea(this.path.get(e))}ea(e){if(0===e.length)throw this.ia("Document fields must not be empty");if(wg(this.Yc)&&vg.test(e))throw this.ia('Document fields cannot begin and end with "__"')}constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Jc(),this.fieldTransforms=i||[],this.fieldMask=s||[]}}class _g{ua(e,t,n,r=!1){return new Eg({Yc:e,methodName:t,oa:n,path:$u.emptyPath(),ta:!1,ra:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||gp(e)}}function kg(e){const t=e._freezeSettings(),n=gp(e._databaseId);return new _g(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Sg(e,t,n,r,i,s={}){const o=e.ua(s.merge||s.mergeFields?2:0,t,n,i);xg("Data must be an object, but it was:",o,r);const a=Cg(r,o);let l,u;if(s.merge)l=new gc(o.fieldMask),u=o.fieldTransforms;else if(s.mergeFields){const e=[];for(const r of s.mergeFields){const i=Ag(t,r,n);if(!o.contains(i))throw new Su(ku.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);Pg(e,i)||e.push(i)}l=new gc(e),u=o.fieldTransforms.filter((e=>l.covers(e.field)))}else l=null,u=o.fieldTransforms;return new bg(new qc(a),l,u)}function Tg(e,t,n,r=!1){return Ig(n,e.ua(r?4:3,t))}function Ig(e,t){if(Ng(e=We(e)))return xg("Unsupported field value:",t,e),Cg(e,t);if(e instanceof gg)return function(e,t){if(!wg(t.Yc))throw t.ia(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.ia(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.ta&&4!==t.Yc)throw t.ia("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=Ig(i,t.sa(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=We(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return ed(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=Uu.fromDate(e);return{timestampValue:Jd(t.serializer,n)}}if(e instanceof Uu){const n=new Uu(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:Jd(t.serializer,n)}}if(e instanceof yg)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof pg)return{bytesValue:Zd(t.serializer,e._byteString)};if(e instanceof ig){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.ia(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:nf(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.ia(`Unsupported field value: ${Zm(e)}`)}(e,t)}function Cg(e,t){const n={};return cc(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):uc(e,((e,r)=>{const i=Ig(r,t.Xc(e));null!=i&&(n[e]=i)})),{mapValue:{fields:n}}}function Ng(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof Uu||e instanceof yg||e instanceof pg||e instanceof ig||e instanceof gg)}function xg(e,t,n){if(!Ng(n)||!function(e){return"object"==typeof e&&null!==e&&(Object.getPrototypeOf(e)===Object.prototype||null===Object.getPrototypeOf(e))}(n)){const r=Zm(n);throw"an object"===r?t.ia(e+" a custom object"):t.ia(e+" "+r)}}function Ag(e,t,n){if((t=We(t))instanceof mg)return t._internalPath;if("string"==typeof t)return Dg(e,t);throw Og("Field path arguments must be of type string or ",e,!1,void 0,n)}const Rg=new RegExp("[~\\*/\\[\\]]");function Dg(e,t,n){if(t.search(Rg)>=0)throw Og(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new mg(...t.split("."))._internalPath}catch(r){throw Og(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function Og(e,t,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let l="";return(s||o)&&(l+=" (found",s&&(l+=` in field ${r}`),o&&(l+=` in document ${i}`),l+=")"),new Su(ku.INVALID_ARGUMENT,a+e+l)}function Pg(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lg{get id(){return this._key.path.lastSegment()}get ref(){return new ig(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new Mg(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(Fg("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}}class Mg extends Lg{data(){return super.data()}}function Fg(e,t){return"string"==typeof t?Dg(e,t):t instanceof mg?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ug(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new Su(ku.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Vg{}class jg extends Vg{}function zg(e,t,...n){let r=[];t instanceof Vg&&r.push(t),r=r.concat(n),function(e){const t=e.filter((e=>e instanceof qg)).length,n=e.filter((e=>e instanceof Bg)).length;if(t>1||t>0&&n>0)throw new Su(ku.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const t of r)e=t._apply(e);return e}class Bg extends jg{static _create(e,t,n){return new Bg(e,t,n)}_apply(e){const t=this._parse(e);return Qg(e._query,t),new sg(e.firestore,e.converter,xh(e._query,t))}_parse(e){const t=kg(e.firestore),n=function(e,t,n,r,i,s,o){let a;if(i.isKeyField()){if("array-contains"===s||"array-contains-any"===s)throw new Su(ku.INVALID_ARGUMENT,`Invalid Query. You can't perform '${s}' queries on documentId().`);if("in"===s||"not-in"===s){Gg(o,s);const t=[];for(const n of o)t.push(Wg(r,e,n));a={arrayValue:{values:t}}}else a=Wg(r,e,o)}else"in"!==s&&"not-in"!==s&&"array-contains-any"!==s||Gg(o,s),a=Tg(n,"where",o,"in"===s||"not-in"===s);return Zc.create(i,s,a)}(e._query,0,t,e.firestore._databaseId,this._field,this._op,this._value);return n}constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}}function $g(e,t,n){const r=t,i=Fg("where",e);return Bg._create(i,r,n)}class qg extends Vg{static _create(e,t){return new qg(e,t)}_parse(e){const t=this._queryConstraints.map((t=>t._parse(e))).filter((e=>e.getFilters().length>0));return 1===t.length?t[0]:eh.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return 0===t.getFilters().length?e:(function(e,t){let n=e;const r=t.getFlattenedFilters();for(const e of r)Qg(n,e),n=xh(n,e)}(e._query,t),new sg(e.firestore,e.converter,xh(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return"and"===this.type?"and":"or"}constructor(e,t){super(),this.type=e,this._queryConstraints=t}}class Hg extends jg{static _create(e,t){return new Hg(e,t)}_apply(e){const t=function(e,t,n){if(null!==e.startAt)throw new Su(ku.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(null!==e.endAt)throw new Su(ku.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");const r=new Yc(t,n);return function(e,t){if(null===Sh(e)){const n=Th(e);null!==n&&Yg(e,n,t.field)}}(e,r),r}(e._query,this._field,this._direction);return new sg(e.firestore,e.converter,function(e,t){const n=e.explicitOrderBy.concat([t]);return new wh(e.path,e.collectionGroup,n,e.filters.slice(),e.limit,e.limitType,e.startAt,e.endAt)}(e._query,t))}constructor(e,t){super(),this._field=e,this._direction=t,this.type="orderBy"}}function Kg(e,t="asc"){const n=t,r=Fg("orderBy",e);return Hg._create(r,n)}function Wg(e,t,n){if("string"==typeof(n=We(n))){if(""===n)throw new Su(ku.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Ih(t)&&-1!==n.indexOf("/"))throw new Su(ku.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const r=t.path.child(zu.fromString(n));if(!qu.isDocumentKey(r))throw new Su(ku.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Mc(e,new qu(r))}if(n instanceof ig)return Mc(e,n._key);throw new Su(ku.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Zm(n)}.`)}function Gg(e,t){if(!Array.isArray(e)||0===e.length)throw new Su(ku.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function Qg(e,t){if(t.isInequality()){const n=Th(e),r=t.field;if(null!==n&&!n.isEqual(r))throw new Su(ku.INVALID_ARGUMENT,`Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${r.toString()}'`);const i=Sh(e);null!==i&&Yg(e,r,i)}const n=function(e,t){for(const n of e)for(const e of n.getFlattenedFilters())if(t.indexOf(e.op)>=0)return e.op;return null}(e.filters,function(e){switch(e){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(null!==n)throw n===t.op?new Su(ku.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new Su(ku.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${n.toString()}' filters.`)}function Yg(e,t,n){if(!n.isEqual(t))throw new Su(ku.INVALID_ARGUMENT,`Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${t.toString()}' and so you must also use '${t.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`)}class Xg{convertValue(e,t="none"){switch(xc(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Ec(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(_c(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 10:return this.convertObject(e.mapValue,t);default:throw wu()}}convertObject(e,t){const n={};return uc(e.fields,((e,r)=>{n[e]=this.convertValue(r,t)})),n}convertGeoPoint(e){return new yg(Ec(e.latitude),Ec(e.longitude))}convertArray(e,t){return(e.values||[]).map((e=>this.convertValue(e,t)))}convertServerTimestamp(e,t){switch(t){case"previous":const n=Sc(e);return null==n?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(Tc(e));default:return null}}convertTimestamp(e){const t=wc(e);return new Uu(t.seconds,t.nanos)}convertDocumentKey(e,t){const n=zu.fromString(e);Eu(Sf(n));const r=new Cc(n.get(1),n.get(3)),i=new qu(n.popFirst(5));return r.isEqual(t)||yu(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jg(e,t,n){let r;return r=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zg{isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}}class ey extends Lg{exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new ty(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(Fg("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}}class ty extends ey{data(e={}){return super.data(e)}}class ny{get docs(){const e=[];return this.forEach((t=>e.push(t))),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach((n=>{e.call(t,new ty(this._firestore,this._userDataWriter,n.key,n,new Zg(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new Su(ku.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map((n=>{const r=new ty(e._firestore,e._userDataWriter,n.doc.key,n.doc,new Zg(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}}))}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter((e=>t||3!==e.type)).map((t=>{const r=new ty(e._firestore,e._userDataWriter,t.doc.key,t.doc,new Zg(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),s=n.indexOf(t.doc.key)),{type:ry(t.type),doc:r,oldIndex:i,newIndex:s}}))}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new Zg(r.hasPendingWrites,r.fromCache),this.query=n}}function ry(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return wu()}}class iy extends Xg{convertBytes(e){return new pg(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ig(this.firestore,null,t)}constructor(e){super(),this.firestore=e}}function sy(e){e=eg(e,sg);const t=eg(e.firestore,cg),n=dg(t),r=new iy(t);return Ug(e._query),Gm(n,e._query).then((n=>new ny(t,r,e,n)))}function oy(e,t,n){e=eg(e,ig);const r=eg(e.firestore,cg),i=Jg(e.converter,t,n);return ly(r,[Sg(kg(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,pd.none())])}function ay(e,t){const n=eg(e.firestore,cg),r=lg(e),i=Jg(e.converter,t);return ly(n,[Sg(kg(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,pd.exists(!1))]).then((()=>r))}function ly(e,t){return function(e,t){const n=new Tu;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const r=Mm(e);try{const e=await function(e,t){const n=_u(e),r=Uu.now(),i=t.reduce(((e,t)=>e.add(t.key)),Qh());let s,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>{let a=jh(),l=Qh();return n.Ki.getEntries(e,i).next((e=>{a=e,a.forEach(((e,t)=>{t.isValidDocument()||(l=l.add(e))}))})).next((()=>n.localDocuments.getOverlayedDocuments(e,a))).next((i=>{s=i;const o=[];for(const e of t){const t=wd(e,s.get(e.key).overlayedDocument);null!=t&&o.push(new kd(e.key,t,Hc(t.value.mapValue),pd.exists(!0)))}return n.mutationQueue.addMutationBatch(e,r,o,t)})).next((t=>{o=t;const r=t.applyToLocalDocumentSet(s,l);return n.documentOverlayCache.saveOverlays(e,t.batchId,r)}))})).then((()=>({batchId:o.batchId,changes:$h(s)})))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.ac[e.currentUser.toKey()];r||(r=new hc(Mu)),r=r.insert(t,n),e.ac[e.currentUser.toKey()]=r}(r,e.batchId,n),await Dm(r,e.changes),await Vp(r.remoteStore)}catch(e){const t=Zp(e,"Failed to persist write");n.reject(t)}}(await Km(e),t,n))),n.promise}(dg(e),t)}!function(e,t=!0){fu=Ft,Ot(new Ge("firestore",((e,{instanceIdentifier:n,options:r})=>{const i=e.getProvider("app").getImmediate(),s=new cg(new xu(e.getProvider("auth-internal")),new Ou(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new Su(ku.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Cc(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),s._setSettings(r),s}),"PUBLIC").setMultipleInstances(!0)),jt(hu,"3.10.1",e),jt(hu,"3.10.1","esm2017")}();const uy=Ut({apiKey:"AIzaSyBvHCpKNrfKfc2AZZLP8D0K1AGlUFcX1aE",authDomain:"test-budget-38b21.firebaseapp.com",databaseURL:"https://test-budget-38b21.firebaseio.com",projectId:"test-budget-38b21",storageBucket:"test-budget-38b21.appspot.com",messagingSenderId:"1067130269246",appId:"1:1067130269246:web:504d76c1afc05bcbf12b6f"}),cy=function(e){const t=os(e);return{signIn:async()=>{const e=new Rr;e.setCustomParameters({prompt:"select_account"});try{await Ii(t,e);const n=await Ci(t);if(null!==n){const{displayName:e,email:t,photoURL:r}=n.user;return{displayName:e,email:t,photoURL:r}}}catch(e){const{code:t,message:n}=e;return console.log(t,n),null}return null},signOut:()=>t.signOut(),onAuthStateChanged:e=>{t.onAuthStateChanged((t=>{e(t)}))}}}(uy),hy=cy.signIn,dy=cy.signOut,fy=cy.onAuthStateChanged,py=function(e){const t=hg(e);return{getBudgets:async function(e){const n=zg(ag(t,"budgets"),$g("uid","==",e.uid),Kg("createdAt"));return(await sy(n)).docs.map((function(e){return{id:e.id,...e.data()}}))},updateBudget:async function(e,n,r){const i=ag(t,"budgets");await oy(lg(i,e),{amount:n,weekly_amount:r},{merge:!0})},createBudget:async function(e,n,r){const i=await ay(ag(t,"budgets"),{amount:0,createdAt:new Date,name:n,uid:e.uid,weekly_amount:0,weekly_budget:r});console.log("Document written with ID: ",i.id)}}}(uy),my=py.getBudgets,gy=py.updateBudget,yy=py.createBudget,vy=function(e){const t=se(["budgets",e.uid],(()=>my(e))),{data:n,mutate:r}=t;return{...t,Methods:{spend:async function(e,t){r(n.map((function(n){return e.id===n.id?{...e,amount:e.amount-t,weekly_amount:e.weekly_amount+t}:n})),!1),await gy(e.id,e.amount-t,e.weekly_amount+t),r()},recharge:async function(e){r((function(t){return t.map((function(t){return e.id===t.id?{...e,amount:e.amount+e.weekly_budget,weekly_amount:0}:t}))}),!1),await gy(e.id,e.amount+e.weekly_budget,0),r()},create:async function(t){r([...n,{amount:0,id:"temporary_id",name:`${t.name} (${t.description})`,weekly_amount:0,weekly_budget:t.budget}],!1),await yy(e,`${t.name} (${t.description})`,t.budget),r()}}}};u=s("6SgHj"),u=s("6SgHj");const by=document.body.appendChild(document.createElement("div")),wy=function({opened:e,setOpened:n,children:r}){const[i,s]=t(u).useState(!1),a=t(u).useRef(null),c=t(u).useRef(null);return t(u).useEffect((function(){c.current=new bootstrap.Modal(a.current),a.current.addEventListener("hidden.bs.modal",(function(e){s(!1),n(!1)})),a.current.addEventListener("shown.bs.modal",(function(){s(!0)}))}),[]),t(u).useEffect((function(){e?c.current.show():(s(!1),c.current.hide())}),[e]),t(l).createPortal((0,o.jsx)("div",{ref:a,className:"modal fade",tabIndex:"-1","aria-hidden":"true",children:(0,o.jsx)("div",{className:"modal-dialog",children:(0,o.jsx)("div",{className:"modal-content",children:i?r:null})})}),by)};u=s("6SgHj");const Ey=function(e){return new Intl.NumberFormat("it-IT",{style:"currency",currency:"EUR"}).format(e)},_y=function(){const[e,n]=t(u).useState(void 0);return t(u).useEffect((()=>fy(n)),[]),e},ky=function({user:e}){return null!==e?(0,o.jsxs)("button",{className:"btn btn-outline-danger",onClick:function(e){e.preventDefault(),dy()},children:[(0,o.jsx)("i",{className:"bi bi-box-arrow-in-left"})," ",(0,o.jsx)("em",{children:e.displayName})]}):(0,o.jsx)("button",{className:"btn btn-outline-success",onClick:function(e){e.preventDefault(),hy()},children:(0,o.jsx)("i",{className:"bi bi-box-arrow-in-right"})})},Sy=function(){return(0,o.jsx)("div",{className:"mt-5 d-flex justify-content-center",children:(0,o.jsx)("div",{style:{width:"3rem",height:"3rem"},className:"spinner-border",role:"status",children:(0,o.jsx)("span",{className:"visually-hidden",children:"Loading..."})})})},Ty=function(){return(0,o.jsx)("nav",{className:"navbar navbar-expand-md navbar-dark bg-dark",children:(0,o.jsxs)("div",{className:"container-fluid",children:[(0,o.jsx)("span",{className:"navbar-brand",children:"My Budgets"}),(0,o.jsx)("button",{className:"navbar-toggler",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarCollapse","aria-controls":"navbarCollapse","aria-expanded":"false","aria-label":"Toggle navigation",children:(0,o.jsx)("span",{className:"navbar-toggler-icon"})}),(0,o.jsxs)("div",{className:"collapse navbar-collapse",id:"navbarCollapse",children:[(0,o.jsx)("ul",{className:"navbar-nav me-auto mb-2 mb-md-0"}),(0,o.jsx)("form",{className:"d-flex",children:(0,o.jsx)(ky,{user:null})})]})]})})};u=s("6SgHj");const Iy=function({setOpened:e,budget:n,action:r}){const i=t(u).useRef(null);t(u).useEffect((function(){i.current.focus()}),[]);const[s,a]=t(u).useState("");return(0,o.jsxs)(t(u).Fragment,{children:[(0,o.jsxs)("div",{className:"modal-header",children:[(0,o.jsx)("h5",{className:"modal-title",children:n.name}),(0,o.jsx)("button",{type:"button",className:"btn-close","data-bs-dismiss":"modal","aria-label":"Close"})]}),(0,o.jsxs)("form",{onSubmit:function(t){t.preventDefault(),r(parseFloat(s)),e(!1)},children:[(0,o.jsxs)("div",{className:"modal-body",children:[(0,o.jsxs)("div",{className:"form-floating",children:[(0,o.jsx)("input",{ref:i,id:"floatingInput",type:"number",className:"form-control",value:s,step:"0.01",onChange:function(e){a(e.target.value)},placeholder:"3.14",required:!0}),(0,o.jsx)("label",{htmlFor:"floatingInput",children:"Quanto hai speso?"})]}),(0,o.jsxs)("small",{className:"form-text text-muted",children:["Il tuo budget è ",Ey(n.amount)]})]}),(0,o.jsx)("div",{className:"modal-footer",children:(0,o.jsx)("button",{type:"submit",className:"btn btn-outline-primary",children:"Sure!"})})]})]})},Cy=function({budget:e,spend:n}){const[r,i]=t(u).useState(!1);return(0,o.jsxs)("div",{className:"col-sm-6",children:[(0,o.jsx)(wy,{opened:r,setOpened:i,children:(0,o.jsx)(Iy,{setOpened:i,budget:e,action:n})}),(0,o.jsxs)("div",{className:"card border-secondary m-2",children:[(0,o.jsxs)("div",{className:"card-header",children:[(0,o.jsx)("span",{children:e.name}),(0,o.jsx)("span",{className:"float-end",children:(0,o.jsxs)("form",{className:"row row-cols-auto align-items-center",children:[(0,o.jsx)("small",{children:Ey(e.weekly_budget)}),(0,o.jsxs)("div",{className:"dropdown",children:[(0,o.jsx)("button",{className:"btn btn-sm btn-outline-secondary dropdown-toggle",type:"button","data-bs-toggle":"dropdown","aria-expanded":"false",children:(0,o.jsx)("i",{className:"bi bi-gear"})}),(0,o.jsxs)("div",{className:"dropdown-menu dropdown-menu-end",children:[(0,o.jsx)("button",{className:"dropdown-item",onClick:function(e){e.preventDefault()},children:"Details"}),(0,o.jsx)("button",{className:"dropdown-item",onClick:function(e){e.preventDefault()},children:"Move"})]})]})]})})]}),(0,o.jsxs)("div",{className:"card-body",children:[(0,o.jsx)("p",{className:"mb-0",children:(0,o.jsx)("span",{className:"card-subtitle mb-2 text-muted",children:Ey(e.weekly_amount)})}),(0,o.jsxs)("p",{children:[(0,o.jsx)("strong",{className:"fs-5",children:(0,o.jsx)("em",{children:Ey(e.amount)})}),(0,o.jsxs)("button",{className:"btn btn-outline-primary float-end",onClick:function(){i(!0)},children:[(0,o.jsx)("i",{className:"bi bi-currency-euro"})," Add Cost"]})]})]})]})]},e.id)};s("6SgHj");const Ny=function({user:e}){const{isValidating:t}=vy(e);return t?(0,o.jsx)("div",{className:"spinner-border",style:{position:"fixed",bottom:"1em",right:"1em"},role:"status",children:(0,o.jsx)("span",{className:"visually-hidden",children:"Loading..."})}):null};u=s("6SgHj");s("6SgHj");const xy=function({opened:e,setOpened:t,action:n}){return(0,o.jsxs)(wy,{opened:e,setOpened:t,children:[(0,o.jsxs)("div",{className:"modal-header",children:[(0,o.jsx)("h5",{className:"modal-title",children:"Recharge All"}),(0,o.jsx)("button",{type:"button",className:"btn-close","data-bs-dismiss":"modal","aria-label":"Close"})]}),(0,o.jsx)("div",{className:"modal-body",children:"Sicuro di voler ricaricare tutti i budget?"}),(0,o.jsx)("div",{className:"modal-footer",style:{display:"block"},children:(0,o.jsx)("button",{className:"btn btn-outline-danger float-end",onClick:function(){n(),t(!1)},children:"Ok"})})]})};u=s("6SgHj");const Ay=function({action:e}){const n=t(u).useRef(null);t(u).useEffect((function(){n.current.focus()}),[]);const[r,i]=t(u).useState(""),[s,a]=t(u).useState(""),[l,c]=t(u).useState(""),h=function(e){if("budget"===e.target.name)c(parseFloat(e.target.value));else{(0,{name:i,description:a}[e.target.name])(e.target.value)}};return(0,o.jsxs)(t(u).Fragment,{children:[(0,o.jsxs)("div",{className:"modal-header",children:[(0,o.jsx)("h5",{className:"modal-title",children:"New Budget"}),(0,o.jsx)("button",{type:"button",className:"btn-close","data-bs-dismiss":"modal","aria-label":"Close"})]}),(0,o.jsxs)("form",{onSubmit:function(t){t.preventDefault(),e({name:r,description:s,budget:l})},children:[(0,o.jsxs)("div",{className:"modal-body",children:[(0,o.jsxs)("div",{className:"form-floating mb-3",children:[(0,o.jsx)("input",{ref:n,className:"form-control",name:"name",placeholder:" ",value:r,onChange:h,required:!0}),(0,o.jsx)("label",{children:"Name"})]}),(0,o.jsxs)("div",{className:"form-floating mb-3",children:[(0,o.jsx)("textarea",{className:"form-control",name:"description",rows:"3",placeholder:" ",style:{height:"100px"},value:s,onChange:h}),(0,o.jsx)("label",{children:"Description"})]}),(0,o.jsxs)("div",{className:"form-floating mb-3",children:[(0,o.jsx)("input",{type:"number",min:"0.01",step:"0.01",className:"form-control",value:l,onChange:h,name:"budget",placeholder:" ",required:!0}),(0,o.jsx)("label",{children:"Budget"})]})]}),(0,o.jsx)("div",{className:"modal-footer",style:{display:"block"},children:(0,o.jsx)("button",{type:"submit",className:"btn btn-outline-danger float-end",children:"Ok"})})]})]})},Ry=function({opened:e,setOpened:t,action:n}){return(0,o.jsx)(wy,{opened:e,setOpened:t,children:(0,o.jsx)(Ay,{action:function(e){n(e),t(!1)}})})},Dy=function({user:e,budgets:n,Methods:r}){const[i,s]=t(u).useState(!1),[a,l]=t(u).useState(!1),c=n.reduce((function(e,t){return e+t.weekly_budget}),0),h=n.reduce((function(e,t){return e+t.amount}),0);return(0,o.jsxs)("nav",{className:"navbar navbar-expand-md navbar-dark bg-dark",children:[(0,o.jsx)(xy,{opened:i,setOpened:s,action:function(){n.forEach((function(e){r.recharge(e)}))}}),(0,o.jsx)(Ry,{opened:a,setOpened:l,action:function(e){r.create(e)}}),(0,o.jsxs)("div",{className:"container-fluid",children:[(0,o.jsxs)("span",{className:"navbar-brand",children:["My Budgets ",(0,o.jsx)("sub",{children:Ey(c)})]}),(0,o.jsx)("button",{className:"navbar-toggler",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarCollapse","aria-controls":"navbarCollapse","aria-expanded":"false","aria-label":"Toggle navigation",children:(0,o.jsx)("span",{className:"navbar-toggler-icon"})}),(0,o.jsxs)("div",{className:"collapse navbar-collapse",id:"navbarCollapse",children:[(0,o.jsxs)("ul",{className:"navbar-nav me-auto mb-2 mb-md-0",children:[(0,o.jsx)("li",{className:"nav-item",children:(0,o.jsx)("a",{className:"nav-link",href:"#",onClick:function(e){e.preventDefault(),s(!0)},children:"Recharge all"})}),(0,o.jsx)("li",{className:"nav-item",children:(0,o.jsx)("a",{className:"nav-link",href:"#",onClick:function(e){e.preventDefault(),l(!0)},children:"New budget"})})]}),(0,o.jsx)("span",{className:"navbar-brand fst-italic",children:Ey(h)}),(0,o.jsx)("form",{className:"d-flex",children:(0,o.jsx)(ky,{user:e})})]})]})]})},Oy=function({user:e,error:n}){return(0,o.jsxs)(t(u).Fragment,{children:[(0,o.jsx)(Ty,{user:e}),(0,o.jsx)("div",{className:"container",children:(0,o.jsxs)("div",{style:{marginTop:"10px"},className:"alert alert-danger",role:"alert",children:[(0,o.jsx)("p",{children:"Errore nel caricamento dei budget!"}),(0,o.jsx)("hr",{}),(0,o.jsx)("p",{children:(0,o.jsx)("em",{children:n.message})})]})})]})},Py=function({user:e}){const{data:n,error:r,Methods:i}=vy(e);if(void 0!==r)return(0,o.jsx)(Oy,{user:e,error:r});if(void 0===n)return(0,o.jsx)(Sy,{});const s=n.map((function(e){return(0,o.jsx)(Cy,{budget:e,spend:function(t){i.spend(e,t)}},e.id)}));return(0,o.jsxs)(t(u).Fragment,{children:[(0,o.jsx)(Dy,{user:e,budgets:n,Methods:i}),(0,o.jsx)("div",{className:"container",children:(0,o.jsx)("div",{className:"row",children:s})}),(0,o.jsx)(Ny,{user:e})]})};s("6SgHj");var Ly;Ly=JSON.parse('{"name":"my-budgets","version":"5.3.0","description":"My Budgets","private":true,"source":"src/index.html","browserslist":"defaults","scripts":{"update":"ncu -u","serve":"parcel -p 8000","watch":"parcel watch","build":"rm -rf dist && rm -rf docs && parcel build --no-source-maps --dist-dir docs --public-url=/my-budgets"},"author":"Luca Bacchi <bacchilu@gmail.com> (https://github.com/bacchilu)","license":"ISC","prettier":{"arrowParens":"always","bracketSpacing":false,"embeddedLanguageFormatting":"auto","htmlWhitespaceSensitivity":"css","insertPragma":false,"jsxBracketSameLine":false,"jsxSingleQuote":false,"printWidth":120,"proseWrap":"preserve","quoteProps":"as-needed","requirePragma":false,"semi":true,"singleQuote":true,"tabWidth":4,"trailingComma":"es5","useTabs":false,"vueIndentScriptAndStyle":false},"devDependencies":{"@types/react":"^18.0.37","@types/react-dom":"^18.0.11","npm-check-updates":"^16.10.8","parcel":"^2.8.3"},"dependencies":{"firebase":"^9.20.0","firebaseui":"^6.0.2","react":"^18.2.0","react-dom":"^18.2.0","swr":"^2.1.3"}}');const My=function(){const e=function(){const e=[{message:"Forget about goals, focus on systems instead.",author:"James Clear",source:"Atomic Habits"},{message:"Stand up straight with your shoulders back.",author:"Jordan Peterson",source:"12 Rules for Life"},{message:"A year from now you will wish you had started today.",author:"Unknown",source:"Unknown"},{message:"If you don’t risk anything, you risk even more.",author:"Erica Jong",source:"Unknown"}];return e[Math.floor(Math.random()*e.length)]}();return(0,o.jsx)("div",{className:"mt-5 d-flex justify-content-center lead",children:(0,o.jsxs)("figure",{children:[(0,o.jsx)("blockquote",{className:"blockquote",children:(0,o.jsx)("p",{children:e.message})}),(0,o.jsxs)("figcaption",{className:"blockquote-footer",children:[e.author," in ",(0,o.jsx)("cite",{title:"Source Title",children:e.source})]})]})})},Fy=function(){return(0,o.jsxs)(t(u).Fragment,{children:[(0,o.jsx)(Ty,{}),(0,o.jsx)("div",{className:"container",children:(0,o.jsxs)("div",{style:{marginTop:"10px"},className:"alert alert-danger",role:"alert",children:[(0,o.jsx)("p",{children:"Please authenticate!"}),(0,o.jsxs)("p",{children:["You need to"," ",(0,o.jsx)("a",{href:"#",onClick:function(e){e.preventDefault(),hy()},children:"authenticate"})," ","with a Google Account to use this app."]})]})})]})},Uy=function(){const e=_y();return void 0===e?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(Sy,{}),(0,o.jsx)(My,{})]}):null===e?(0,o.jsx)(Fy,{}):(0,o.jsx)(Py,{user:e})};a(document.getElementById("app")).render((0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(Uy,{}),(0,o.jsx)("div",{style:{position:"fixed",bottom:"0.1rem",left:"0.1rem"},className:"font-monospace",children:(0,o.jsx)((()=>(0,o.jsx)("span",{children:Ly.version})),{})})]}));