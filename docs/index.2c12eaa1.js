 ...
 * limitations under the License.
 */
function Yr(){return void 0!==Jr().WorkerGlobalScope&&"function"==typeof Jr().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mi=new vn(3e4,6e4);function Fi(){const e=Jr().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Ui=null;function Vi(e){return Ui=Ui||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){Fi(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Fi(),n(an(e,"network-request-failed"))},timeout:Mi.get()})}if(null===(i=null===(r=Jr().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Jr().gapi)||void 0===s?void 0:s.load)){const t=lr("iframefcb");return Jr()[t]=()=>{gapi.load?o():n(an(e,"network-request-failed"))},ar(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Ui=null,e}))}(e),Ui}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ju="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Yu{addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}constructor(){this.onCommittedListeners=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xu(e){if(e.code!==ku.FAILED_PRECONDITION||e.message!==Ju)throw e;gu("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc{constructor(e,t="asc"){this.field=e,this.dir=t}}function Yc(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:rc(t)?"-0":t}}function Zh(e){return{integerValue:""+e}}function ed(e,t){return ic(t)?Zh(t):Xh(e,t)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vd{static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,jd.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new Vd(Vu.min(),r,Yh(),jh(),Qh())}constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}}class jd{static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new jd(n,t,Qh(),Qh(),Qh())}constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gp(e){return new Yd(e,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.lu=[],this.fu=new Map,this.du=new Set,this.wu=[],this._u=i,this._u.qr((e=>{n.enqueueAndForget((async()=>{Dp(this)&&(gu("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=_u(e);t.du.add(4),await Tp(t),t.mu.set("Unknown"),t.du.delete(4),await Sp(t)}(this))}))})),this.mu=new _p(n,r)}}async function Sp(e){if(Dp(e))for(const t of e.wu)await t(!0)}async function Tp(e){for(const t of e.wu)await t(!1)}function Ip(e,t){const n=_u(e);n.fu.has(t.targetId)||(n.fu.set(t.targetId,t),Rp(n)?Ap(n):Jp(n).No()&&Np(n,t))}function Cp(e,t){const n=_u(e),r=Jp(n);n.fu.delete(t),r.No()&&xp(n,t),0===n.fu.size&&(r.No()?r.$o():Dp(n)&&n.mu.set("Unknown"))}function Np(e,t){e.gu.Ot(t.targetId),Jp(e).jo(t)}function xp(e,t){e.gu.Ot(t),Jp(e).Wo(t)}function Ap(e){e.gu=new Hd({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ne:t=>e.fu.get(t)||null}),Jp(e).start(),e.mu.ou()}function Rp(e){return Dp(e)&&!Jp(e).xo()&&e.fu.size>0}function Dp(e){return 0===_u(e).du.size}function Op(e){e.gu=void 0}async function Pp(e){e.fu.forEach(((t,n)=>{Np(e,t)}))}async function Lp(e,t){Op(e),Rp(e)?(e.mu.au(t),Ap(e)):e.mu.set("Unknown")}async function Mp(e,t,n){if(e.mu.set("Online"),t instanceof $d&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.fu.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.fu.delete(r),e.gu.removeTarget(r))}(e,t)}catch(n){gu("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Fp(e,n)}else if(t instanceof zd?e.gu.Kt(t):t instanceof Bd?e.gu.Jt(t):e.gu.zt(t),!n.isEqual(Vu.min()))try{const t=await Xf(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.gu.Xt(t);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.fu.get(r);i&&e.fu.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach((t=>{const n=e.fu.get(t);if(!n)return;e.fu.set(t,n.withResumeToken(vc.EMPTY_BYTE_STRING,n.snapshotVersion)),xp(e,t);const r=new Tf(n.target,t,1,n.sequenceNumber);Np(e,r)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){gu("RemoteStore","Failed to raise snapshot:",t),await Fp(e,t)}}async function Fp(e,t,n){if(!ec(t))throw t;e.du.add(1),await Tp(e),e.mu.set("Offline"),n||(n=()=>Xf(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{gu("RemoteStore","Retrying IndexedDB access"),await n(),e.du.delete(1),await Sp(e)}))}function Up(e,t){return t().catch((n=>Fp(e,n,t)))}async function Vp(e){const t=_u(e),n=Yp(t);let r=t.lu.length>0?t.lu[t.lu.length-1].batchId:-1;for(;jp(t);)try{const e=await ep(t.localStore,r);if(null===e){0===t.lu.length&&n.$o();break}r=e.batchId,zp(t,e)}catch(e){await Fp(t,e)}Bp(t)&&$p(t)}function jp(e){return Dp(e)&&e.lu.length<10}function zp(e,t){e.lu.push(t);const n=Yp(e);n.No()&&n.Jo&&n.Yo(t.mutations)}function Bp(e){return Dp(e)&&!Yp(e).xo()&&e.lu.length>0}function $p(e){Yp(e).start()}async function qp(e){Yp(e).tu()}async function Hp(e){const t=Yp(e);for(const n of e.lu)t.Yo(n.mutations)}async function Kp(e,t,n){const r=e.lu.shift(),i=Ad.from(r,t,n);await Up(e,(()=>e.remoteSyncer.applySuccessfulWrite(i))),await Vp(e)}async function Wp(e,t){t&&Yp(e).Jo&&await async function(e,t){if(Ld(n=t.code)&&n!==ku.ABORTED){const n=e.lu.shift();Yp(e).Oo(),await Up(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await Vp(e)}var n}(e,t),Bp(e)&&$p(e)}async function Gp(e,t){const n=_u(e);n.asyncQueue.verifyOperationInProgress(),gu("RemoteStore","RemoteStore received new credentials");const r=Dp(n);n.du.add(3),await Tp(n),r&&n.mu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.du.delete(3),await Sp(n)}async function Qp(e,t){const n=_u(e);t?(n.du.delete(2),await Sp(n)):t||(n.du.add(2),await Tp(n),n.mu.set("Unknown"))}function Jp(e){return e.yu||(e.yu=function(e,t,n){const r=_u(e);return r.nu(),new bp(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{Jr:Pp.bind(null,e),Zr:Lp.bind(null,e),zo:Mp.bind(null,e)}),e.wu.push((async t=>{t?(e.yu.Oo(),Rp(e)?Ap(e):e.mu.set("Unknown")):(await e.yu.stop(),Op(e))}))),e.yu}function Yp(e){return e.pu||(e.pu=function(e,t,n){const r=_u(e);return r.nu(),new wp(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{Jr:qp.bind(null,e),Zr:Wp.bind(null,e),Xo:Hp.bind(null,e),Zo:Kp.bind(null,e)}),e.wu.push((async t=>{t?(e.pu.Oo(),await Vp(e)):(await e.pu.stop(),e.lu.length>0&&(gu("RemoteStore",`Stopping write stream with ${e.lu.length} pending writes`),e.lu=[]))}))),e.pu
/**
 * @license
 * Copyright 2017 Google LLC
 *
